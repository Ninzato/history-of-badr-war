...
lib.ssMetadata = [
		{name:"LessonChapter3_06_atlas_1", frames: [[1560,0,312,399],[763,1252,285,308],[1337,1252,304,286],[793,1562,285,308],[1050,1252,285,308],[1367,1542,313,269],[1643,1252,298,288],[1080,1562,285,308],[460,1252,301,327],[1282,0,276,635],[1560,401,330,317],[0,1571,228,432],[460,1581,331,292],[0,1252,330,317],[230,1571,228,432],[1682,1542,317,265],[0,990,1829,260],[0,722,1914,266],[0,0,1280,720]]},
		{name:"LessonChapter3_06_atlas_2", frames: [[0,416,132,102],[134,417,132,102],[861,0,77,245],[354,271,77,244],[570,0,112,623],[940,0,77,245],[433,271,77,244],[299,0,269,269],[0,0,297,268],[861,247,77,245],[684,294,77,244],[940,247,77,245],[763,294,77,244],[361,517,193,36],[0,521,193,36],[684,0,175,145],[0,270,175,144],[684,147,175,145],[177,271,175,144],[268,517,91,87],[842,494,91,88]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-69.8,-73.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-69.8,-73.2,148.5,134);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-108.1,-44.4,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(98.3,45.5,1.283,1.283,0,0,0,54.1,29.4);
	...
	this.shape.setTransform(98.7593,41.7749,1.283,1.283);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-0.2,-10.75,1,0.2094,0,0,0,98.5,39.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:98.8,regY:41.8,scaleY:0.2489,x:0.1,y:-11.75},0).wait(1).to({scaleY:0.2883,y:-13.35},0).wait(1).to({scaleY:0.3277,y:-14.9},0).wait(1).to({scaleY:0.3671,y:-16.5},0).wait(1).to({scaleY:0.4065,y:-18.05},0).wait(1).to({scaleY:0.446,y:-19.65},0).wait(1).to({scaleY:0.4854,y:-21.2},0).wait(1).to({scaleY:0.5248,y:-22.8},0).wait(1).to({scaleY:0.5642,y:-24.35},0).wait(1).to({scaleY:0.6036,y:-25.95},0).wait(1).to({scaleY:0.643,y:-27.5},0).wait(1).to({scaleY:0.6825,y:-29.1},0).wait(1).to({scaleY:0.7219,y:-30.7},0).wait(1).to({scaleY:0.7613,y:-32.3},0).wait(1).to({scaleY:0.8007,y:-33.85},0).wait(1).to({scaleY:0.8401,y:-35.45},0).wait(1).to({scaleY:0.8796,y:-37},0).wait(1).to({scaleY:0.919,y:-38.6},0).wait(1).to({scaleY:0.9584,y:-40.15},0).wait(1).to({scaleY:0.9978,y:-41.75},0).wait(1).to({scaleY:1.0372,y:-43.3},0).wait(1).to({scaleY:1.0766,y:-44.9},0).wait(1).to({scaleY:1.1161,y:-46.45},0).wait(23).to({scaleY:1.0848,y:-45.2},0).wait(1).to({scaleY:1.0535,y:-43.95},0).wait(1).to({scaleY:1.0223,y:-42.7},0).wait(1).to({scaleY:0.991,y:-41.5},0).wait(1).to({scaleY:0.9597,y:-40.25},0).wait(1).to({scaleY:0.9285,y:-38.95},0).wait(1).to({scaleY:0.8972,y:-37.7},0).wait(1).to({scaleY:0.866,y:-36.45},0).wait(1).to({scaleY:0.8347,y:-35.2},0).wait(1).to({scaleY:0.8034,y:-33.95},0).wait(1).to({scaleY:0.7722,y:-32.7},0).wait(1).to({scaleY:0.7409,y:-31.45},0).wait(1).to({scaleY:0.7097,y:-30.2},0).wait(1).to({scaleY:0.6784,y:-28.95},0).wait(1).to({scaleY:0.6471,y:-27.7},0).wait(1).to({scaleY:0.6159,y:-26.45},0).wait(1).to({scaleY:0.5846,y:-25.2},0).wait(1).to({scaleY:0.5533,y:-23.9},0).wait(1).to({scaleY:0.5221,y:-22.7},0).wait(1).to({scaleY:0.4908,y:-21.45},0).wait(1).to({scaleY:0.4596,y:-20.2},0).wait(1).to({scaleY:0.4283,y:-18.95},0).wait(1).to({scaleY:0.397,y:-17.7},0).wait(1).to({scaleY:0.3658,y:-16.4},0).wait(1).to({scaleY:0.3345,y:-15.15},0).wait(1).to({scaleY:0.3032,y:-13.9},0).wait(1).to({scaleY:0.272,y:-12.7},0).wait(1).to({scaleY:0.2407,y:-11.45},0).wait(1).to({scaleY:0.2095,y:-10.2},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-55.5,-66.8,111.1,132.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.homeBtn},{t:this.prevBtn},{t:this.nextBtn}]}).wait(390));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LessonChapter3_06_atlas_1.png?1655397279483", id:"LessonChapter3_06_atlas_1"},
		{src:"images/LessonChapter3_06_atlas_2.png?1655397279484", id:"LessonChapter3_06_atlas_2"},
		{src:"sounds/AfterWar206wav.mp3?1655397279757", id:"AfterWar206wav"},
		{src:"sounds/popsound.mp3?1655397279757", id:"popsound"}
	],
	preloads: []
};
