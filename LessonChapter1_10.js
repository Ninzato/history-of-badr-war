...
lib.ssMetadata = [
		{name:"LessonChapter1_10_atlas_1", frames: [[679,1484,330,308],[1011,1484,330,308],[1343,1484,330,308],[1675,1484,318,310],[0,1484,357,308],[359,1484,318,333],[0,1350,1779,132],[0,1082,1914,266],[0,0,1920,1080]]},
		{name:"LessonChapter1_10_atlas_2", frames: [[455,277,132,102],[320,277,133,102],[0,0,318,292],[589,293,193,36],[784,293,193,36],[320,0,315,275],[589,331,193,36],[784,331,193,36],[589,369,193,36],[784,369,193,36],[637,0,175,145],[637,147,175,144],[814,0,175,145],[814,147,175,144],[93,294,91,87],[0,294,91,88]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.CachedBmp_784();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-79.9,-67.4,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-79.9,-67.4,159,146);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.CachedBmp_778();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance_1 = new lib.CachedBmp_770();
...
if (reversed == null) { reversed = false; }
	...
	// flash0_ai
	this.instance_1 = new lib.CachedBmp_769();
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.CachedBmp_768();
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.CachedBmp_766();
...
p.nominalBounds = new cjs.Rectangle(-246,-173.9,491.1,346.5);
...
if (reversed == null) { reversed = false; }
	...
	// Subtitle
	this.instance = new lib.CachedBmp_764();
	this.instance.setTransform(195.55,597,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_763();
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.homeBtn},{t:this.prevBtn},{t:this.nextBtn}]}).wait(272));

	// interaction
	this.instance_2 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_2.setTransform(-32.2,450.2,0.1767,0.1767,-90.7322,0,0,35.1,1.3);

	this.instance_3 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_3.setTransform(-20.15,474.55,0.1766,0.1766,-148.1525,0,0,5.5,-1.8);

	this.instance_4 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_4.setTransform(-20.8,473.1,0.1767,0.1767,-124.7938,0,0,4.7,-8.2);

	this.instance_5 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_5.setTransform(-31.75,464.2,0.1766,0.1766,-141.5767,0,0,38.9,1.7);

	this.instance_6 = new lib.ch1_headcopy_1("synched",0);
	this.instance_6.setTransform(-22.05,440.35,0.1768,0.1768,-3.6174,0,0,1.9,54.2);

	this.instance_7 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_7.setTransform(-23.45,450.65,0.177,0.177,0,0,0,0,-22.9);

	this.instance_8 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_8.setTransform(-26.3,487.8,0.1766,0.1766,16.7851,0,0,4,-54.1);

	this.instance_9 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_9.setTransform(-22.95,444,0.1768,0.1768,12.0868,0,0,-0.1,9.2);

	this.instance_10 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_10.setTransform(-23.15,462.8,0.177,0.177,0,0,0,0.6,-22.3);

	this.instance_11 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_11.setTransform(-17,487.8,0.1766,0.1766,-11.5702,0,0,3.1,-53.4);

	this.instance_12 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_12.setTransform(-20.4,471.2,0.1766,0.1766,-14.6979,0,0,-0.5,2.8);

	this.instance_13 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_13.setTransform(-13.8,475.3,0.1767,0.1767,58.7222,0,0,-4.2,3.1);

	this.instance_14 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_14.setTransform(-12.95,473.55,0.1767,0.1767,96.3659,0,0,-5.5,7.2);

	this.instance_15 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_15.setTransform(-20.55,461.45,0.1767,0.1767,58.0466,0,0,-39.5,-0.9);

	this.instance_16 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_16.setTransform(-14.15,449.65,0.1767,0.1767,119.3036,0,0,-33.4,-1.1);

	this.instance_17 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_17.setTransform(-25.1,470.7,0.1767,0.1767,1.8162,0,0,2.8,-45.6);

	this.instance_18 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_18.setTransform(319.35,488.65,0.1765,0.1765,-63.3597,0,0,35.6,0.8);

	this.instance_19 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_19.setTransform(313.5,516.45,0.1765,0.1765,-85.3495,0,0,6.2,-0.8);

	this.instance_20 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_20.setTransform(314.55,515.35,0.1765,0.1765,-52.9974,0,0,4.8,-7.9);

	this.instance_21 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_21.setTransform(313.05,501.1,0.1766,0.1766,-95.5938,0,0,39.3,-0.1);

	this.instance_22 = new lib.ch1_headcopy("synched",0);
	this.instance_22.setTransform(329.5,478.65,0.1767,0.1767,-1.0491,0,0,1.3,52.6);
	...
	this.instance_24.setTransform(331.05,525.05,0.1765,0.1765,-17.6407,0,0,3.4,-53.6);

	this.instance_25 = new lib.ch1_neckcopy("synched",0);
	this.instance_25.setTransform(328.6,482.45,0.1767,0.1767,10.7014,0,0,-0.7,8.8);
	...
	this.instance_27.setTransform(331.25,526.7,0.1764,0.1764,30.7113,0,0,4.4,-53.1);

	this.instance_28 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_28.setTransform(330.9,509.75,0.1764,0.1764,-3.3714,0,0,0.1,2.3);

	this.instance_29 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_29.setTransform(341.7,516.8,0.1766,0.1766,90.2773,0,0,-4.2,2.3);

	this.instance_30 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_30.setTransform(342.9,515.2,0.1766,0.1766,109.9916,0,0,-5.9,7);

	this.instance_31 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_31.setTransform(340.1,501.25,0.1766,0.1766,78.6425,0,0,-39.9,-1.4);

	this.instance_32 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_32.setTransform(337.45,488.2,0.1766,0.1766,79.4786,0,0,-32.5,0);

	this.instance_33 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_33.setTransform(325.55,508.9,0.1765,0.1765,-21.1364,0,0,1.9,-45.8);

	this.instance_34 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_34.setTransform(294.55,474.3,0.1767,0.1767,-90.7322,0,0,35.1,2.5);

	this.instance_35 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_35.setTransform(306.6,498.65,0.1766,0.1766,-148.1525,0,0,5.3,-1.7);

	this.instance_36 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_36.setTransform(305.95,497.2,0.1767,0.1767,-124.7938,0,0,4.5,-7.9);

	this.instance_37 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_37.setTransform(295,488.3,0.1766,0.1766,-141.5767,0,0,38.2,2.2);

	this.instance_38 = new lib.ch1_headcopy_1("synched",0);
	this.instance_38.setTransform(304.7,464.4,0.1768,0.1768,-3.6174,0,0,3.1,55.1);

	this.instance_39 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_39.setTransform(303.3,474.75,0.177,0.177,0,0,0,0,-22.9);

	this.instance_40 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_40.setTransform(300.45,511.95,0.1766,0.1766,16.7851,0,0,5.4,-53.6);

	this.instance_41 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_41.setTransform(303.8,468.1,0.1768,0.1768,12.0868,0,0,0.1,10.1);

	this.instance_42 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_42.setTransform(303.6,486.9,0.177,0.177,0,0,0,1.7,-21.4);

	this.instance_43 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_43.setTransform(309.75,511.9,0.1766,0.1766,-11.5702,0,0,4,-53.2);

	this.instance_44 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_44.setTransform(306.35,495.3,0.1766,0.1766,-14.6979,0,0,0.7,3.1);

	this.instance_45 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_45.setTransform(312.95,499.4,0.1767,0.1767,58.7222,0,0,-3.6,2.1);

	this.instance_46 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_46.setTransform(313.8,497.65,0.1767,0.1767,96.3659,0,0,-5.5,6.9);

	this.instance_47 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_47.setTransform(306.2,485.55,0.1767,0.1767,58.0466,0,0,-38.1,-1.4);

	this.instance_48 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_48.setTransform(312.6,473.7,0.1767,0.1767,119.3036,0,0,-34,-2);

	this.instance_49 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_49.setTransform(301.65,494.8,0.1767,0.1767,1.8162,0,0,2.8,-45.6);

	this.instance_50 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_50.setTransform(257.7,488.9,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_51 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_51.setTransform(257.3,516.9,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_52 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_52.setTransform(256.75,515.45,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_53 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_53.setTransform(252.35,501.75,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_54 = new lib.ch1_headcopy2("synched",0);
	this.instance_54.setTransform(267.75,478.9,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_56.setTransform(270.2,524.55,0.1766,0.1766,-11.9108,0,0,3,-53.8);

	this.instance_57 = new lib.ch1_neckcopy2("synched",0);
	this.instance_57.setTransform(267,482.65,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_59.setTransform(267.4,526.2,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_60 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_60.setTransform(270.55,509.45,0.1766,0.1766,7.787,0,0,-0.3,2);

	this.instance_61 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_61.setTransform(285.45,514.55,0.1767,0.1767,34.1046,0,0,-4.4,2.6);

	this.instance_62 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_62.setTransform(285.05,512.5,0.1767,0.1767,58.3948,0,0,-5.5,7.9);

	this.instance_63 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_63.setTransform(275.75,501.75,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_64 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_64.setTransform(275.85,488.35,0.1767,0.1767,91.3111,0,0,-32.5,-0.7);

	this.instance_65 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_65.setTransform(263.3,508.95,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_66 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_66.setTransform(288.7,442,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_67 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_67.setTransform(288.3,470,0.1767,0.1767,-110.4854,0,0,5.5,-1.6);

	this.instance_68 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_68.setTransform(287.75,468.55,0.1767,0.1767,-120.7482,0,0,4.1,-9.1);

	this.instance_69 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_69.setTransform(283.35,454.85,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_70 = new lib.ch1_headcopy2("synched",0);
	this.instance_70.setTransform(298.75,432,0.1768,0.1768,-2.0027,0,0,1,52.6);

	this.instance_71 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_71.setTransform(297.5,442.45,0.177,0.177,0,0,0,0,-22.9);

	this.instance_72 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_72.setTransform(301.2,477.65,0.1766,0.1766,-11.9108,0,0,2.6,-53.9);

	this.instance_73 = new lib.ch1_neckcopy2("synched",0);
	this.instance_73.setTransform(298,435.75,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_75.setTransform(298.4,479.3,0.1765,0.1765,36.4519,0,0,4.5,-52.6);

	this.instance_76 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_76.setTransform(301.55,462.55,0.1766,0.1766,7.787,0,0,-0.2,2.9);

	this.instance_77 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_77.setTransform(316.45,467.65,0.1767,0.1767,34.1046,0,0,-4,3.7);

	this.instance_78 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_78.setTransform(316,465.6,0.1767,0.1767,58.3948,0,0,-5.7,8.2);

	this.instance_79 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_79.setTransform(306.75,454.85,0.1767,0.1767,49.301,0,0,-39.4,-0.2);

	this.instance_80 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_80.setTransform(306.85,441.45,0.1767,0.1767,91.3111,0,0,-32,-0.4);

	this.instance_81 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_81.setTransform(294.3,462.05,0.1766,0.1766,-26.6536,0,0,1.9,-44.3);
	...
	this.instance_87.setTransform(275.5,458.65,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_90.setTransform(275.85,470.8,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_98.setTransform(312.9,453.1,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_99 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_99.setTransform(307.05,480.9,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_100 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_100.setTransform(308.1,479.85,0.1765,0.1765,-52.9983,0,0,4.5,-7.7);

	this.instance_101 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_101.setTransform(306.65,465.55,0.1765,0.1765,-95.5899,0,0,39,-0.1);

	this.instance_102 = new lib.ch1_headcopy("synched",0);
	this.instance_102.setTransform(323.05,443.1,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_104.setTransform(324.6,489.5,0.1765,0.1765,-17.6375,0,0,3.4,-53.6);

	this.instance_105 = new lib.ch1_neckcopy("synched",0);
	this.instance_105.setTransform(322.15,446.9,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_107.setTransform(324.8,491.15,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_108 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_108.setTransform(324.45,474.2,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_109 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_109.setTransform(335.25,481.25,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_110 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_110.setTransform(336.45,479.65,0.1765,0.1765,109.9886,0,0,-5.9,7);

	this.instance_111 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_111.setTransform(333.65,465.7,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_112 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_112.setTransform(331,452.65,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_113 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_113.setTransform(319.1,473.35,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_114 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_114.setTransform(369.4,490.25,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_115 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_115.setTransform(369,518.25,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_116 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_116.setTransform(368.45,516.8,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_117 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_117.setTransform(364.05,503.1,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_118 = new lib.ch1_headcopy2("synched",0);
	this.instance_118.setTransform(379.45,480.25,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_120.setTransform(381.9,525.9,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_121 = new lib.ch1_neckcopy2("synched",0);
	this.instance_121.setTransform(378.7,484,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_123.setTransform(379.1,527.55,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_124 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_124.setTransform(382.25,510.8,0.1766,0.1766,7.787,0,0,0.8,1.6);

	this.instance_125 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_125.setTransform(397.15,515.9,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_126 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_126.setTransform(396.75,513.85,0.1767,0.1767,58.3948,0,0,-5.3,7);

	this.instance_127 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_127.setTransform(387.45,503.1,0.1767,0.1767,49.301,0,0,-39.5,-1.9);

	this.instance_128 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_128.setTransform(387.55,489.7,0.1767,0.1767,91.3111,0,0,-32.9,-1.5);

	this.instance_129 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_129.setTransform(375,510.3,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_130 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_130.setTransform(389.85,462.25,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_131 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_131.setTransform(384,490.05,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_132 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_132.setTransform(385.05,488.95,0.1765,0.1765,-52.9983,0,0,4.8,-7.9);

	this.instance_133 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_133.setTransform(383.55,474.7,0.1765,0.1765,-95.5899,0,0,39.3,-0.1);

	this.instance_134 = new lib.ch1_headcopy("synched",0);
	this.instance_134.setTransform(400,452.25,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_136.setTransform(401.55,498.65,0.1765,0.1765,-17.6375,0,0,4.2,-53.4);

	this.instance_137 = new lib.ch1_neckcopy("synched",0);
	this.instance_137.setTransform(399.1,456.05,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_139.setTransform(401.75,500.3,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_140 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_140.setTransform(401.4,483.35,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_141 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_141.setTransform(412.2,490.4,0.1765,0.1765,90.2724,0,0,-4.2,1.4);

	this.instance_142 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_142.setTransform(413.35,488.8,0.1765,0.1765,109.9886,0,0,-6.2,6.2);

	this.instance_143 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_143.setTransform(410.6,474.85,0.1766,0.1766,78.6464,0,0,-39.6,-2.5);

	this.instance_144 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_144.setTransform(407.95,461.8,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_145 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_145.setTransform(396.05,482.5,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_146 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_146.setTransform(96.65,486.85,0.1765,0.1765,-63.3619,0,0,35.4,1);

	this.instance_147 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_147.setTransform(90.8,514.65,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_148 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_148.setTransform(91.85,513.6,0.1765,0.1765,-52.9983,0,0,4.5,-7.7);

	this.instance_149 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_149.setTransform(90.4,499.3,0.1765,0.1765,-95.5899,0,0,39,-0.1);

	this.instance_150 = new lib.ch1_headcopy("synched",0);
	this.instance_150.setTransform(106.8,476.85,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_152.setTransform(108.35,523.25,0.1765,0.1765,-17.6375,0,0,4.1,-53.1);

	this.instance_153 = new lib.ch1_neckcopy("synched",0);
	this.instance_153.setTransform(105.9,480.65,0.1766,0.1766,10.6984,0,0,-0.7,8.8);

	this.instance_154 = new lib.ch1_lBodycopy("synched",0);
	this.instance_154.setTransform(105.8,499.4,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_155 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_155.setTransform(108.55,524.9,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_156 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_156.setTransform(108.2,507.95,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_157 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_157.setTransform(119,515,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_158 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_158.setTransform(120.2,513.4,0.1765,0.1765,109.9886,0,0,-6,6);

	this.instance_159 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_159.setTransform(117.4,499.45,0.1766,0.1766,78.6464,0,0,-39.6,-2.5);

	this.instance_160 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_160.setTransform(114.75,486.4,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_161 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_161.setTransform(102.85,507.1,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_162 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_162.setTransform(-2.3,490.3,0.1767,0.1767,-67.6896,0,0,35.1,-0.3);

	this.instance_163 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_163.setTransform(-2.65,518.3,0.1766,0.1766,-110.4825,0,0,6.6,-2.4);

	this.instance_164 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_164.setTransform(-3.2,516.85,0.1767,0.1767,-120.7491,0,0,5.7,-9.5);

	this.instance_165 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_165.setTransform(-7.6,503.15,0.1767,0.1767,-107.385,0,0,40.6,-0.9);

	this.instance_166 = new lib.ch1_headcopy2("synched",0);
	this.instance_166.setTransform(7.75,480.3,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_168.setTransform(10.25,525.95,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_169 = new lib.ch1_neckcopy2("synched",0);
	this.instance_169.setTransform(7.05,484.05,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_171.setTransform(7.45,527.6,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_172 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_172.setTransform(10.6,510.85,0.1766,0.1766,7.7828,0,0,-0.3,2);

	this.instance_173 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_173.setTransform(25.5,515.95,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_174 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_174.setTransform(25.05,513.9,0.1767,0.1767,58.3964,0,0,-5.7,8.2);

	this.instance_175 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_175.setTransform(15.8,503.15,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_176 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_176.setTransform(15.9,489.75,0.1767,0.1767,91.3062,0,0,-32.5,-0.7);

	this.instance_177 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_177.setTransform(3.35,510.35,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_178 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_178.setTransform(34.95,487.1,0.1767,0.1767,-67.6896,0,0,34.5,1.2);

	this.instance_179 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_179.setTransform(34.6,515.1,0.1766,0.1766,-110.4825,0,0,5.2,-1.7);

	this.instance_180 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_180.setTransform(34.05,513.65,0.1767,0.1767,-120.7491,0,0,4.1,-9.1);

	this.instance_181 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_181.setTransform(29.65,499.95,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_182 = new lib.ch1_headcopy2("synched",0);
	this.instance_182.setTransform(45,477.1,0.1768,0.1768,-1.9979,0,0,1,52.6);

	this.instance_183 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_183.setTransform(43.8,487.55,0.177,0.177,0,0,0,0,-22.6);

	this.instance_184 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_184.setTransform(47.5,522.75,0.1766,0.1766,-11.907,0,0,2.7,-52.6);

	this.instance_185 = new lib.ch1_neckcopy2("synched",0);
	this.instance_185.setTransform(44.3,480.85,0.1768,0.1768,10.1753,0,0,-0.1,9);

	this.instance_186 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_186.setTransform(44.15,499.65,0.177,0.177,0,0,0,0.3,-22.1);

	this.instance_187 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_187.setTransform(44.7,524.4,0.1765,0.1765,36.4509,0,0,4.5,-52.6);

	this.instance_188 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_188.setTransform(47.9,507.65,0.1766,0.1766,7.7828,0,0,-0.1,3.1);

	this.instance_189 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_189.setTransform(62.75,512.75,0.1766,0.1766,34.1032,0,0,-3.8,3.6);

	this.instance_190 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_190.setTransform(62.35,510.7,0.1767,0.1767,58.3964,0,0,-4.8,8.3);

	this.instance_191 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_191.setTransform(53.05,499.95,0.1766,0.1766,49.3015,0,0,-39.4,-0.2);

	this.instance_192 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_192.setTransform(53.15,486.55,0.1767,0.1767,91.3062,0,0,-31.7,-0.7);

	this.instance_193 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_193.setTransform(40.6,507.15,0.1766,0.1766,-26.6514,0,0,1.9,-44.3);

	this.instance_194 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_194.setTransform(119.25,478.55,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_195 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_195.setTransform(118.85,506.55,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_196 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_196.setTransform(118.3,505.1,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_197 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_197.setTransform(113.85,491.4,0.1767,0.1767,-107.385,0,0,40.3,0.1);

	this.instance_198 = new lib.ch1_headcopy2("synched",0);
	this.instance_198.setTransform(129.25,468.55,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_200.setTransform(131.75,514.2,0.1766,0.1766,-11.907,0,0,3,-54.1);

	this.instance_201 = new lib.ch1_neckcopy2("synched",0);
	this.instance_201.setTransform(128.55,472.3,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_203.setTransform(128.95,515.85,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_204 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_204.setTransform(132.1,499.1,0.1766,0.1766,7.7828,0,0,-0.3,2);

	this.instance_205 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_205.setTransform(147,504.2,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_206 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_206.setTransform(146.6,502.15,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_207 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_207.setTransform(137.3,491.4,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_208 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_208.setTransform(137.4,478,0.1767,0.1767,91.3062,0,0,-32.9,-0.7);

	this.instance_209 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_209.setTransform(124.85,498.6,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_210 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_210.setTransform(146.7,488.45,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_211 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_211.setTransform(146.3,516.45,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_212 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_212.setTransform(145.75,515,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_213 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_213.setTransform(141.3,501.3,0.1767,0.1767,-107.385,0,0,40.3,0.1);

	this.instance_214 = new lib.ch1_headcopy2("synched",0);
	this.instance_214.setTransform(156.7,478.45,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_216.setTransform(159.2,524.1,0.1766,0.1766,-11.907,0,0,3,-54.1);

	this.instance_217 = new lib.ch1_neckcopy2("synched",0);
	this.instance_217.setTransform(156,482.2,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_219.setTransform(156.4,525.75,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_220 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_220.setTransform(159.55,509,0.1766,0.1766,7.7828,0,0,0.2,1.9);

	this.instance_221 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_221.setTransform(174.45,514.1,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_222 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_222.setTransform(174.05,512.05,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_223 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_223.setTransform(164.75,501.3,0.1766,0.1766,49.3015,0,0,-39.9,-1.4);

	this.instance_224 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_224.setTransform(164.85,487.9,0.1767,0.1767,91.3062,0,0,-32.5,-0.7);

	this.instance_225 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_225.setTransform(152.3,508.5,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_226 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_226.setTransform(193.6,482.15,0.1765,0.1765,-63.3619,0,0,35.4,1);

	this.instance_227 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_227.setTransform(187.8,509.95,0.1765,0.1765,-85.354,0,0,5.4,-0.7);

	this.instance_228 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_228.setTransform(188.8,508.9,0.1765,0.1765,-52.9983,0,0,3.9,-7.2);

	this.instance_229 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_229.setTransform(187.3,494.6,0.1765,0.1765,-95.5899,0,0,38.1,-0.2);

	this.instance_230 = new lib.ch1_headcopy("synched",0);
	this.instance_230.setTransform(203.75,472.15,0.1767,0.1767,-1.0443,0,0,1.3,52.7);

	this.instance_231 = new lib.ch1_uBodycopy("synched",0);
	this.instance_231.setTransform(202.4,482.65,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_232 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_232.setTransform(205.3,518.55,0.1765,0.1765,-17.6375,0,0,2.8,-52.6);

	this.instance_233 = new lib.ch1_neckcopy("synched",0);
	this.instance_233.setTransform(202.85,475.95,0.1766,0.1766,10.6984,0,0,-0.7,8.8);

	this.instance_234 = new lib.ch1_lBodycopy("synched",0);
	this.instance_234.setTransform(202.75,494.7,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_235 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_235.setTransform(205.5,520.2,0.1764,0.1764,30.7096,0,0,5,-52.1);

	this.instance_236 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_236.setTransform(205.15,503.25,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_237 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_237.setTransform(215.95,510.3,0.1765,0.1765,90.2724,0,0,-3.4,2.3);

	this.instance_238 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_238.setTransform(217.15,508.7,0.1765,0.1765,109.9886,0,0,-4.9,6.6);

	this.instance_239 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_239.setTransform(214.35,494.75,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_240 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_240.setTransform(211.7,481.7,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_241 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_241.setTransform(199.8,502.4,0.1765,0.1765,-21.1353,0,0,1.5,-44.7);

	this.instance_242 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_242.setTransform(220.45,492.1,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_243 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_243.setTransform(220.05,520.1,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_244 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_244.setTransform(219.5,518.65,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_245 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_245.setTransform(215.1,504.95,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_246 = new lib.ch1_headcopy2("synched",0);
	this.instance_246.setTransform(230.5,482.1,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_248.setTransform(233,527.75,0.1766,0.1766,-11.9108,0,0,2.8,-54.1);

	this.instance_249 = new lib.ch1_neckcopy2("synched",0);
	this.instance_249.setTransform(229.75,485.85,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_251.setTransform(230.15,529.4,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_252 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_252.setTransform(233.3,512.65,0.1766,0.1766,7.787,0,0,-0.4,1.8);

	this.instance_253 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_253.setTransform(248.2,517.75,0.1767,0.1767,34.1046,0,0,-4.6,2.8);

	this.instance_254 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_254.setTransform(247.8,515.7,0.1767,0.1767,58.3948,0,0,-5.9,8);

	this.instance_255 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_255.setTransform(238.5,504.95,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_256 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_256.setTransform(238.6,491.55,0.1767,0.1767,91.3111,0,0,-32.9,-0.4);

	this.instance_257 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_257.setTransform(226.05,512.15,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_258 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_258.setTransform(341.95,480.35,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_259 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_259.setTransform(341.55,508.35,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_260 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_260.setTransform(341,506.9,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_261 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_261.setTransform(336.6,493.2,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_262 = new lib.ch1_headcopy2("synched",0);
	this.instance_262.setTransform(352,470.35,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_264.setTransform(354.45,516,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_265 = new lib.ch1_neckcopy2("synched",0);
	this.instance_265.setTransform(351.25,474.1,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_267.setTransform(351.65,517.65,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_268 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_268.setTransform(354.8,500.9,0.1766,0.1766,7.787,0,0,-0.4,1.8);

	this.instance_269 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_269.setTransform(369.7,506,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_270 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_270.setTransform(369.3,503.95,0.1767,0.1767,58.3948,0,0,-6,7.6);

	this.instance_271 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_271.setTransform(360,493.2,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_272 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_272.setTransform(360.1,479.8,0.1767,0.1767,91.3111,0,0,-32.9,-1.5);

	this.instance_273 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_273.setTransform(347.55,500.4,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_274 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_274.setTransform(354.75,461.6,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_275 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_275.setTransform(348.95,489.4,0.1765,0.1765,-85.3585,0,0,5.4,-0.7);

	this.instance_276 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_276.setTransform(349.95,488.35,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_277 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_277.setTransform(348.5,474.05,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_278 = new lib.ch1_headcopy("synched",0);
	this.instance_278.setTransform(364.9,451.6,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_279 = new lib.ch1_uBodycopy("synched",0);
	this.instance_279.setTransform(363.55,462.1,0.1768,0.1768,0,0,0,0,-22.6);

	this.instance_280 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_280.setTransform(366.45,498,0.1764,0.1764,-17.6357,0,0,3,-53.5);

	this.instance_281 = new lib.ch1_neckcopy("synched",0);
	this.instance_281.setTransform(364,455.4,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_282 = new lib.ch1_lBodycopy("synched",0);
	this.instance_282.setTransform(363.9,474.15,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_283 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_283.setTransform(366.65,499.65,0.1764,0.1764,30.7078,0,0,4.9,-52.4);

	this.instance_284 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_284.setTransform(366.3,482.7,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_285 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_285.setTransform(377.1,489.75,0.1765,0.1765,90.2674,0,0,-3.4,2.3);

	this.instance_286 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_286.setTransform(378.3,488.15,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_287 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_287.setTransform(375.5,474.2,0.1765,0.1765,78.6493,0,0,-39.9,-1.4);

	this.instance_288 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_288.setTransform(372.85,461.15,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_289 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_289.setTransform(360.95,481.85,0.1764,0.1764,-21.1325,0,0,1.6,-45);

	this.instance_290 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_290.setTransform(369.95,437.85,0.1767,0.1767,-90.7322,0,0,35.1,1.3);

	this.instance_291 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_291.setTransform(382,462.2,0.1766,0.1766,-148.1525,0,0,5.3,-1.7);

	this.instance_292 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_292.setTransform(381.35,460.75,0.1767,0.1767,-124.7938,0,0,4.5,-7.9);

	this.instance_293 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_293.setTransform(370.4,451.85,0.1766,0.1766,-141.5767,0,0,38.9,1.7);

	this.instance_294 = new lib.ch1_headcopy_1("synched",0);
	this.instance_294.setTransform(380.1,428.05,0.1768,0.1768,-3.6174,0,0,1.9,54);

	this.instance_295 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_295.setTransform(378.7,438.3,0.177,0.177,0,0,0,0,-23.2);

	this.instance_296 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_296.setTransform(375.85,475.45,0.1766,0.1766,16.7851,0,0,4.4,-54.2);

	this.instance_297 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_297.setTransform(379.2,431.65,0.1768,0.1768,12.0868,0,0,-0.1,9.2);

	this.instance_298 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_298.setTransform(379,450.45,0.177,0.177,0,0,0,0.8,-22.6);

	this.instance_299 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_299.setTransform(385.15,475.45,0.1766,0.1766,-11.5702,0,0,3.1,-53.4);

	this.instance_300 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_300.setTransform(381.75,458.85,0.1766,0.1766,-14.6979,0,0,-0.5,2.8);

	this.instance_301 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_301.setTransform(388.35,462.95,0.1767,0.1767,58.7222,0,0,-4.2,3.1);

	this.instance_302 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_302.setTransform(389.2,461.2,0.1767,0.1767,96.3659,0,0,-5.5,7.2);

	this.instance_303 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_303.setTransform(381.6,449.1,0.1767,0.1767,58.0466,0,0,-39.6,-1.3);

	this.instance_304 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_304.setTransform(388,437.3,0.1767,0.1767,119.3036,0,0,-33.4,-1.1);

	this.instance_305 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_305.setTransform(377.05,458.35,0.1767,0.1767,1.8162,0,0,2.8,-45.6);

	this.instance_306 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_306.setTransform(335.55,434.4,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_307 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_307.setTransform(335.15,462.4,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_308 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_308.setTransform(334.6,460.95,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_309 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_309.setTransform(330.2,447.25,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_310 = new lib.ch1_headcopy2("synched",0);
	this.instance_310.setTransform(345.6,424.4,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_312.setTransform(348.05,470.05,0.1766,0.1766,-11.9108,0,0,3,-54.1);

	this.instance_313 = new lib.ch1_neckcopy2("synched",0);
	this.instance_313.setTransform(344.85,428.15,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_315.setTransform(345.25,471.7,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_316 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_316.setTransform(348.4,454.95,0.1766,0.1766,7.787,0,0,-0.4,1.8);

	this.instance_317 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_317.setTransform(363.3,460.05,0.1767,0.1767,34.1046,0,0,-4.4,2.6);

	this.instance_318 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_318.setTransform(362.9,458,0.1767,0.1767,58.3948,0,0,-6.2,7.9);

	this.instance_319 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_319.setTransform(353.6,447.25,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_320 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_320.setTransform(353.7,433.85,0.1767,0.1767,91.3111,0,0,-33.1,-0.7);

	this.instance_321 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_321.setTransform(341.15,454.45,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);
	...
	this.instance_327.setTransform(362.5,417.65,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_330.setTransform(362.85,429.8,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_338.setTransform(71.9,472.45,0.1767,0.1767,-90.7322,0,0,35.1,2.5);

	this.instance_339 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_339.setTransform(83.95,496.8,0.1766,0.1766,-148.1525,0,0,4.6,-1.2);

	this.instance_340 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_340.setTransform(83.3,495.35,0.1767,0.1767,-124.7938,0,0,4,-7.2);

	this.instance_341 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_341.setTransform(72.35,486.45,0.1766,0.1766,-141.5767,0,0,38,2.4);

	this.instance_342 = new lib.ch1_headcopy_1("synched",0);
	this.instance_342.setTransform(82.05,462.6,0.1768,0.1768,-3.6174,0,0,3.1,54.3);

	this.instance_343 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_343.setTransform(80.65,472.9,0.177,0.177,0,0,0,1.2,-22.9);

	this.instance_344 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_344.setTransform(77.85,510.05,0.1766,0.1766,16.7851,0,0,5.2,-54.5);

	this.instance_345 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_345.setTransform(81.15,466.25,0.1768,0.1768,12.0868,0,0,1.1,9.1);

	this.instance_346 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_346.setTransform(80.95,485.05,0.177,0.177,0,0,0,1.7,-22.3);

	this.instance_347 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_347.setTransform(87.1,510.05,0.1766,0.1766,-11.5702,0,0,4.2,-53.2);

	this.instance_348 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_348.setTransform(83.7,493.45,0.1766,0.1766,-14.6979,0,0,0.7,3.1);

	this.instance_349 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_349.setTransform(90.3,497.55,0.1767,0.1767,58.7222,0,0,-3.6,2.1);

	this.instance_350 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_350.setTransform(91.15,495.8,0.1767,0.1767,96.3659,0,0,-5.6,6);

	this.instance_351 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_351.setTransform(83.55,483.65,0.1767,0.1767,58.0466,0,0,-38.9,-1.9);

	this.instance_352 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_352.setTransform(89.95,471.85,0.1767,0.1767,119.3036,0,0,-34,-2);

	this.instance_353 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_353.setTransform(79,492.95,0.1767,0.1767,1.8162,0,0,4,-45.7);

	this.instance_354 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_354.setTransform(-8.55,458.35,0.1767,0.1767,-67.6896,0,0,35.1,-0.3);

	this.instance_355 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_355.setTransform(-8.9,486.35,0.1766,0.1766,-110.4825,0,0,6.6,-2.4);

	this.instance_356 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_356.setTransform(-9.45,484.9,0.1767,0.1767,-120.7491,0,0,5.7,-9.5);

	this.instance_357 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_357.setTransform(-13.85,471.2,0.1767,0.1767,-107.385,0,0,40.6,-0.9);

	this.instance_358 = new lib.ch1_headcopy2("synched",0);
	this.instance_358.setTransform(1.5,448.35,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_360.setTransform(4,494,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_361 = new lib.ch1_neckcopy2("synched",0);
	this.instance_361.setTransform(0.8,452.1,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_363.setTransform(1.2,495.65,0.1765,0.1765,36.4509,0,0,2.9,-52.9);

	this.instance_364 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_364.setTransform(4.35,478.9,0.1766,0.1766,7.7828,0,0,0.2,1.9);

	this.instance_365 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_365.setTransform(19.25,484,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_366 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_366.setTransform(18.85,481.95,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_367 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_367.setTransform(9.55,471.2,0.1766,0.1766,49.3015,0,0,-39.9,-1.4);

	this.instance_368 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_368.setTransform(9.65,457.8,0.1767,0.1767,91.3062,0,0,-32.5,-0.7);

	this.instance_369 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_369.setTransform(-2.9,478.4,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_370 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_370.setTransform(-13.55,431.05,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_371 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_371.setTransform(-19.4,458.85,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_372 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_372.setTransform(-18.35,457.8,0.1764,0.1764,-53.0003,0,0,3.9,-7.2);

	this.instance_373 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_373.setTransform(-19.85,443.5,0.1765,0.1765,-95.5854,0,0,38.1,-0.2);

	this.instance_374 = new lib.ch1_headcopy("synched",0);
	this.instance_374.setTransform(-3.4,421.05,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_375 = new lib.ch1_uBodycopy("synched",0);
	this.instance_375.setTransform(-4.75,431.55,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_376 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_376.setTransform(-1.85,467.4,0.1764,0.1764,-17.6357,0,0,4.4,-53.1);

	this.instance_377 = new lib.ch1_neckcopy("synched",0);
	this.instance_377.setTransform(-4.3,424.85,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_378 = new lib.ch1_lBodycopy("synched",0);
	this.instance_378.setTransform(-4.4,443.6,0.1768,0.1768,0,0,0,0,-22.6);

	this.instance_379 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_379.setTransform(-1.65,469.1,0.1764,0.1764,30.7078,0,0,4.9,-52.4);

	this.instance_380 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_380.setTransform(-2,452.15,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_381 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_381.setTransform(8.8,459.2,0.1765,0.1765,90.2674,0,0,-4.2,1.2);

	this.instance_382 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_382.setTransform(10,457.6,0.1765,0.1765,109.9873,0,0,-6,5.8);

	this.instance_383 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_383.setTransform(7.2,443.65,0.1765,0.1765,78.6493,0,0,-39.6,-2.5);

	this.instance_384 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_384.setTransform(4.55,430.6,0.1765,0.1765,79.4856,0,0,-32.4,-1.1);

	this.instance_385 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_385.setTransform(-7.35,451.3,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_386 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_386.setTransform(14.95,466.95,0.1765,0.1765,-63.3618,0,0,34.6,1.4);

	this.instance_387 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_387.setTransform(9.1,494.75,0.1765,0.1765,-85.3585,0,0,5,-0.7);

	this.instance_388 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_388.setTransform(10.15,493.7,0.1764,0.1764,-53.0003,0,0,3.6,-7);

	this.instance_389 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_389.setTransform(8.65,479.4,0.1765,0.1765,-95.5854,0,0,37.9,-0.3);

	this.instance_390 = new lib.ch1_headcopy("synched",0);
	this.instance_390.setTransform(25.1,456.95,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_391 = new lib.ch1_uBodycopy("synched",0);
	this.instance_391.setTransform(23.75,467.45,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_392 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_392.setTransform(26.65,503.35,0.1764,0.1764,-17.6357,0,0,3,-52.3);

	this.instance_393 = new lib.ch1_neckcopy("synched",0);
	this.instance_393.setTransform(24.2,460.75,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_394 = new lib.ch1_lBodycopy("synched",0);
	this.instance_394.setTransform(24.1,479.5,0.1768,0.1768,0,0,0,0.3,-21.8);

	this.instance_395 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_395.setTransform(26.85,505,0.1764,0.1764,30.7078,0,0,5,-52.1);

	this.instance_396 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_396.setTransform(26.5,488.05,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_397 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_397.setTransform(37.3,495.1,0.1765,0.1765,90.2674,0,0,-3.1,2.3);

	this.instance_398 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_398.setTransform(38.45,493.5,0.1765,0.1765,109.9873,0,0,-4.5,6.5);

	this.instance_399 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_399.setTransform(35.7,479.55,0.1765,0.1765,78.6493,0,0,-39.9,-1.4);

	this.instance_400 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_400.setTransform(33.05,466.5,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_401 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_401.setTransform(21.15,487.2,0.1764,0.1764,-21.1325,0,0,1.5,-44.7);

	this.instance_402 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_402.setTransform(90.2,451.3,0.1765,0.1765,-63.3618,0,0,34.6,1.4);

	this.instance_403 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_403.setTransform(84.35,479.1,0.1765,0.1765,-85.3585,0,0,5,-0.7);

	this.instance_404 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_404.setTransform(85.4,478.05,0.1764,0.1764,-53.0003,0,0,3.6,-7);

	this.instance_405 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_405.setTransform(83.9,463.75,0.1765,0.1765,-95.5854,0,0,37.9,-0.3);

	this.instance_406 = new lib.ch1_headcopy("synched",0);
	this.instance_406.setTransform(100.35,441.3,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_407 = new lib.ch1_uBodycopy("synched",0);
	this.instance_407.setTransform(99,451.8,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_408 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_408.setTransform(101.9,487.7,0.1764,0.1764,-17.6357,0,0,4.1,-52.2);

	this.instance_409 = new lib.ch1_neckcopy("synched",0);
	this.instance_409.setTransform(99.45,445.1,0.1766,0.1766,10.6945,0,0,-0.7,8.8);
	...
	this.instance_411.setTransform(102.1,489.35,0.1764,0.1764,30.7078,0,0,5,-52.1);

	this.instance_412 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_412.setTransform(101.8,472.4,0.1764,0.1764,-3.3621,0,0,1,2.4);

	this.instance_413 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_413.setTransform(112.55,479.45,0.1765,0.1765,90.2674,0,0,-3.1,1.4);

	this.instance_414 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_414.setTransform(113.75,477.85,0.1765,0.1765,109.9873,0,0,-5.2,5.5);

	this.instance_415 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_415.setTransform(110.95,463.9,0.1765,0.1765,78.6493,0,0,-39.6,-2.5);

	this.instance_416 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_416.setTransform(108.3,450.85,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_417 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_417.setTransform(96.4,471.55,0.1764,0.1764,-21.1325,0,0,1.5,-44.7);
	...
	this.instance_423.setTransform(52.85,456.8,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_426.setTransform(53.2,468.95,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_434.setTransform(66.1,440.1,0.1767,0.1767,-67.6904,0,0,35.5,0.8);

	this.instance_435 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_435.setTransform(65.7,468.1,0.1766,0.1766,-110.4813,0,0,6.2,-1.3);

	this.instance_436 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_436.setTransform(65.15,466.65,0.1767,0.1767,-120.7473,0,0,5,-8.5);

	this.instance_437 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_437.setTransform(60.7,452.95,0.1767,0.1767,-107.3818,0,0,40.3,0.1);

	this.instance_438 = new lib.ch1_headcopy2("synched",0);
	this.instance_438.setTransform(76.1,430.1,0.1768,0.1768,-1.9933,0,0,1,52.6);

	this.instance_439 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_439.setTransform(74.9,440.55,0.177,0.177,0,0,0,0,-23.8);

	this.instance_440 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_440.setTransform(78.6,475.75,0.1766,0.1766,-11.9042,0,0,3,-54.1);

	this.instance_441 = new lib.ch1_neckcopy2("synched",0);
	this.instance_441.setTransform(75.4,433.85,0.1768,0.1768,10.1721,0,0,-0.1,9);

	this.instance_442 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_442.setTransform(75.25,452.65,0.177,0.177,0,0,0,0.3,-23.2);

	this.instance_443 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_443.setTransform(75.8,477.4,0.1765,0.1765,36.4488,0,0,3.8,-53.5);

	this.instance_444 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_444.setTransform(78.95,460.65,0.1765,0.1765,7.7792,0,0,-0.3,2);

	this.instance_445 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_445.setTransform(93.85,465.75,0.1766,0.1766,34.1019,0,0,-4.4,2.6);

	this.instance_446 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_446.setTransform(93.45,463.7,0.1767,0.1767,58.398,0,0,-5.8,7.8);

	this.instance_447 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_447.setTransform(84.15,452.95,0.1766,0.1766,49.3026,0,0,-40.2,-1);

	this.instance_448 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_448.setTransform(84.25,439.55,0.1767,0.1767,91.3014,0,0,-32.9,-0.7);

	this.instance_449 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_449.setTransform(71.7,460.15,0.1766,0.1766,-26.6514,0,0,2.5,-45.4);

	this.instance_450 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_450.setTransform(77.2,409.85,0.1767,0.1767,-67.6904,0,0,35.5,0.8);

	this.instance_451 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_451.setTransform(76.8,437.85,0.1766,0.1766,-110.4813,0,0,6.2,-1.3);

	this.instance_452 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_452.setTransform(76.25,436.4,0.1767,0.1767,-120.7473,0,0,5,-8.5);

	this.instance_453 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_453.setTransform(71.8,422.7,0.1767,0.1767,-107.3818,0,0,40.3,0.1);

	this.instance_454 = new lib.ch1_headcopy2("synched",0);
	this.instance_454.setTransform(87.2,399.85,0.1768,0.1768,-1.9933,0,0,1,52.6);

	this.instance_455 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_455.setTransform(86,410.3,0.177,0.177,0,0,0,0,-23.8);

	this.instance_456 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_456.setTransform(89.7,445.5,0.1766,0.1766,-11.9042,0,0,3,-54.1);

	this.instance_457 = new lib.ch1_neckcopy2("synched",0);
	this.instance_457.setTransform(86.5,403.6,0.1768,0.1768,10.1721,0,0,-0.1,9);

	this.instance_458 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_458.setTransform(86.35,422.4,0.177,0.177,0,0,0,0.3,-23.2);

	this.instance_459 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_459.setTransform(86.9,447.15,0.1765,0.1765,36.4488,0,0,3.8,-53.5);

	this.instance_460 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_460.setTransform(90.05,430.4,0.1765,0.1765,7.7792,0,0,-0.3,2);

	this.instance_461 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_461.setTransform(104.95,435.5,0.1766,0.1766,34.1019,0,0,-4.4,2.6);

	this.instance_462 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_462.setTransform(104.55,433.45,0.1767,0.1767,58.398,0,0,-5.8,7.8);

	this.instance_463 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_463.setTransform(95.25,422.7,0.1766,0.1766,49.3026,0,0,-40.2,-1);

	this.instance_464 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_464.setTransform(95.35,409.3,0.1767,0.1767,91.3014,0,0,-32.9,-0.7);

	this.instance_465 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_465.setTransform(82.8,429.9,0.1766,0.1766,-26.6514,0,0,2.5,-45.4);

	this.instance_466 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_466.setTransform(167.15,460.45,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_467 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_467.setTransform(161.3,488.25,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_468 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_468.setTransform(162.35,487.2,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_469 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_469.setTransform(160.9,472.9,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_470 = new lib.ch1_headcopy("synched",0);
	this.instance_470.setTransform(177.3,450.45,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_471 = new lib.ch1_uBodycopy("synched",0);
	this.instance_471.setTransform(175.95,460.95,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_472 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_472.setTransform(178.85,496.8,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_473 = new lib.ch1_neckcopy("synched",0);
	this.instance_473.setTransform(176.4,454.25,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_474 = new lib.ch1_lBodycopy("synched",0);
	this.instance_474.setTransform(176.3,473,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_475 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_475.setTransform(179.05,498.5,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_476 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_476.setTransform(178.7,481.55,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_477 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_477.setTransform(189.5,488.6,0.1765,0.1765,90.2674,0,0,-4.2,2);

	this.instance_478 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_478.setTransform(190.7,487,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_479 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_479.setTransform(187.9,473.05,0.1765,0.1765,78.6493,0,0,-39.9,-1.7);

	this.instance_480 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_480.setTransform(185.25,460,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_481 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_481.setTransform(173.35,480.7,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_482 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_482.setTransform(21.85,440.2,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_483 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_483.setTransform(21.45,468.2,0.1766,0.1766,-110.4825,0,0,6,-1.4);

	this.instance_484 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_484.setTransform(20.9,466.75,0.1767,0.1767,-120.7491,0,0,4.8,-8.7);

	this.instance_485 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_485.setTransform(16.5,453.05,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_486 = new lib.ch1_headcopy2("synched",0);
	this.instance_486.setTransform(31.85,430.2,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_488.setTransform(34.35,475.85,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_489 = new lib.ch1_neckcopy2("synched",0);
	this.instance_489.setTransform(31.15,433.95,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_491.setTransform(31.55,477.5,0.1765,0.1765,36.4509,0,0,4,-53.3);

	this.instance_492 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_492.setTransform(34.7,460.75,0.1766,0.1766,7.7828,0,0,-0.3,2);

	this.instance_493 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_493.setTransform(49.6,465.85,0.1766,0.1766,34.1032,0,0,-4.2,2.9);

	this.instance_494 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_494.setTransform(49.2,463.8,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_495 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_495.setTransform(39.9,453.05,0.1766,0.1766,49.3015,0,0,-40,-0.8);

	this.instance_496 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_496.setTransform(40,439.65,0.1767,0.1767,91.3062,0,0,-32.9,-0.7);

	this.instance_497 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_497.setTransform(27.45,460.3,0.1766,0.1766,-26.6514,0,0,2.2,-44.8);
	...
	this.instance_503.setTransform(16.8,420.35,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_506.setTransform(17.15,432.5,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_514.setTransform(-14.4,395.15,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_515 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_515.setTransform(-14.8,423.15,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_516 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_516.setTransform(-15.35,421.7,0.1767,0.1767,-120.7491,0,0,5.2,-8.8);

	this.instance_517 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_517.setTransform(-19.8,408,0.1767,0.1767,-107.385,0,0,40.3,0.1);

	this.instance_518 = new lib.ch1_headcopy2("synched",0);
	this.instance_518.setTransform(-4.4,385.15,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_520.setTransform(-1.9,430.8,0.1766,0.1766,-11.907,0,0,3,-54.1);

	this.instance_521 = new lib.ch1_neckcopy2("synched",0);
	this.instance_521.setTransform(-5.1,388.9,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_523.setTransform(-4.7,432.45,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_524 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_524.setTransform(-1.55,415.7,0.1766,0.1766,7.7828,0,0,0,2);

	this.instance_525 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_525.setTransform(13.35,420.8,0.1766,0.1766,34.1032,0,0,-3.5,2);

	this.instance_526 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_526.setTransform(12.95,418.75,0.1767,0.1767,58.3964,0,0,-5.2,6.8);

	this.instance_527 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_527.setTransform(3.6,408,0.1766,0.1766,49.3015,0,0,-39.3,-2);

	this.instance_528 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_528.setTransform(3.75,394.6,0.1767,0.1767,91.3062,0,0,-32.9,-1.8);

	this.instance_529 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_529.setTransform(-8.8,415.2,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_530 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_530.setTransform(132.15,459.65,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_531 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_531.setTransform(126.3,487.45,0.1765,0.1765,-85.3585,0,0,5.9,-0.8);

	this.instance_532 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_532.setTransform(127.35,486.4,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_533 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_533.setTransform(125.9,472.1,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_534 = new lib.ch1_headcopy("synched",0);
	this.instance_534.setTransform(142.3,449.65,0.1766,0.1766,-1.0395,0,0,1.3,52.7);
	...
	this.instance_536.setTransform(143.85,496.05,0.1764,0.1764,-17.6357,0,0,3,-53.5);

	this.instance_537 = new lib.ch1_neckcopy("synched",0);
	this.instance_537.setTransform(141.4,453.45,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_538 = new lib.ch1_lBodycopy("synched",0);
	this.instance_538.setTransform(141.3,472.2,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_539 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_539.setTransform(144.05,497.7,0.1764,0.1764,30.7078,0,0,4.5,-52.9);

	this.instance_540 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_540.setTransform(143.7,480.75,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_541 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_541.setTransform(154.5,487.8,0.1765,0.1765,90.2674,0,0,-4,2.3);

	this.instance_542 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_542.setTransform(155.7,486.2,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_543 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_543.setTransform(152.9,472.25,0.1765,0.1765,78.6493,0,0,-39.9,-1.4);

	this.instance_544 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_544.setTransform(150.25,459.2,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_545 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_545.setTransform(138.35,479.9,0.1764,0.1764,-21.1325,0,0,1.8,-45.5);

	this.instance_546 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_546.setTransform(147.3,436.05,0.1767,0.1767,-90.7322,0,0,35.1,1.3);

	this.instance_547 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_547.setTransform(159.35,460.4,0.1766,0.1766,-148.1525,0,0,5.5,-1.8);

	this.instance_548 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_548.setTransform(158.7,458.95,0.1767,0.1767,-124.7938,0,0,4.7,-8.2);

	this.instance_549 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_549.setTransform(147.75,450.05,0.1766,0.1766,-141.5767,0,0,38.9,1.7);

	this.instance_550 = new lib.ch1_headcopy_1("synched",0);
	this.instance_550.setTransform(157.45,426.2,0.1768,0.1768,-3.6174,0,0,1.9,54.2);

	this.instance_551 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_551.setTransform(156.05,436.5,0.177,0.177,0,0,0,0,-22.9);

	this.instance_552 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_552.setTransform(153.2,473.65,0.1766,0.1766,16.7851,0,0,4.4,-54.2);

	this.instance_553 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_553.setTransform(156.55,429.85,0.1768,0.1768,12.0868,0,0,-0.1,9.2);

	this.instance_554 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_554.setTransform(156.35,448.65,0.177,0.177,0,0,0,0.6,-22.3);

	this.instance_555 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_555.setTransform(162.5,473.65,0.1766,0.1766,-11.5702,0,0,3.1,-53.4);

	this.instance_556 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_556.setTransform(159.1,457.05,0.1766,0.1766,-14.6979,0,0,-0.5,2.8);

	this.instance_557 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_557.setTransform(165.7,461.15,0.1767,0.1767,58.7222,0,0,-4.2,3.1);

	this.instance_558 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_558.setTransform(166.55,459.4,0.1767,0.1767,96.3659,0,0,-5.5,7.2);

	this.instance_559 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_559.setTransform(159,447.3,0.1767,0.1767,58.0466,0,0,-39.3,-1.2);

	this.instance_560 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_560.setTransform(165.35,435.5,0.1767,0.1767,119.3036,0,0,-33.4,-1.1);

	this.instance_561 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_561.setTransform(154.4,456.55,0.1767,0.1767,1.8162,0,0,2.8,-45.6);

	this.instance_562 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_562.setTransform(167.45,423.3,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_563 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_563.setTransform(167.05,451.3,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_564 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_564.setTransform(166.5,449.85,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_565 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_565.setTransform(162.05,436.15,0.1767,0.1767,-107.385,0,0,40.3,0.1);

	this.instance_566 = new lib.ch1_headcopy2("synched",0);
	this.instance_566.setTransform(177.45,413.3,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_568.setTransform(179.95,458.95,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_569 = new lib.ch1_neckcopy2("synched",0);
	this.instance_569.setTransform(176.75,417.05,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_571.setTransform(177.15,460.6,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_572 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_572.setTransform(180.3,443.85,0.1766,0.1766,7.7828,0,0,0.2,1.9);

	this.instance_573 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_573.setTransform(195.2,448.95,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_574 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_574.setTransform(194.8,446.9,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_575 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_575.setTransform(185.5,436.15,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_576 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_576.setTransform(185.6,422.75,0.1767,0.1767,91.3062,0,0,-32.5,-0.7);

	this.instance_577 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_577.setTransform(173.05,443.35,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_578 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_578.setTransform(112.85,432.6,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_579 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_579.setTransform(112.45,460.6,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_580 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_580.setTransform(111.9,459.15,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_581 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_581.setTransform(107.45,445.45,0.1767,0.1767,-107.385,0,0,40.3,0.1);

	this.instance_582 = new lib.ch1_headcopy2("synched",0);
	this.instance_582.setTransform(122.85,422.6,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_584.setTransform(125.35,468.25,0.1766,0.1766,-11.907,0,0,4.1,-53.8);

	this.instance_585 = new lib.ch1_neckcopy2("synched",0);
	this.instance_585.setTransform(122.15,426.35,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_587.setTransform(122.55,469.9,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_588 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_588.setTransform(125.7,453.15,0.1766,0.1766,7.7828,0,0,0.6,1.9);

	this.instance_589 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_589.setTransform(140.6,458.25,0.1766,0.1766,34.1032,0,0,-3.5,2);

	this.instance_590 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_590.setTransform(140.2,456.2,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_591 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_591.setTransform(130.9,445.45,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_592 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_592.setTransform(131,432.05,0.1767,0.1767,91.3062,0,0,-32.9,-1.8);

	this.instance_593 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_593.setTransform(118.45,452.65,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_594 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_594.setTransform(390.15,425.1,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_595 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_595.setTransform(389.75,453.1,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_596 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_596.setTransform(389.2,451.65,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_597 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_597.setTransform(384.8,437.95,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_598 = new lib.ch1_headcopy2("synched",0);
	this.instance_598.setTransform(400.2,415.1,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_600.setTransform(402.65,460.75,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_601 = new lib.ch1_neckcopy2("synched",0);
	this.instance_601.setTransform(399.45,418.85,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_603.setTransform(399.85,462.4,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_604 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_604.setTransform(403,445.65,0.1766,0.1766,7.787,0,0,0.5,1.7);

	this.instance_605 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_605.setTransform(417.9,450.75,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_606 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_606.setTransform(417.5,448.7,0.1767,0.1767,58.3948,0,0,-5.8,7.8);

	this.instance_607 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_607.setTransform(408.2,437.95,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_608 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_608.setTransform(408.3,424.55,0.1767,0.1767,91.3111,0,0,-32.9,-1.5);

	this.instance_609 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_609.setTransform(395.75,445.15,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_610 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_610.setTransform(374.85,406.15,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_611 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_611.setTransform(369,433.95,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_612 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_612.setTransform(370.05,432.85,0.1765,0.1765,-52.9983,0,0,4.8,-7.9);

	this.instance_613 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_613.setTransform(368.55,418.6,0.1765,0.1765,-95.5899,0,0,39.3,-0.1);

	this.instance_614 = new lib.ch1_headcopy("synched",0);
	this.instance_614.setTransform(385,396.15,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_616.setTransform(386.55,442.55,0.1765,0.1765,-17.6375,0,0,3.1,-53.7);

	this.instance_617 = new lib.ch1_neckcopy("synched",0);
	this.instance_617.setTransform(384.1,399.95,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_619.setTransform(386.75,444.2,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_620 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_620.setTransform(386.4,427.25,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_621 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_621.setTransform(397.2,434.3,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_622 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_622.setTransform(398.4,432.7,0.1765,0.1765,109.9886,0,0,-5.9,7);

	this.instance_623 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_623.setTransform(395.6,418.75,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_624 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_624.setTransform(392.95,405.7,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_625 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_625.setTransform(381.05,426.4,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_626 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_626.setTransform(237.65,468.75,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_627 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_627.setTransform(231.8,496.55,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_628 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_628.setTransform(232.85,495.5,0.1765,0.1765,-52.9983,0,0,4.5,-7.7);

	this.instance_629 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_629.setTransform(231.4,481.2,0.1765,0.1765,-95.5899,0,0,39,-0.1);

	this.instance_630 = new lib.ch1_headcopy("synched",0);
	this.instance_630.setTransform(247.8,458.75,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_632.setTransform(249.35,505.15,0.1765,0.1765,-17.6375,0,0,3,-53.5);

	this.instance_633 = new lib.ch1_neckcopy("synched",0);
	this.instance_633.setTransform(246.9,462.55,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_635.setTransform(249.55,506.8,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_636 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_636.setTransform(249.2,489.85,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_637 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_637.setTransform(260,496.9,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_638 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_638.setTransform(261.2,495.3,0.1765,0.1765,109.9886,0,0,-5.5,7.2);

	this.instance_639 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_639.setTransform(258.4,481.35,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_640 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_640.setTransform(255.75,468.3,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_641 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_641.setTransform(243.85,489,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);
	...
	this.instance_647.setTransform(334.5,407.5,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_650.setTransform(334.85,419.65,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_658.setTransform(349.35,384.3,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_659 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_659.setTransform(348.95,412.3,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_660 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_660.setTransform(348.4,410.85,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_661 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_661.setTransform(344,397.15,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_662 = new lib.ch1_headcopy2("synched",0);
	this.instance_662.setTransform(359.4,374.3,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_664.setTransform(361.85,419.95,0.1766,0.1766,-11.9108,0,0,2.6,-53.9);

	this.instance_665 = new lib.ch1_neckcopy2("synched",0);
	this.instance_665.setTransform(358.65,378.05,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_667.setTransform(359.05,421.6,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_668 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_668.setTransform(362.2,404.85,0.1766,0.1766,7.787,0,0,-0.3,2);

	this.instance_669 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_669.setTransform(377.1,409.95,0.1767,0.1767,34.1046,0,0,-4.6,2.8);

	this.instance_670 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_670.setTransform(376.65,407.9,0.1767,0.1767,58.3948,0,0,-5.7,8.2);

	this.instance_671 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_671.setTransform(367.4,397.15,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_672 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_672.setTransform(367.5,383.75,0.1767,0.1767,91.3111,0,0,-32.5,-0.4);

	this.instance_673 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_673.setTransform(354.95,404.35,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_674 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_674.setTransform(299.8,411.65,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_675 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_675.setTransform(299.4,439.65,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_676 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_676.setTransform(298.85,438.2,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_677 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_677.setTransform(294.45,424.5,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_678 = new lib.ch1_headcopy2("synched",0);
	this.instance_678.setTransform(309.85,401.65,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_680.setTransform(312.3,447.3,0.1766,0.1766,-11.9108,0,0,3,-54.1);

	this.instance_681 = new lib.ch1_neckcopy2("synched",0);
	this.instance_681.setTransform(309.1,405.4,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_683.setTransform(309.5,448.95,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_684 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_684.setTransform(312.65,432.2,0.1766,0.1766,7.787,0,0,-0.4,1.8);

	this.instance_685 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_685.setTransform(327.55,437.3,0.1767,0.1767,34.1046,0,0,-4.4,2.6);

	this.instance_686 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_686.setTransform(327.15,435.25,0.1767,0.1767,58.3948,0,0,-6,7.6);

	this.instance_687 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_687.setTransform(317.85,424.5,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_688 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_688.setTransform(317.95,411.1,0.1767,0.1767,91.3111,0,0,-32.9,-0.7);

	this.instance_689 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_689.setTransform(305.4,431.7,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_690 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_690.setTransform(244.55,442,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_691 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_691.setTransform(244.15,470,0.1767,0.1767,-110.4854,0,0,5.5,-1.6);

	this.instance_692 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_692.setTransform(243.6,468.55,0.1767,0.1767,-120.7482,0,0,4.1,-9.1);

	this.instance_693 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_693.setTransform(239.2,454.85,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_694 = new lib.ch1_headcopy2("synched",0);
	this.instance_694.setTransform(254.6,432,0.1768,0.1768,-2.0027,0,0,1,52.6);

	this.instance_695 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_695.setTransform(253.35,442.45,0.177,0.177,0,0,0,0,-22.9);

	this.instance_696 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_696.setTransform(257.05,477.65,0.1766,0.1766,-11.9108,0,0,3,-53.8);

	this.instance_697 = new lib.ch1_neckcopy2("synched",0);
	this.instance_697.setTransform(253.85,435.75,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_699.setTransform(254.25,479.3,0.1765,0.1765,36.4519,0,0,4.5,-52.6);

	this.instance_700 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_700.setTransform(257.4,462.55,0.1766,0.1766,7.787,0,0,-0.2,2.9);

	this.instance_701 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_701.setTransform(272.3,467.65,0.1767,0.1767,34.1046,0,0,-3.8,3.6);

	this.instance_702 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_702.setTransform(271.9,465.6,0.1767,0.1767,58.3948,0,0,-5.5,7.9);

	this.instance_703 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_703.setTransform(262.6,454.85,0.1767,0.1767,49.301,0,0,-39.4,-0.2);

	this.instance_704 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_704.setTransform(262.7,441.45,0.1767,0.1767,91.3111,0,0,-32,-0.7);

	this.instance_705 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_705.setTransform(250.15,462.05,0.1766,0.1766,-26.6536,0,0,1.9,-44.3);

	this.instance_706 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_706.setTransform(190.5,452.05,0.1767,0.1767,-90.7322,0,0,35.1,1.3);

	this.instance_707 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_707.setTransform(202.55,476.4,0.1766,0.1766,-148.1525,0,0,5.3,-1.7);

	this.instance_708 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_708.setTransform(201.9,474.95,0.1767,0.1767,-124.7938,0,0,4.5,-7.9);

	this.instance_709 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_709.setTransform(190.95,466.05,0.1766,0.1766,-141.5767,0,0,38.9,1.7);

	this.instance_710 = new lib.ch1_headcopy_1("synched",0);
	this.instance_710.setTransform(200.65,442.2,0.1768,0.1768,-3.6174,0,0,1.9,54.2);

	this.instance_711 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_711.setTransform(199.25,452.5,0.177,0.177,0,0,0,0,-22.9);

	this.instance_712 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_712.setTransform(196.4,489.65,0.1766,0.1766,16.7851,0,0,4.4,-54.2);

	this.instance_713 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_713.setTransform(199.75,445.85,0.1768,0.1768,12.0868,0,0,-0.1,9.2);

	this.instance_714 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_714.setTransform(199.55,464.65,0.177,0.177,0,0,0,0.8,-22.3);

	this.instance_715 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_715.setTransform(205.7,489.65,0.1766,0.1766,-11.5702,0,0,3.1,-53.4);

	this.instance_716 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_716.setTransform(202.3,473.05,0.1766,0.1766,-14.6979,0,0,-0.5,2.8);

	this.instance_717 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_717.setTransform(208.9,477.15,0.1767,0.1767,58.7222,0,0,-4.2,3.1);

	this.instance_718 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_718.setTransform(209.75,475.4,0.1767,0.1767,96.3659,0,0,-5.5,6.9);

	this.instance_719 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_719.setTransform(202.15,463.25,0.1767,0.1767,58.0466,0,0,-38.9,-1.9);

	this.instance_720 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_720.setTransform(208.55,451.5,0.1767,0.1767,119.3036,0,0,-33.4,-1.1);

	this.instance_721 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_721.setTransform(197.6,472.55,0.1767,0.1767,1.8162,0,0,2.8,-45.6);

	this.instance_722 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_722.setTransform(214.2,460.15,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_723 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_723.setTransform(213.8,488.15,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_724 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_724.setTransform(213.25,486.7,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_725 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_725.setTransform(208.85,473,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_726 = new lib.ch1_headcopy2("synched",0);
	this.instance_726.setTransform(224.25,450.15,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_728.setTransform(226.7,495.8,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_729 = new lib.ch1_neckcopy2("synched",0);
	this.instance_729.setTransform(223.5,453.9,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_731.setTransform(223.9,497.45,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_732 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_732.setTransform(227.05,480.7,0.1766,0.1766,7.787,0,0,0.8,1.6);

	this.instance_733 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_733.setTransform(241.95,485.8,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_734 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_734.setTransform(241.55,483.75,0.1767,0.1767,58.3948,0,0,-5.3,7);

	this.instance_735 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_735.setTransform(232.3,473,0.1767,0.1767,49.301,0,0,-39.6,-1.7);

	this.instance_736 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_736.setTransform(232.35,459.6,0.1767,0.1767,91.3111,0,0,-32.9,-1.5);

	this.instance_737 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_737.setTransform(219.8,480.2,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);
	...
	this.instance_743.setTransform(139.85,415.85,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_746.setTransform(140.2,428,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_759.setTransform(111.85,405.65,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_762.setTransform(112.2,417.8,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_770.setTransform(209.15,432.85,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_771 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_771.setTransform(203.3,460.65,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_772 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_772.setTransform(204.35,459.55,0.1765,0.1765,-52.9983,0,0,4.8,-7.9);

	this.instance_773 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_773.setTransform(202.85,445.3,0.1765,0.1765,-95.5899,0,0,39.3,-0.1);

	this.instance_774 = new lib.ch1_headcopy("synched",0);
	this.instance_774.setTransform(219.3,422.85,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_776.setTransform(220.85,469.25,0.1765,0.1765,-17.6375,0,0,3.4,-53.6);

	this.instance_777 = new lib.ch1_neckcopy("synched",0);
	this.instance_777.setTransform(218.4,426.65,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_779.setTransform(221.05,470.9,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_780 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_780.setTransform(220.7,453.95,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_781 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_781.setTransform(231.5,461,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_782 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_782.setTransform(232.65,459.4,0.1765,0.1765,109.9886,0,0,-6.2,6.2);

	this.instance_783 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_783.setTransform(229.9,445.45,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_784 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_784.setTransform(227.25,432.4,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_785 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_785.setTransform(215.35,453.1,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);
	...
	this.instance_791.setTransform(239.4,422.2,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_794.setTransform(239.75,434.35,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_802.setTransform(190.05,411.4,0.1765,0.1765,-63.3641,0,0,35.4,1);

	this.instance_803 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_803.setTransform(184.25,439.2,0.1765,0.1765,-85.3627,0,0,5.4,-0.7);

	this.instance_804 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_804.setTransform(185.25,438.15,0.1764,0.1764,-53.0013,0,0,3.4,-6.8);

	this.instance_805 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_805.setTransform(183.75,423.85,0.1765,0.1765,-95.581,0,0,37.6,-0.3);

	this.instance_806 = new lib.ch1_headcopy("synched",0);
	this.instance_806.setTransform(200.2,401.4,0.1766,0.1766,-1.0346,0,0,1.3,52.7);

	this.instance_807 = new lib.ch1_uBodycopy("synched",0);
	this.instance_807.setTransform(198.85,411.9,0.1768,0.1768,0,0,0,0,-22.1);

	this.instance_808 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_808.setTransform(201.75,447.8,0.1764,0.1764,-17.6325,0,0,3,-52.3);

	this.instance_809 = new lib.ch1_neckcopy("synched",0);
	this.instance_809.setTransform(199.3,405.2,0.1766,0.1766,10.6905,0,0,-0.7,8.8);

	this.instance_810 = new lib.ch1_lBodycopy("synched",0);
	this.instance_810.setTransform(199.2,423.95,0.1768,0.1768,0,0,0,0.3,-22.7);

	this.instance_811 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_811.setTransform(201.95,449.45,0.1763,0.1763,30.7086,0,0,5.2,-51.9);

	this.instance_812 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_812.setTransform(201.6,432.5,0.1764,0.1764,-3.3577,0,0,0.1,2.3);

	this.instance_813 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_813.setTransform(212.4,439.55,0.1765,0.1765,90.2625,0,0,-3.4,2.3);

	this.instance_814 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_814.setTransform(213.55,437.95,0.1765,0.1765,109.9844,0,0,-4.5,6.5);

	this.instance_815 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_815.setTransform(210.8,424,0.1765,0.1765,78.6532,0,0,-39.9,-1.4);

	this.instance_816 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_816.setTransform(208.15,410.95,0.1765,0.1765,79.4896,0,0,-32.5,0);

	this.instance_817 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_817.setTransform(196.25,431.65,0.1764,0.1764,-21.1297,0,0,1.4,-44.5);

	this.instance_818 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_818.setTransform(214.2,397,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_819 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_819.setTransform(213.8,425,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_820 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_820.setTransform(213.25,423.55,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_821 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_821.setTransform(208.85,409.85,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_822 = new lib.ch1_headcopy2("synched",0);
	this.instance_822.setTransform(224.25,387,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_824.setTransform(226.7,432.65,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_825 = new lib.ch1_neckcopy2("synched",0);
	this.instance_825.setTransform(223.5,390.75,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_827.setTransform(223.9,434.3,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_828 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_828.setTransform(227.05,417.55,0.1766,0.1766,7.787,0,0,0.8,1.9);

	this.instance_829 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_829.setTransform(241.95,422.65,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_830 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_830.setTransform(241.55,420.6,0.1767,0.1767,58.3948,0,0,-5.3,7);

	this.instance_831 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_831.setTransform(232.3,409.85,0.1767,0.1767,49.301,0,0,-39.6,-1.7);

	this.instance_832 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_832.setTransform(232.35,396.45,0.1767,0.1767,91.3111,0,0,-32.9,-1.5);

	this.instance_833 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_833.setTransform(219.8,417.05,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_834 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_834.setTransform(196.5,366.45,0.1765,0.1765,-63.3641,0,0,34.4,1.5);

	this.instance_835 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_835.setTransform(190.65,394.3,0.1765,0.1765,-85.3627,0,0,4.8,-0.7);

	this.instance_836 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_836.setTransform(191.7,393.25,0.1764,0.1764,-53.0013,0,0,3.4,-6.8);

	this.instance_837 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_837.setTransform(190.2,378.95,0.1765,0.1765,-95.581,0,0,37.6,-0.3);

	this.instance_838 = new lib.ch1_headcopy("synched",0);
	this.instance_838.setTransform(206.65,356.5,0.1766,0.1766,-1.0346,0,0,1.3,52.7);

	this.instance_839 = new lib.ch1_uBodycopy("synched",0);
	this.instance_839.setTransform(205.3,367,0.1768,0.1768,0,0,0,0,-22.1);

	this.instance_840 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_840.setTransform(208.2,402.9,0.1764,0.1764,-17.6325,0,0,3,-52.3);

	this.instance_841 = new lib.ch1_neckcopy("synched",0);
	this.instance_841.setTransform(205.75,360.3,0.1766,0.1766,10.6905,0,0,-0.7,8.8);

	this.instance_842 = new lib.ch1_lBodycopy("synched",0);
	this.instance_842.setTransform(205.65,379.05,0.1768,0.1768,0,0,0,0.3,-21.5);

	this.instance_843 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_843.setTransform(208.4,404.55,0.1763,0.1763,30.7086,0,0,5.2,-51.9);

	this.instance_844 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_844.setTransform(208.1,387.6,0.1764,0.1764,-3.3577,0,0,0.1,3.4);

	this.instance_845 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_845.setTransform(218.85,394.65,0.1765,0.1765,90.2625,0,0,-2.8,2.3);

	this.instance_846 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_846.setTransform(220,393.05,0.1765,0.1765,109.9844,0,0,-4.5,6.5);

	this.instance_847 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_847.setTransform(217.25,379.1,0.1765,0.1765,78.6532,0,0,-38.8,-1.2);

	this.instance_848 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_848.setTransform(214.6,366.05,0.1765,0.1765,79.4896,0,0,-31.4,0.2);

	this.instance_849 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_849.setTransform(202.7,386.75,0.1764,0.1764,-21.1297,0,0,1.4,-44.5);

	this.instance_850 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_850.setTransform(306.7,380.8,0.1765,0.1765,-63.3619,0,0,35.4,1);

	this.instance_851 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_851.setTransform(300.85,408.6,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_852 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_852.setTransform(301.9,407.55,0.1765,0.1765,-52.9983,0,0,4.5,-7.7);

	this.instance_853 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_853.setTransform(300.45,393.25,0.1765,0.1765,-95.5899,0,0,39,-0.1);

	this.instance_854 = new lib.ch1_headcopy("synched",0);
	this.instance_854.setTransform(316.85,370.8,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_856.setTransform(318.4,417.15,0.1765,0.1765,-17.6375,0,0,3.3,-53.4);

	this.instance_857 = new lib.ch1_neckcopy("synched",0);
	this.instance_857.setTransform(315.95,374.6,0.1766,0.1766,10.6984,0,0,-0.7,8.8);

	this.instance_858 = new lib.ch1_lBodycopy("synched",0);
	this.instance_858.setTransform(315.85,393.35,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_859 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_859.setTransform(318.6,418.85,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_860 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_860.setTransform(318.25,401.9,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_861 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_861.setTransform(329.05,408.95,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_862 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_862.setTransform(330.25,407.35,0.1765,0.1765,109.9886,0,0,-5.7,6.9);

	this.instance_863 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_863.setTransform(327.45,393.4,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_864 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_864.setTransform(324.8,380.35,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_865 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_865.setTransform(312.9,401.05,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_866 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_866.setTransform(270.35,421.7,0.1765,0.1765,-63.3619,0,0,35.4,1);

	this.instance_867 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_867.setTransform(264.5,449.5,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_868 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_868.setTransform(265.55,448.45,0.1765,0.1765,-52.9983,0,0,4.5,-7.7);

	this.instance_869 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_869.setTransform(264.1,434.15,0.1765,0.1765,-95.5899,0,0,39,-0.1);

	this.instance_870 = new lib.ch1_headcopy("synched",0);
	this.instance_870.setTransform(280.5,411.7,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_872.setTransform(282.05,458.1,0.1765,0.1765,-17.6375,0,0,3,-53.5);

	this.instance_873 = new lib.ch1_neckcopy("synched",0);
	this.instance_873.setTransform(279.6,415.5,0.1766,0.1766,10.6984,0,0,-0.7,8.8);

	this.instance_874 = new lib.ch1_lBodycopy("synched",0);
	this.instance_874.setTransform(279.5,434.25,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_875 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_875.setTransform(282.25,459.75,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_876 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_876.setTransform(281.9,442.8,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_877 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_877.setTransform(292.7,449.85,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_878 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_878.setTransform(293.9,448.25,0.1765,0.1765,109.9886,0,0,-5.5,7.2);

	this.instance_879 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_879.setTransform(291.1,434.3,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_880 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_880.setTransform(288.45,421.25,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_881 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_881.setTransform(276.55,441.95,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_882 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_882.setTransform(280.5,392.1,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_883 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_883.setTransform(274.65,419.9,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_884 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_884.setTransform(275.7,418.85,0.1765,0.1765,-52.9983,0,0,4.5,-7.7);

	this.instance_885 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_885.setTransform(274.25,404.55,0.1765,0.1765,-95.5899,0,0,39,-0.1);

	this.instance_886 = new lib.ch1_headcopy("synched",0);
	this.instance_886.setTransform(290.65,382.1,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_888.setTransform(292.2,428.5,0.1765,0.1765,-17.6375,0,0,4.2,-53.4);

	this.instance_889 = new lib.ch1_neckcopy("synched",0);
	this.instance_889.setTransform(289.75,385.9,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_891.setTransform(292.4,430.15,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_892 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_892.setTransform(292.1,413.2,0.1764,0.1764,-3.3668,0,0,1,2.4);

	this.instance_893 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_893.setTransform(302.85,420.25,0.1765,0.1765,90.2724,0,0,-4.2,1.2);

	this.instance_894 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_894.setTransform(304,418.65,0.1765,0.1765,109.9886,0,0,-6.2,6.2);

	this.instance_895 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_895.setTransform(301.25,404.7,0.1766,0.1766,78.6464,0,0,-39.6,-2.5);

	this.instance_896 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_896.setTransform(298.6,391.65,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_897 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_897.setTransform(286.7,412.35,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_898 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_898.setTransform(252.2,405.05,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_899 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_899.setTransform(251.8,433.05,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_900 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_900.setTransform(251.25,431.6,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_901 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_901.setTransform(246.85,417.9,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_902 = new lib.ch1_headcopy2("synched",0);
	this.instance_902.setTransform(262.25,395.05,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_904.setTransform(264.7,440.7,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_905 = new lib.ch1_neckcopy2("synched",0);
	this.instance_905.setTransform(261.5,398.8,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_907.setTransform(261.9,442.35,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_908 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_908.setTransform(265.05,425.6,0.1766,0.1766,7.787,0,0,-0.3,2);

	this.instance_909 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_909.setTransform(279.95,430.7,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_910 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_910.setTransform(279.55,428.65,0.1767,0.1767,58.3948,0,0,-5.8,7.8);

	this.instance_911 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_911.setTransform(270.25,417.9,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_912 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_912.setTransform(270.35,404.5,0.1767,0.1767,91.3111,0,0,-32.9,-1.5);

	this.instance_913 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_913.setTransform(257.8,425.1,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_914 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_914.setTransform(231.8,378.9,0.1765,0.1765,-63.3641,0,0,35.4,1);

	this.instance_915 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_915.setTransform(225.95,406.7,0.1765,0.1765,-85.3627,0,0,5.7,-0.8);

	this.instance_916 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_916.setTransform(227,405.65,0.1764,0.1764,-53.0013,0,0,3.9,-7.2);

	this.instance_917 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_917.setTransform(225.5,391.35,0.1765,0.1765,-95.581,0,0,38.5,-0.2);

	this.instance_918 = new lib.ch1_headcopy("synched",0);
	this.instance_918.setTransform(241.95,368.9,0.1766,0.1766,-1.0346,0,0,1.3,52.7);

	this.instance_919 = new lib.ch1_uBodycopy("synched",0);
	this.instance_919.setTransform(240.6,379.4,0.1768,0.1768,0,0,0,0,-22.9);

	this.instance_920 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_920.setTransform(243.5,415.25,0.1764,0.1764,-17.6325,0,0,3.3,-53.4);

	this.instance_921 = new lib.ch1_neckcopy("synched",0);
	this.instance_921.setTransform(241.05,372.7,0.1766,0.1766,10.6905,0,0,-0.7,8.8);

	this.instance_922 = new lib.ch1_lBodycopy("synched",0);
	this.instance_922.setTransform(240.95,391.45,0.1768,0.1768,0,0,0,0.3,-22.7);

	this.instance_923 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_923.setTransform(243.7,416.95,0.1763,0.1763,30.7086,0,0,4.7,-52.6);

	this.instance_924 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_924.setTransform(243.35,400,0.1764,0.1764,-3.3577,0,0,0.1,2.3);

	this.instance_925 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_925.setTransform(254.15,407.05,0.1765,0.1765,90.2625,0,0,-3.6,2.3);

	this.instance_926 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_926.setTransform(255.35,405.45,0.1765,0.1765,109.9844,0,0,-5.7,6.9);

	this.instance_927 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_927.setTransform(252.55,391.5,0.1765,0.1765,78.6532,0,0,-39.9,-1.4);

	this.instance_928 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_928.setTransform(249.9,378.45,0.1765,0.1765,79.4896,0,0,-32.5,0);

	this.instance_929 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_929.setTransform(238.05,399.15,0.1764,0.1764,-21.1297,0,0,1.7,-45.2);

	this.instance_930 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_930.setTransform(261.5,375.95,0.1767,0.1767,-90.7322,0,0,34.2,1.3);

	this.instance_931 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_931.setTransform(273.55,400.3,0.1766,0.1766,-148.1525,0,0,5.1,-2.5);

	this.instance_932 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_932.setTransform(272.9,398.85,0.1767,0.1767,-124.7938,0,0,4.7,-8.2);

	this.instance_933 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_933.setTransform(261.95,389.95,0.1766,0.1766,-141.5767,0,0,38.9,1.7);

	this.instance_934 = new lib.ch1_headcopy_1("synched",0);
	this.instance_934.setTransform(271.65,366.1,0.1768,0.1768,-3.6174,0,0,1.9,55.1);

	this.instance_935 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_935.setTransform(270.25,376.4,0.177,0.177,0,0,0,0,-22.3);

	this.instance_936 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_936.setTransform(267.4,413.5,0.1766,0.1766,16.7851,0,0,4.4,-53.1);

	this.instance_937 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_937.setTransform(270.75,369.75,0.1768,0.1768,12.0868,0,0,0.2,10.3);

	this.instance_938 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_938.setTransform(270.55,388.55,0.177,0.177,0,0,0,0.6,-21.4);

	this.instance_939 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_939.setTransform(276.7,413.55,0.1766,0.1766,-11.5702,0,0,3.1,-53.4);

	this.instance_940 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_940.setTransform(273.25,396.95,0.1766,0.1766,-14.6979,0,0,-0.8,3.9);

	this.instance_941 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_941.setTransform(279.9,401.05,0.1767,0.1767,58.7222,0,0,-3.2,3.6);

	this.instance_942 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_942.setTransform(280.75,399.3,0.1767,0.1767,96.3659,0,0,-5.5,7.2);

	this.instance_943 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_943.setTransform(273.15,387.2,0.1767,0.1767,58.0466,0,0,-38.6,-0.7);

	this.instance_944 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_944.setTransform(279.55,375.45,0.1767,0.1767,119.3036,0,0,-32.6,-1.5);

	this.instance_945 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_945.setTransform(268.6,396.45,0.1767,0.1767,1.8162,0,0,2.8,-45.6);

	this.instance_946 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_946.setTransform(249.75,354.35,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_947 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_947.setTransform(249.35,382.35,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_948 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_948.setTransform(248.8,380.9,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_949 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_949.setTransform(244.4,367.2,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_950 = new lib.ch1_headcopy2("synched",0);
	this.instance_950.setTransform(259.8,344.35,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_952.setTransform(262.25,390,0.1766,0.1766,-11.9108,0,0,3,-53.8);

	this.instance_953 = new lib.ch1_neckcopy2("synched",0);
	this.instance_953.setTransform(259.05,348.1,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_955.setTransform(259.45,391.65,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_956 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_956.setTransform(262.6,374.9,0.1766,0.1766,7.787,0,0,-0.2,2.9);

	this.instance_957 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_957.setTransform(277.5,380,0.1767,0.1767,34.1046,0,0,-4.4,2.6);

	this.instance_958 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_958.setTransform(277.05,377.95,0.1767,0.1767,58.3948,0,0,-5.7,8.2);

	this.instance_959 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_959.setTransform(267.8,367.2,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_960 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_960.setTransform(267.9,353.8,0.1767,0.1767,91.3111,0,0,-32.5,-0.7);

	this.instance_961 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_961.setTransform(255.35,374.4,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_962 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_962.setTransform(382.85,375.15,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_963 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_963.setTransform(377,402.95,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_964 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_964.setTransform(378.05,401.85,0.1765,0.1765,-52.9983,0,0,4.8,-7.9);

	this.instance_965 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_965.setTransform(376.55,387.6,0.1765,0.1765,-95.5899,0,0,39.3,-0.1);

	this.instance_966 = new lib.ch1_headcopy("synched",0);
	this.instance_966.setTransform(393,365.15,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_968.setTransform(394.55,411.55,0.1765,0.1765,-17.6375,0,0,3.1,-53.7);

	this.instance_969 = new lib.ch1_neckcopy("synched",0);
	this.instance_969.setTransform(392.1,368.95,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_971.setTransform(394.75,413.2,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_972 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_972.setTransform(394.4,396.25,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_973 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_973.setTransform(405.2,403.3,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_974 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_974.setTransform(406.4,401.7,0.1765,0.1765,109.9886,0,0,-5.8,7.2);

	this.instance_975 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_975.setTransform(403.6,387.75,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_976 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_976.setTransform(400.95,374.7,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_977 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_977.setTransform(389.05,395.4,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_978 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_978.setTransform(329.1,361.5,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_979 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_979.setTransform(328.7,389.5,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_980 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_980.setTransform(328.15,388.05,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_981 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_981.setTransform(323.75,374.35,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_982 = new lib.ch1_headcopy2("synched",0);
	this.instance_982.setTransform(339.15,351.5,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_984.setTransform(341.6,397.15,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_985 = new lib.ch1_neckcopy2("synched",0);
	this.instance_985.setTransform(338.4,355.25,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_987.setTransform(338.8,398.8,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_988 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_988.setTransform(341.95,382.05,0.1766,0.1766,7.787,0,0,0.8,1.6);

	this.instance_989 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_989.setTransform(356.85,387.15,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_990 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_990.setTransform(356.45,385.1,0.1767,0.1767,58.3948,0,0,-5.8,7.8);

	this.instance_991 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_991.setTransform(347.15,374.35,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_992 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_992.setTransform(347.25,360.95,0.1767,0.1767,91.3111,0,0,-32.9,-1.5);

	this.instance_993 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_993.setTransform(334.7,381.55,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_994 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_994.setTransform(323.8,336.45,0.1767,0.1767,-90.7371,0,0,35.1,1.3);

	this.instance_995 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_995.setTransform(335.85,360.8,0.1767,0.1767,-148.1509,0,0,5.5,-1.8);

	this.instance_996 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_996.setTransform(335.2,359.35,0.1767,0.1767,-124.7922,0,0,4.7,-8.2);

	this.instance_997 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_997.setTransform(324.25,350.45,0.1767,0.1767,-141.5759,0,0,38.9,1.7);

	this.instance_998 = new lib.ch1_headcopy_1("synched",0);
	this.instance_998.setTransform(333.95,326.6,0.1768,0.1768,-3.6217,0,0,1.9,54.8);
	...
	this.instance_1000.setTransform(329.7,374.05,0.1767,0.1767,16.7869,0,0,4.6,-53.4);

	this.instance_1001 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_1001.setTransform(333.05,330.25,0.1768,0.1768,12.0906,0,0,0.1,10.1);

	this.instance_1002 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_1002.setTransform(332.85,349.05,0.177,0.177,0,0,0,0.8,-21.8);

	this.instance_1003 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_1003.setTransform(339,374.05,0.1766,0.1766,-11.574,0,0,3.1,-53.4);

	this.instance_1004 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_1004.setTransform(335.6,357.45,0.1766,0.1766,-14.7015,0,0,-0.7,3.6);

	this.instance_1005 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_1005.setTransform(342.2,361.55,0.1767,0.1767,58.7231,0,0,-4.2,3.1);

	this.instance_1006 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_1006.setTransform(343.05,359.8,0.1767,0.1767,96.3702,0,0,-5.5,7.2);

	this.instance_1007 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_1007.setTransform(335.4,347.75,0.1767,0.1767,58.0476,0,0,-38.8,-0.8);

	this.instance_1008 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_1008.setTransform(341.85,335.9,0.1767,0.1767,119.3055,0,0,-33.4,-1.1);

	this.instance_1009 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_1009.setTransform(330.9,356.95,0.1767,0.1767,1.821,0,0,2.8,-45.6);

	this.instance_1010 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1010.setTransform(286.95,351.25,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1011 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1011.setTransform(286.55,379.25,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_1012 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1012.setTransform(286,377.8,0.1767,0.1767,-120.7482,0,0,4.4,-9);

	this.instance_1013 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1013.setTransform(281.6,364.1,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_1014 = new lib.ch1_headcopy2("synched",0);
	this.instance_1014.setTransform(297,341.25,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_1016.setTransform(299.45,386.9,0.1766,0.1766,-11.9108,0,0,3,-53.8);

	this.instance_1017 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1017.setTransform(296.25,345,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1019.setTransform(296.65,388.55,0.1765,0.1765,36.4519,0,0,4.3,-52.8);

	this.instance_1020 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1020.setTransform(299.8,371.8,0.1766,0.1766,7.787,0,0,-0.2,2.9);

	this.instance_1021 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1021.setTransform(314.7,376.9,0.1767,0.1767,34.1046,0,0,-4.4,2.6);

	this.instance_1022 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1022.setTransform(314.3,374.85,0.1767,0.1767,58.3948,0,0,-5.5,7.9);

	this.instance_1023 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1023.setTransform(305,364.1,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_1024 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1024.setTransform(305.1,350.7,0.1767,0.1767,91.3111,0,0,-32.5,-0.7);

	this.instance_1025 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1025.setTransform(292.55,371.3,0.1766,0.1766,-26.6536,0,0,2.1,-44.6);

	this.instance_1026 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1026.setTransform(266.85,331.1,0.1765,0.1765,-63.3618,0,0,35.6,0.8);

	this.instance_1027 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1027.setTransform(261,358.9,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1028 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1028.setTransform(262.05,357.8,0.1764,0.1764,-53.0003,0,0,4.8,-7.9);

	this.instance_1029 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1029.setTransform(260.55,343.55,0.1765,0.1765,-95.5854,0,0,39.3,-0.1);

	this.instance_1030 = new lib.ch1_headcopy("synched",0);
	this.instance_1030.setTransform(277,321.1,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1031 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1031.setTransform(275.65,331.6,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1032 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1032.setTransform(278.55,367.5,0.1764,0.1764,-17.6357,0,0,3.4,-53.6);

	this.instance_1033 = new lib.ch1_neckcopy("synched",0);
	this.instance_1033.setTransform(276.1,324.9,0.1766,0.1766,10.6945,0,0,-0.7,8.8);
	...
	this.instance_1035.setTransform(278.75,369.15,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1036 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1036.setTransform(278.45,352.2,0.1764,0.1764,-3.3621,0,0,1,2.4);

	this.instance_1037 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1037.setTransform(289.2,359.25,0.1765,0.1765,90.2674,0,0,-4.2,1.4);

	this.instance_1038 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1038.setTransform(290.4,357.65,0.1765,0.1765,109.9873,0,0,-6.3,5.9);

	this.instance_1039 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1039.setTransform(287.6,343.7,0.1765,0.1765,78.6493,0,0,-39.7,-2.2);

	this.instance_1040 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1040.setTransform(284.95,330.65,0.1765,0.1765,79.4856,0,0,-32.4,-0.8);

	this.instance_1041 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1041.setTransform(273.05,351.35,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_1042 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1042.setTransform(348.6,351,0.1765,0.1765,-63.3619,0,0,34.6,1.4);

	this.instance_1043 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1043.setTransform(342.75,378.8,0.1765,0.1765,-85.354,0,0,5,-0.7);

	this.instance_1044 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1044.setTransform(343.8,377.75,0.1765,0.1765,-52.9983,0,0,3.9,-7.2);

	this.instance_1045 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1045.setTransform(342.3,363.45,0.1765,0.1765,-95.5899,0,0,38.1,-0.2);

	this.instance_1046 = new lib.ch1_headcopy("synched",0);
	this.instance_1046.setTransform(358.75,341,0.1767,0.1767,-1.0443,0,0,1.3,52.7);

	this.instance_1047 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1047.setTransform(357.4,351.5,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_1048 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1048.setTransform(360.3,387.4,0.1765,0.1765,-17.6375,0,0,2.8,-52.6);

	this.instance_1049 = new lib.ch1_neckcopy("synched",0);
	this.instance_1049.setTransform(357.85,344.8,0.1766,0.1766,10.6984,0,0,-0.7,8.8);

	this.instance_1050 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1050.setTransform(357.75,363.55,0.1768,0.1768,0,0,0,0.3,-21.8);

	this.instance_1051 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1051.setTransform(360.5,389.05,0.1764,0.1764,30.7096,0,0,5,-52.1);

	this.instance_1052 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1052.setTransform(360.2,372.1,0.1764,0.1764,-3.3668,0,0,0.1,3.4);

	this.instance_1053 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1053.setTransform(370.95,379.15,0.1765,0.1765,90.2724,0,0,-3.1,2.3);

	this.instance_1054 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1054.setTransform(372.15,377.55,0.1765,0.1765,109.9886,0,0,-4.9,6.6);

	this.instance_1055 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1055.setTransform(369.35,363.6,0.1766,0.1766,78.6464,0,0,-38.8,-1.2);

	this.instance_1056 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1056.setTransform(366.7,350.55,0.1765,0.1765,79.4817,0,0,-31.4,0.2);

	this.instance_1057 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1057.setTransform(354.8,371.25,0.1765,0.1765,-21.1353,0,0,1.5,-44.7);

	this.instance_1058 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1058.setTransform(371.25,342.6,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1059 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1059.setTransform(370.85,370.6,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_1060 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1060.setTransform(370.3,369.15,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_1061 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1061.setTransform(365.9,355.45,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_1062 = new lib.ch1_headcopy2("synched",0);
	this.instance_1062.setTransform(381.3,332.6,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_1064.setTransform(383.75,378.25,0.1766,0.1766,-11.9108,0,0,2.6,-53.9);

	this.instance_1065 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1065.setTransform(380.55,336.35,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1067.setTransform(380.95,379.9,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_1068 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1068.setTransform(384.1,363.15,0.1766,0.1766,7.787,0,0,-0.3,2);

	this.instance_1069 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1069.setTransform(399,368.25,0.1767,0.1767,34.1046,0,0,-4.6,2.8);

	this.instance_1070 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1070.setTransform(398.6,366.2,0.1767,0.1767,58.3948,0,0,-5.9,8);

	this.instance_1071 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1071.setTransform(389.3,355.45,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_1072 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1072.setTransform(389.4,342.05,0.1767,0.1767,91.3111,0,0,-32.5,-0.4);

	this.instance_1073 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1073.setTransform(376.85,362.65,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_1074 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1074.setTransform(398.6,352.6,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1075 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1075.setTransform(398.2,380.6,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_1076 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1076.setTransform(397.65,379.15,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_1077 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1077.setTransform(393.25,365.45,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_1078 = new lib.ch1_headcopy2("synched",0);
	this.instance_1078.setTransform(408.65,342.6,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_1080.setTransform(411.1,388.25,0.1766,0.1766,-11.9108,0,0,3,-54.1);

	this.instance_1081 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1081.setTransform(407.9,346.35,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1083.setTransform(408.3,389.9,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_1084 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1084.setTransform(411.45,373.15,0.1766,0.1766,7.787,0,0,-0.4,1.8);

	this.instance_1085 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1085.setTransform(426.35,378.25,0.1767,0.1767,34.1046,0,0,-4.4,2.6);

	this.instance_1086 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1086.setTransform(425.95,376.2,0.1767,0.1767,58.3948,0,0,-5.8,7.8);

	this.instance_1087 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1087.setTransform(416.65,365.45,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_1088 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1088.setTransform(416.75,352.05,0.1767,0.1767,91.3111,0,0,-32.9,-0.7);

	this.instance_1089 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1089.setTransform(404.2,372.65,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_1090 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1090.setTransform(342.3,315.4,0.1765,0.1765,-63.3619,0,0,34.6,1.4);

	this.instance_1091 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1091.setTransform(336.45,343.2,0.1765,0.1765,-85.354,0,0,5,-0.7);

	this.instance_1092 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1092.setTransform(337.5,342.15,0.1765,0.1765,-52.9983,0,0,3.9,-7.2);

	this.instance_1093 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1093.setTransform(336,327.85,0.1765,0.1765,-95.5899,0,0,38.1,-0.2);

	this.instance_1094 = new lib.ch1_headcopy("synched",0);
	this.instance_1094.setTransform(352.45,305.4,0.1767,0.1767,-1.0443,0,0,1.3,52.7);

	this.instance_1095 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1095.setTransform(351.1,315.9,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_1096 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1096.setTransform(354,351.8,0.1765,0.1765,-17.6375,0,0,3.1,-52.6);

	this.instance_1097 = new lib.ch1_neckcopy("synched",0);
	this.instance_1097.setTransform(351.55,309.2,0.1766,0.1766,10.6984,0,0,-0.7,8.8);

	this.instance_1098 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1098.setTransform(351.45,327.95,0.1768,0.1768,0,0,0,0.3,-21.8);

	this.instance_1099 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1099.setTransform(354.2,353.45,0.1764,0.1764,30.7096,0,0,5,-52.1);

	this.instance_1100 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1100.setTransform(353.85,336.5,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_1101 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1101.setTransform(364.65,343.55,0.1765,0.1765,90.2724,0,0,-3.1,2.3);

	this.instance_1102 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1102.setTransform(365.85,341.95,0.1765,0.1765,109.9886,0,0,-4.9,6.6);

	this.instance_1103 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1103.setTransform(363.05,328,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_1104 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1104.setTransform(360.4,314.95,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_1105 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1105.setTransform(348.5,335.65,0.1765,0.1765,-21.1353,0,0,1.5,-44.7);

	this.instance_1106 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1106.setTransform(383.95,323.5,0.1765,0.1765,-63.3618,0,0,35.6,0.8);

	this.instance_1107 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1107.setTransform(378.1,351.3,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1108 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1108.setTransform(379.15,350.25,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_1109 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1109.setTransform(377.7,335.95,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_1110 = new lib.ch1_headcopy("synched",0);
	this.instance_1110.setTransform(394.1,313.5,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1111 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1111.setTransform(392.75,324,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1112 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1112.setTransform(395.65,359.9,0.1764,0.1764,-17.6357,0,0,3.4,-53.6);

	this.instance_1113 = new lib.ch1_neckcopy("synched",0);
	this.instance_1113.setTransform(393.2,317.3,0.1766,0.1766,10.6945,0,0,-0.7,8.8);
	...
	this.instance_1115.setTransform(395.85,361.55,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1116 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1116.setTransform(395.55,344.6,0.1764,0.1764,-3.3621,0,0,1,2.4);

	this.instance_1117 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1117.setTransform(406.3,351.65,0.1765,0.1765,90.2674,0,0,-4.2,1.4);

	this.instance_1118 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1118.setTransform(407.5,350.05,0.1765,0.1765,109.9873,0,0,-6.3,5.9);

	this.instance_1119 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1119.setTransform(404.7,336.1,0.1765,0.1765,78.6493,0,0,-39.7,-2.2);

	this.instance_1120 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1120.setTransform(402.05,323.05,0.1765,0.1765,79.4856,0,0,-32.4,-0.8);

	this.instance_1121 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1121.setTransform(390.15,343.75,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_1122 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1122.setTransform(364.85,296.7,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1123 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1123.setTransform(364.45,324.7,0.1767,0.1767,-110.4854,0,0,5.5,-1.6);

	this.instance_1124 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1124.setTransform(363.9,323.25,0.1767,0.1767,-120.7482,0,0,4.4,-9);

	this.instance_1125 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1125.setTransform(359.5,309.55,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_1126 = new lib.ch1_headcopy2("synched",0);
	this.instance_1126.setTransform(374.9,286.7,0.1768,0.1768,-2.0027,0,0,1,52.6);

	this.instance_1127 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_1127.setTransform(373.65,297.15,0.177,0.177,0,0,0,0,-22.9);

	this.instance_1128 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_1128.setTransform(377.35,332.35,0.1766,0.1766,-11.9108,0,0,3.8,-53.6);

	this.instance_1129 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1129.setTransform(374.15,290.45,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1131.setTransform(374.55,334,0.1765,0.1765,36.4519,0,0,4.3,-52.8);

	this.instance_1132 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1132.setTransform(377.7,317.25,0.1766,0.1766,7.787,0,0,0.7,2.8);

	this.instance_1133 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1133.setTransform(392.6,322.35,0.1767,0.1767,34.1046,0,0,-3.2,2.9);

	this.instance_1134 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1134.setTransform(392.2,320.3,0.1767,0.1767,58.3948,0,0,-5.5,7.9);

	this.instance_1135 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1135.setTransform(382.9,309.55,0.1767,0.1767,49.301,0,0,-39.6,-0.5);

	this.instance_1136 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1136.setTransform(383,296.15,0.1767,0.1767,91.3111,0,0,-32.6,-1.5);

	this.instance_1137 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1137.setTransform(370.45,316.75,0.1766,0.1766,-26.6536,0,0,1.9,-44.3);
	...
	this.instance_1143.setTransform(304.8,320.9,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_1146.setTransform(305.15,333.05,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_1154.setTransform(318.05,304.2,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1155 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1155.setTransform(317.65,332.2,0.1767,0.1767,-110.4854,0,0,5.2,-1.7);

	this.instance_1156 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1156.setTransform(317.1,330.75,0.1767,0.1767,-120.7482,0,0,4.1,-9.1);

	this.instance_1157 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1157.setTransform(312.7,317.05,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_1158 = new lib.ch1_headcopy2("synched",0);
	this.instance_1158.setTransform(328.1,294.2,0.1768,0.1768,-2.0027,0,0,1,52.6);

	this.instance_1159 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_1159.setTransform(326.85,304.65,0.177,0.177,0,0,0,0,-22.9);

	this.instance_1160 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_1160.setTransform(330.55,339.85,0.1766,0.1766,-11.9108,0,0,2.8,-53);

	this.instance_1161 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1161.setTransform(327.35,297.95,0.1768,0.1768,10.1793,0,0,-0.1,9);

	this.instance_1162 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_1162.setTransform(327.2,316.75,0.177,0.177,0,0,0,0.3,-22.1);

	this.instance_1163 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_1163.setTransform(327.75,341.5,0.1765,0.1765,36.4519,0,0,4.5,-52.6);

	this.instance_1164 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1164.setTransform(330.9,324.75,0.1766,0.1766,7.787,0,0,-0.2,2.9);

	this.instance_1165 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1165.setTransform(345.8,329.85,0.1767,0.1767,34.1046,0,0,-3.8,3.6);

	this.instance_1166 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1166.setTransform(345.4,327.8,0.1767,0.1767,58.3948,0,0,-5.5,7.9);

	this.instance_1167 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1167.setTransform(336.1,317.05,0.1767,0.1767,49.301,0,0,-39.4,-0.2);

	this.instance_1168 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1168.setTransform(336.2,303.65,0.1767,0.1767,91.3111,0,0,-32,-0.7);

	this.instance_1169 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1169.setTransform(323.65,324.25,0.1766,0.1766,-26.6536,0,0,1.9,-44.3);

	this.instance_1170 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1170.setTransform(273.85,304.2,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1171 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1171.setTransform(273.45,332.2,0.1767,0.1767,-110.4854,0,0,5.2,-1.7);

	this.instance_1172 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1172.setTransform(272.9,330.75,0.1767,0.1767,-120.7482,0,0,4.1,-9.1);

	this.instance_1173 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1173.setTransform(268.5,317.05,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_1174 = new lib.ch1_headcopy2("synched",0);
	this.instance_1174.setTransform(283.9,294.2,0.1768,0.1768,-2.0027,0,0,1,52.6);

	this.instance_1175 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_1175.setTransform(282.65,304.65,0.177,0.177,0,0,0,0,-22.9);

	this.instance_1176 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_1176.setTransform(286.35,339.85,0.1766,0.1766,-11.9108,0,0,3.6,-52.8);

	this.instance_1177 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1177.setTransform(283.15,297.95,0.1768,0.1768,10.1793,0,0,-0.1,9);

	this.instance_1178 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_1178.setTransform(283,316.75,0.177,0.177,0,0,0,0.3,-22.1);

	this.instance_1179 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_1179.setTransform(283.55,341.5,0.1765,0.1765,36.4519,0,0,4.5,-52.6);

	this.instance_1180 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1180.setTransform(286.7,324.75,0.1766,0.1766,7.787,0,0,1,2.8);

	this.instance_1181 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1181.setTransform(301.6,329.85,0.1767,0.1767,34.1046,0,0,-3.1,3.1);

	this.instance_1182 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1182.setTransform(301.2,327.8,0.1767,0.1767,58.3948,0,0,-5.1,7.2);

	this.instance_1183 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1183.setTransform(291.9,317.05,0.1767,0.1767,49.301,0,0,-38.6,-1.1);

	this.instance_1184 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1184.setTransform(292.05,303.65,0.1767,0.1767,91.3111,0,0,-32,-1.6);

	this.instance_1185 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1185.setTransform(279.45,324.25,0.1766,0.1766,-26.6536,0,0,1.9,-44.3);

	this.instance_1186 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1186.setTransform(222.95,344.35,0.1765,0.1765,-63.3641,0,0,35.4,1);

	this.instance_1187 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1187.setTransform(217.15,372.15,0.1765,0.1765,-85.3627,0,0,5.4,-0.7);

	this.instance_1188 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1188.setTransform(218.15,371.1,0.1764,0.1764,-53.0013,0,0,3.9,-7.2);

	this.instance_1189 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1189.setTransform(216.65,356.8,0.1765,0.1765,-95.581,0,0,38.1,-0.2);

	this.instance_1190 = new lib.ch1_headcopy("synched",0);
	this.instance_1190.setTransform(233.1,334.35,0.1766,0.1766,-1.0346,0,0,1.3,52.7);

	this.instance_1191 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1191.setTransform(231.75,344.85,0.1768,0.1768,0,0,0,0,-22.7);

	this.instance_1192 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1192.setTransform(234.65,380.7,0.1764,0.1764,-17.6325,0,0,4.4,-53.1);

	this.instance_1193 = new lib.ch1_neckcopy("synched",0);
	this.instance_1193.setTransform(232.2,338.15,0.1766,0.1766,10.6905,0,0,-0.7,8.8);

	this.instance_1194 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1194.setTransform(232.1,356.9,0.1768,0.1768,0,0,0,0.3,-22.7);

	this.instance_1195 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1195.setTransform(234.85,382.4,0.1763,0.1763,30.7086,0,0,4.9,-52.4);

	this.instance_1196 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1196.setTransform(234.55,365.45,0.1764,0.1764,-3.3577,0,0,1,2.4);

	this.instance_1197 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1197.setTransform(245.3,372.5,0.1765,0.1765,90.2625,0,0,-3.4,1.2);

	this.instance_1198 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1198.setTransform(246.5,370.9,0.1765,0.1765,109.9844,0,0,-6,5.8);

	this.instance_1199 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1199.setTransform(243.75,356.95,0.1765,0.1765,78.6532,0,0,-39.6,-2.5);

	this.instance_1200 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1200.setTransform(241.05,343.9,0.1765,0.1765,79.4896,0,0,-32.5,0);

	this.instance_1201 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1201.setTransform(229.15,364.6,0.1764,0.1764,-21.1297,0,0,1.6,-45);

	this.instance_1202 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1202.setTransform(243.55,322.5,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1203 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1203.setTransform(243.15,350.5,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_1204 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1204.setTransform(242.6,349.05,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_1205 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1205.setTransform(238.2,335.35,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_1206 = new lib.ch1_headcopy2("synched",0);
	this.instance_1206.setTransform(253.6,312.5,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_1208.setTransform(256.05,358.15,0.1766,0.1766,-11.9108,0,0,3,-54.1);

	this.instance_1209 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1209.setTransform(252.85,316.25,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1211.setTransform(253.25,359.8,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_1212 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1212.setTransform(256.4,343.05,0.1766,0.1766,7.787,0,0,-0.3,2);

	this.instance_1213 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1213.setTransform(271.3,348.15,0.1767,0.1767,34.1046,0,0,-4.4,2.6);

	this.instance_1214 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1214.setTransform(270.9,346.1,0.1767,0.1767,58.3948,0,0,-5.8,7.8);

	this.instance_1215 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1215.setTransform(261.6,335.35,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_1216 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1216.setTransform(261.7,321.95,0.1767,0.1767,91.3111,0,0,-32.9,-0.7);

	this.instance_1217 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1217.setTransform(249.15,342.55,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_1218 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1218.setTransform(299.7,283.95,0.1765,0.1765,-63.3619,0,0,35.4,1);

	this.instance_1219 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1219.setTransform(293.85,311.75,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_1220 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1220.setTransform(294.9,310.7,0.1765,0.1765,-52.9983,0,0,3.9,-7.2);

	this.instance_1221 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1221.setTransform(293.4,296.4,0.1765,0.1765,-95.5899,0,0,38.1,-0.2);

	this.instance_1222 = new lib.ch1_headcopy("synched",0);
	this.instance_1222.setTransform(309.85,273.95,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_1224.setTransform(311.4,320.3,0.1765,0.1765,-17.6375,0,0,3.3,-53.4);

	this.instance_1225 = new lib.ch1_neckcopy("synched",0);
	this.instance_1225.setTransform(308.95,277.75,0.1766,0.1766,10.6984,0,0,-0.7,8.8);

	this.instance_1226 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1226.setTransform(308.85,296.5,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1227 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1227.setTransform(311.6,322,0.1764,0.1764,30.7096,0,0,4.9,-52.4);

	this.instance_1228 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1228.setTransform(311.25,305.05,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_1229 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1229.setTransform(322.05,312.1,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_1230 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1230.setTransform(323.25,310.5,0.1765,0.1765,109.9886,0,0,-6,6);

	this.instance_1231 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1231.setTransform(320.45,296.55,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_1232 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1232.setTransform(317.8,283.5,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_1233 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1233.setTransform(305.9,304.2,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_1234 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1234.setTransform(329.1,273.9,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1235 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1235.setTransform(328.7,301.9,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_1236 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1236.setTransform(328.15,300.45,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_1237 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1237.setTransform(323.75,286.75,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_1238 = new lib.ch1_headcopy2("synched",0);
	this.instance_1238.setTransform(339.15,263.9,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_1240.setTransform(341.6,309.55,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_1241 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1241.setTransform(338.4,267.65,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1243.setTransform(338.8,311.2,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_1244 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1244.setTransform(341.95,294.45,0.1766,0.1766,7.787,0,0,0.8,1.9);

	this.instance_1245 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1245.setTransform(356.85,299.55,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_1246 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1246.setTransform(356.45,297.5,0.1767,0.1767,58.3948,0,0,-5.8,7.8);

	this.instance_1247 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1247.setTransform(347.15,286.75,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_1248 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1248.setTransform(347.25,273.35,0.1767,0.1767,91.3111,0,0,-32.6,-1.5);

	this.instance_1249 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1249.setTransform(334.7,293.95,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);
	...
	this.instance_1255.setTransform(363.85,269.8,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_1258.setTransform(364.2,281.95,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_1266.setTransform(335.95,243,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_1267 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1267.setTransform(330.1,270.8,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_1268 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1268.setTransform(331.15,269.75,0.1765,0.1765,-52.9983,0,0,4.5,-7.7);

	this.instance_1269 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1269.setTransform(329.7,255.45,0.1765,0.1765,-95.5899,0,0,39,-0.1);

	this.instance_1270 = new lib.ch1_headcopy("synched",0);
	this.instance_1270.setTransform(346.1,233,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_1272.setTransform(347.65,279.4,0.1765,0.1765,-17.6375,0,0,3.1,-53.7);

	this.instance_1273 = new lib.ch1_neckcopy("synched",0);
	this.instance_1273.setTransform(345.2,236.8,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_1275.setTransform(347.85,281.05,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_1276 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1276.setTransform(347.5,264.1,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_1277 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1277.setTransform(358.3,271.15,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_1278 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1278.setTransform(359.5,269.55,0.1765,0.1765,109.9886,0,0,-5.8,7.2);

	this.instance_1279 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1279.setTransform(356.7,255.6,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_1280 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1280.setTransform(354.05,242.55,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_1281 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1281.setTransform(342.15,263.25,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_1282 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1282.setTransform(419.15,324.5,0.1765,0.1765,-63.3619,0,0,35.6,0.8);

	this.instance_1283 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1283.setTransform(413.3,352.3,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_1284 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1284.setTransform(414.35,351.2,0.1765,0.1765,-52.9983,0,0,4.8,-7.9);

	this.instance_1285 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1285.setTransform(412.85,336.95,0.1765,0.1765,-95.5899,0,0,39.3,-0.1);

	this.instance_1286 = new lib.ch1_headcopy("synched",0);
	this.instance_1286.setTransform(429.3,314.5,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_1288.setTransform(430.85,360.9,0.1765,0.1765,-17.6375,0,0,4.2,-53.4);

	this.instance_1289 = new lib.ch1_neckcopy("synched",0);
	this.instance_1289.setTransform(428.4,318.3,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_1291.setTransform(431.05,362.55,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_1292 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1292.setTransform(430.75,345.6,0.1764,0.1764,-3.3668,0,0,1.3,2.4);

	this.instance_1293 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1293.setTransform(441.5,352.65,0.1765,0.1765,90.2724,0,0,-4.2,1.2);

	this.instance_1294 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1294.setTransform(442.65,351.05,0.1765,0.1765,109.9886,0,0,-6.2,6.2);

	this.instance_1295 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1295.setTransform(439.9,337.1,0.1766,0.1766,78.6464,0,0,-39.6,-2.5);

	this.instance_1296 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1296.setTransform(437.25,324.05,0.1765,0.1765,79.4817,0,0,-32.4,-1.1);

	this.instance_1297 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1297.setTransform(425.35,344.75,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_1298 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_1298.setTransform(399.15,299.95,0.1768,0.1768,-90.7419,0,0,34.5,1.9);

	this.instance_1299 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_1299.setTransform(411.2,324.3,0.1767,0.1767,-148.1494,0,0,4.5,-1.8);

	this.instance_1300 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_1300.setTransform(410.55,322.85,0.1767,0.1767,-124.7975,0,0,3.9,-8);

	this.instance_1301 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_1301.setTransform(399.55,313.9,0.1767,0.1767,-141.5712,0,0,38.5,2);

	this.instance_1302 = new lib.ch1_headcopy_1("synched",0);
	this.instance_1302.setTransform(409.3,290.1,0.1768,0.1768,-3.6263,0,0,2.5,54.6);

	this.instance_1303 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_1303.setTransform(407.9,300.4,0.177,0.177,0,0,0,0,-22.9);

	this.instance_1304 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_1304.setTransform(405.05,337.55,0.1767,0.1767,16.7902,0,0,4.8,-53.8);

	this.instance_1305 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_1305.setTransform(408.4,293.75,0.1768,0.1768,12.0944,0,0,0.1,9.8);

	this.instance_1306 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_1306.setTransform(408.2,312.55,0.177,0.177,0,0,0,1.2,-22.1);

	this.instance_1307 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_1307.setTransform(414.35,337.55,0.1766,0.1766,-11.5779,0,0,4,-53.2);

	this.instance_1308 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_1308.setTransform(410.95,320.95,0.1766,0.1766,-14.705,0,0,0.2,3.6);

	this.instance_1309 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_1309.setTransform(417.55,325.05,0.1767,0.1767,58.7215,0,0,-3.2,2.6);

	this.instance_1310 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_1310.setTransform(418.4,323.25,0.1767,0.1767,96.3746,0,0,-5,6.8);

	this.instance_1311 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_1311.setTransform(410.8,311.2,0.1767,0.1767,58.046,0,0,-38.9,-1.2);

	this.instance_1312 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_1312.setTransform(417.2,299.4,0.1767,0.1767,119.3074,0,0,-33.3,-2.1);

	this.instance_1313 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_1313.setTransform(406.25,320.45,0.1767,0.1767,1.8256,0,0,3.6,-45.7);

	this.instance_1314 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1314.setTransform(419.4,287.4,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1315 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1315.setTransform(419,315.4,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_1316 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1316.setTransform(418.45,313.95,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_1317 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1317.setTransform(414.05,300.25,0.1767,0.1767,-107.3868,0,0,40.2,0.1);

	this.instance_1318 = new lib.ch1_headcopy2("synched",0);
	this.instance_1318.setTransform(429.45,277.4,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_1320.setTransform(431.9,323.05,0.1766,0.1766,-11.9108,0,0,3.9,-53.9);

	this.instance_1321 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1321.setTransform(428.7,281.15,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1323.setTransform(429.1,324.7,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_1324 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1324.setTransform(432.25,307.95,0.1766,0.1766,7.787,0,0,-0.4,1.8);

	this.instance_1325 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1325.setTransform(447.15,313.05,0.1767,0.1767,34.1046,0,0,-3.6,2.1);

	this.instance_1326 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1326.setTransform(446.75,311,0.1767,0.1767,58.3948,0,0,-6,7.6);

	this.instance_1327 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1327.setTransform(437.45,300.25,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_1328 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1328.setTransform(437.55,286.85,0.1767,0.1767,91.3111,0,0,-33.1,-0.7);

	this.instance_1329 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1329.setTransform(425,307.45,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);
	...
	this.instance_1335.setTransform(391.8,279.95,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_1338.setTransform(392.15,292.1,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_1346.setTransform(404.05,268.45,0.1765,0.1765,-63.3619,0,0,35.4,1);

	this.instance_1347 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1347.setTransform(398.2,296.25,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_1348 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1348.setTransform(399.25,295.2,0.1765,0.1765,-52.9983,0,0,3.9,-7.2);

	this.instance_1349 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1349.setTransform(397.75,280.9,0.1765,0.1765,-95.5899,0,0,38.1,-0.2);

	this.instance_1350 = new lib.ch1_headcopy("synched",0);
	this.instance_1350.setTransform(414.2,258.45,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_1352.setTransform(415.75,304.85,0.1765,0.1765,-17.6375,0,0,4.1,-53.1);

	this.instance_1353 = new lib.ch1_neckcopy("synched",0);
	this.instance_1353.setTransform(413.3,262.25,0.1766,0.1766,10.6984,0,0,-0.7,8.8);

	this.instance_1354 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1354.setTransform(413.2,281,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1355 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1355.setTransform(415.95,306.5,0.1764,0.1764,30.7096,0,0,4.9,-52.4);

	this.instance_1356 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1356.setTransform(415.6,289.55,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_1357 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1357.setTransform(426.4,296.6,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_1358 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1358.setTransform(427.6,295,0.1765,0.1765,109.9886,0,0,-6,6);

	this.instance_1359 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1359.setTransform(424.8,281.05,0.1766,0.1766,78.6464,0,0,-39.6,-2.5);

	this.instance_1360 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1360.setTransform(422.15,268,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_1361 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1361.setTransform(410.25,288.7,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_1362 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1362.setTransform(378.6,246.5,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1363 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1363.setTransform(378.2,274.5,0.1767,0.1767,-110.4854,0,0,6.2,-1.3);

	this.instance_1364 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1364.setTransform(377.65,273.05,0.1767,0.1767,-120.7482,0,0,5,-8.5);

	this.instance_1365 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1365.setTransform(373.25,259.35,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_1366 = new lib.ch1_headcopy2("synched",0);
	this.instance_1366.setTransform(388.65,236.5,0.1768,0.1768,-2.0027,0,0,1,52.6);
	...
	this.instance_1368.setTransform(391.1,282.15,0.1766,0.1766,-11.9108,0,0,2.6,-53.9);

	this.instance_1369 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1369.setTransform(387.9,240.25,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1371.setTransform(388.3,283.8,0.1765,0.1765,36.4519,0,0,3.8,-53.5);

	this.instance_1372 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1372.setTransform(391.45,267.05,0.1766,0.1766,7.787,0,0,-0.3,2);

	this.instance_1373 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1373.setTransform(406.35,272.15,0.1767,0.1767,34.1046,0,0,-4.6,2.8);

	this.instance_1374 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1374.setTransform(405.9,270.1,0.1767,0.1767,58.3948,0,0,-5.7,8.2);

	this.instance_1375 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1375.setTransform(396.65,259.35,0.1767,0.1767,49.301,0,0,-40.2,-1);

	this.instance_1376 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1376.setTransform(396.75,245.95,0.1767,0.1767,91.3111,0,0,-32.5,-0.4);

	this.instance_1377 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1377.setTransform(384.2,266.55,0.1766,0.1766,-26.6536,0,0,2.5,-45.3);

	this.instance_1378 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1378.setTransform(152.15,404.35,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1379 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1379.setTransform(146.3,432.15,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1380 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1380.setTransform(147.35,431.1,0.1764,0.1764,-53.0003,0,0,3.9,-7.2);

	this.instance_1381 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1381.setTransform(145.85,416.8,0.1765,0.1765,-95.5854,0,0,38.1,-0.2);

	this.instance_1382 = new lib.ch1_headcopy("synched",0);
	this.instance_1382.setTransform(162.3,394.35,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1383 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1383.setTransform(160.95,404.85,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1384 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1384.setTransform(163.85,440.7,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_1385 = new lib.ch1_neckcopy("synched",0);
	this.instance_1385.setTransform(161.4,398.15,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1386 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1386.setTransform(161.3,416.9,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1387 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1387.setTransform(164.05,442.4,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1388 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1388.setTransform(163.7,425.45,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_1389 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1389.setTransform(174.5,432.5,0.1765,0.1765,90.2674,0,0,-4.2,2.3);

	this.instance_1390 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1390.setTransform(175.7,430.9,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_1391 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1391.setTransform(172.9,416.95,0.1765,0.1765,78.6493,0,0,-39.9,-1.4);

	this.instance_1392 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1392.setTransform(170.25,403.9,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_1393 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1393.setTransform(158.35,424.6,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_1394 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1394.setTransform(84,379,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1395 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1395.setTransform(78.15,406.8,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1396 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1396.setTransform(79.2,405.75,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_1397 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1397.setTransform(77.75,391.45,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_1398 = new lib.ch1_headcopy("synched",0);
	this.instance_1398.setTransform(94.15,369,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1399 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1399.setTransform(92.8,379.5,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1400 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1400.setTransform(95.7,415.35,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_1401 = new lib.ch1_neckcopy("synched",0);
	this.instance_1401.setTransform(93.25,372.8,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1402 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1402.setTransform(93.15,391.55,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1403 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1403.setTransform(95.9,417.05,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1404 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1404.setTransform(95.55,400.1,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_1405 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1405.setTransform(106.35,407.15,0.1765,0.1765,90.2674,0,0,-4.2,2.3);

	this.instance_1406 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1406.setTransform(107.55,405.55,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_1407 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1407.setTransform(104.75,391.6,0.1765,0.1765,78.6493,0,0,-39.9,-1.4);

	this.instance_1408 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1408.setTransform(102.1,378.55,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_1409 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1409.setTransform(90.2,399.25,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_1410 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1410.setTransform(47.7,419.8,0.1765,0.1765,-63.3618,0,0,35.6,0.8);

	this.instance_1411 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1411.setTransform(41.85,447.6,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1412 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1412.setTransform(42.9,446.55,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_1413 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1413.setTransform(41.45,432.25,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_1414 = new lib.ch1_headcopy("synched",0);
	this.instance_1414.setTransform(57.85,409.8,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1415 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1415.setTransform(56.5,420.3,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1416 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1416.setTransform(59.4,456.2,0.1764,0.1764,-17.6357,0,0,3.4,-53.6);

	this.instance_1417 = new lib.ch1_neckcopy("synched",0);
	this.instance_1417.setTransform(56.95,413.6,0.1766,0.1766,10.6945,0,0,-0.7,8.8);
	...
	this.instance_1419.setTransform(59.6,457.85,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1420 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1420.setTransform(59.3,440.9,0.1764,0.1764,-3.3621,0,0,1,2.4);

	this.instance_1421 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1421.setTransform(70.05,447.95,0.1765,0.1765,90.2674,0,0,-4.2,1.4);

	this.instance_1422 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1422.setTransform(71.25,446.35,0.1765,0.1765,109.9873,0,0,-6.3,5.9);

	this.instance_1423 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1423.setTransform(68.45,432.4,0.1765,0.1765,78.6493,0,0,-39.7,-2.2);

	this.instance_1424 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1424.setTransform(65.8,419.35,0.1765,0.1765,79.4856,0,0,-32.4,-0.8);

	this.instance_1425 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1425.setTransform(53.9,440.05,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_1426 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1426.setTransform(57.8,390.3,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1427 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1427.setTransform(52,418.1,0.1765,0.1765,-85.3585,0,0,5.4,-0.7);

	this.instance_1428 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1428.setTransform(53,417.05,0.1764,0.1764,-53.0003,0,0,3.6,-7);

	this.instance_1429 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1429.setTransform(51.5,402.75,0.1765,0.1765,-95.5854,0,0,37.9,-0.3);

	this.instance_1430 = new lib.ch1_headcopy("synched",0);
	this.instance_1430.setTransform(67.95,380.3,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1431 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1431.setTransform(66.6,390.8,0.1768,0.1768,0,0,0,0,-22.6);

	this.instance_1432 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1432.setTransform(69.5,426.7,0.1764,0.1764,-17.6357,0,0,3.1,-52.6);

	this.instance_1433 = new lib.ch1_neckcopy("synched",0);
	this.instance_1433.setTransform(67.05,384.1,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1434 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1434.setTransform(66.95,402.85,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1435 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1435.setTransform(69.7,428.35,0.1764,0.1764,30.7078,0,0,5,-52.1);

	this.instance_1436 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1436.setTransform(69.4,411.4,0.1764,0.1764,-3.3621,0,0,0.5,2.3);

	this.instance_1437 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1437.setTransform(80.15,418.45,0.1765,0.1765,90.2674,0,0,-3.4,2);

	this.instance_1438 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1438.setTransform(81.35,416.85,0.1765,0.1765,109.9873,0,0,-4.9,6.6);

	this.instance_1439 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1439.setTransform(78.55,402.9,0.1765,0.1765,78.6493,0,0,-39.8,-1.9);

	this.instance_1440 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1440.setTransform(75.9,389.85,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_1441 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1441.setTransform(64,410.55,0.1764,0.1764,-21.1325,0,0,1.5,-44.7);

	this.instance_1442 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1442.setTransform(126.65,382.5,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1443 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1443.setTransform(126.25,410.5,0.1766,0.1766,-110.4825,0,0,5.2,-1.7);

	this.instance_1444 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1444.setTransform(125.7,409.05,0.1767,0.1767,-120.7491,0,0,4.1,-9.1);

	this.instance_1445 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1445.setTransform(121.3,395.35,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1446 = new lib.ch1_headcopy2("synched",0);
	this.instance_1446.setTransform(136.65,372.5,0.1768,0.1768,-1.9979,0,0,1,52.6);

	this.instance_1447 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_1447.setTransform(135.45,382.95,0.177,0.177,0,0,0,0,-22.6);

	this.instance_1448 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_1448.setTransform(139.15,418.15,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1449 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1449.setTransform(135.95,376.25,0.1768,0.1768,10.1753,0,0,-0.1,9);

	this.instance_1450 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_1450.setTransform(135.8,395.05,0.177,0.177,0,0,0,0.3,-22.1);

	this.instance_1451 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_1451.setTransform(136.35,419.8,0.1765,0.1765,36.4509,0,0,4.5,-52.6);

	this.instance_1452 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1452.setTransform(139.55,403.05,0.1766,0.1766,7.7828,0,0,-0.1,3.1);

	this.instance_1453 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1453.setTransform(154.4,408.15,0.1766,0.1766,34.1032,0,0,-3.8,3.6);

	this.instance_1454 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1454.setTransform(153.95,406.1,0.1767,0.1767,58.3964,0,0,-5.7,8.2);

	this.instance_1455 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1455.setTransform(144.7,395.35,0.1766,0.1766,49.3015,0,0,-39.4,-0.2);

	this.instance_1456 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1456.setTransform(144.8,381.95,0.1767,0.1767,91.3062,0,0,-31.7,-0.7);

	this.instance_1457 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1457.setTransform(132.25,402.55,0.1766,0.1766,-26.6514,0,0,1.9,-44.3);

	this.instance_1458 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1458.setTransform(29.5,403.25,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1459 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1459.setTransform(29.1,431.25,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_1460 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1460.setTransform(28.55,429.8,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_1461 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1461.setTransform(24.15,416.1,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1462 = new lib.ch1_headcopy2("synched",0);
	this.instance_1462.setTransform(39.5,393.25,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1464.setTransform(42,438.9,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1465 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1465.setTransform(38.8,397,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1467.setTransform(39.2,440.55,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_1468 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1468.setTransform(42.35,423.8,0.1766,0.1766,7.7828,0,0,-0.3,2);

	this.instance_1469 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1469.setTransform(57.25,428.9,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_1470 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1470.setTransform(56.85,426.85,0.1767,0.1767,58.3964,0,0,-5.5,7.9);

	this.instance_1471 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1471.setTransform(47.55,416.1,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_1472 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1472.setTransform(47.65,402.7,0.1767,0.1767,91.3062,0,0,-32.5,-0.7);

	this.instance_1473 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1473.setTransform(35.1,423.3,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_1474 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1474.setTransform(11.45,377.25,0.1765,0.1765,-63.3618,0,0,34.6,1.4);

	this.instance_1475 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1475.setTransform(5.6,405.05,0.1765,0.1765,-85.3585,0,0,5,-0.7);

	this.instance_1476 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1476.setTransform(6.65,404,0.1764,0.1764,-53.0003,0,0,3.9,-7.2);

	this.instance_1477 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1477.setTransform(5.15,389.7,0.1765,0.1765,-95.5854,0,0,38.1,-0.2);

	this.instance_1478 = new lib.ch1_headcopy("synched",0);
	this.instance_1478.setTransform(21.6,367.25,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1479 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1479.setTransform(20.25,377.75,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_1480 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1480.setTransform(23.15,413.65,0.1764,0.1764,-17.6357,0,0,3.1,-52.6);

	this.instance_1481 = new lib.ch1_neckcopy("synched",0);
	this.instance_1481.setTransform(20.7,371.05,0.1766,0.1766,10.6945,0,0,-0.7,8.8);
	...
	this.instance_1483.setTransform(23.35,415.3,0.1764,0.1764,30.7078,0,0,5,-52.1);

	this.instance_1484 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1484.setTransform(23.05,398.35,0.1764,0.1764,-3.3621,0,0,0.5,2.3);

	this.instance_1485 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1485.setTransform(33.8,405.4,0.1765,0.1765,90.2674,0,0,-3.1,2);

	this.instance_1486 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1486.setTransform(35,403.8,0.1765,0.1765,109.9873,0,0,-4.9,6.6);

	this.instance_1487 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1487.setTransform(32.2,389.85,0.1765,0.1765,78.6493,0,0,-39.8,-1.9);

	this.instance_1488 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1488.setTransform(29.55,376.8,0.1765,0.1765,79.4856,0,0,-32.5,-0.2);

	this.instance_1489 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1489.setTransform(17.65,397.5,0.1764,0.1764,-21.1325,0,0,1.5,-44.7);

	this.instance_1490 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1490.setTransform(160.15,373.35,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1491 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1491.setTransform(154.3,401.15,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1492 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1492.setTransform(155.35,400.1,0.1764,0.1764,-53.0003,0,0,3.9,-7.2);

	this.instance_1493 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1493.setTransform(153.85,385.8,0.1765,0.1765,-95.5854,0,0,38.1,-0.2);

	this.instance_1494 = new lib.ch1_headcopy("synched",0);
	this.instance_1494.setTransform(170.3,363.35,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1495 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1495.setTransform(168.95,373.85,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1496 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1496.setTransform(171.85,409.75,0.1764,0.1764,-17.6357,0,0,3,-53.5);

	this.instance_1497 = new lib.ch1_neckcopy("synched",0);
	this.instance_1497.setTransform(169.4,367.15,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1498 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1498.setTransform(169.3,385.9,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1499 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1499.setTransform(172.05,411.4,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1500 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1500.setTransform(171.7,394.45,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_1501 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1501.setTransform(182.5,401.5,0.1765,0.1765,90.2674,0,0,-4.2,2.3);

	this.instance_1502 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1502.setTransform(183.7,399.9,0.1765,0.1765,109.9873,0,0,-5.5,7.2);

	this.instance_1503 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1503.setTransform(180.9,385.95,0.1765,0.1765,78.6493,0,0,-39.9,-1.4);

	this.instance_1504 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1504.setTransform(178.25,372.9,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_1505 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1505.setTransform(166.35,393.6,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_1506 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_1506.setTransform(38.8,374.05,0.1767,0.1767,-90.7322,0,0,35.1,2.5);

	this.instance_1507 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_1507.setTransform(50.85,398.4,0.1766,0.1766,-148.1525,0,0,4.6,-1.2);

	this.instance_1508 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_1508.setTransform(50.2,396.95,0.1767,0.1767,-124.7938,0,0,4,-7.2);

	this.instance_1509 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_1509.setTransform(39.25,388.05,0.1766,0.1766,-141.5767,0,0,38,2.4);

	this.instance_1510 = new lib.ch1_headcopy_1("synched",0);
	this.instance_1510.setTransform(48.95,364.2,0.1768,0.1768,-3.6174,0,0,3.1,54.3);

	this.instance_1511 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_1511.setTransform(47.55,374.5,0.177,0.177,0,0,0,1.2,-23.2);

	this.instance_1512 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_1512.setTransform(44.75,411.65,0.1766,0.1766,16.7851,0,0,5.2,-54.5);

	this.instance_1513 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_1513.setTransform(48.05,367.85,0.1768,0.1768,12.0868,0,0,1.1,9.1);

	this.instance_1514 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_1514.setTransform(47.85,386.65,0.177,0.177,0,0,0,1.7,-22.3);

	this.instance_1515 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_1515.setTransform(54,411.65,0.1766,0.1766,-11.5702,0,0,4.2,-53.2);

	this.instance_1516 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_1516.setTransform(50.6,395.05,0.1766,0.1766,-14.6979,0,0,0.7,3.1);

	this.instance_1517 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_1517.setTransform(57.2,399.15,0.1767,0.1767,58.7222,0,0,-3.6,2.1);

	this.instance_1518 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_1518.setTransform(58.05,397.4,0.1767,0.1767,96.3659,0,0,-5.6,6);

	this.instance_1519 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_1519.setTransform(50.45,385.25,0.1767,0.1767,58.0466,0,0,-38.9,-1.9);

	this.instance_1520 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_1520.setTransform(56.85,373.45,0.1767,0.1767,119.3036,0,0,-34,-2);

	this.instance_1521 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_1521.setTransform(45.9,394.55,0.1767,0.1767,1.8162,0,0,4,-45.7);

	this.instance_1522 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1522.setTransform(27,352.55,0.1767,0.1767,-67.6896,0,0,34.5,1.2);

	this.instance_1523 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1523.setTransform(26.65,380.55,0.1766,0.1766,-110.4825,0,0,5.2,-1.7);

	this.instance_1524 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1524.setTransform(26.1,379.1,0.1767,0.1767,-120.7491,0,0,4.1,-9.1);

	this.instance_1525 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1525.setTransform(21.7,365.35,0.1767,0.1767,-107.385,0,0,39,-0.2);

	this.instance_1526 = new lib.ch1_headcopy2("synched",0);
	this.instance_1526.setTransform(37.05,342.55,0.1768,0.1768,-1.9979,0,0,1,52.6);

	this.instance_1527 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_1527.setTransform(35.85,353,0.177,0.177,0,0,0,0,-22.6);

	this.instance_1528 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_1528.setTransform(39.55,388.2,0.1766,0.1766,-11.907,0,0,3.8,-52.5);

	this.instance_1529 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1529.setTransform(36.35,346.3,0.1768,0.1768,10.1753,0,0,-0.1,9);

	this.instance_1530 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_1530.setTransform(36.2,365.1,0.177,0.177,0,0,0,0.3,-22.1);

	this.instance_1531 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_1531.setTransform(36.75,389.85,0.1765,0.1765,36.4509,0,0,4.5,-52.6);

	this.instance_1532 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1532.setTransform(39.9,373.1,0.1766,0.1766,7.7828,0,0,0.7,3.1);

	this.instance_1533 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1533.setTransform(54.8,378.15,0.1766,0.1766,34.1032,0,0,-2.8,2.9);

	this.instance_1534 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1534.setTransform(54.4,376.15,0.1767,0.1767,58.3964,0,0,-4.8,8.3);

	this.instance_1535 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1535.setTransform(45.1,365.4,0.1766,0.1766,49.3015,0,0,-39.4,-0.2);

	this.instance_1536 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1536.setTransform(45.25,352,0.1767,0.1767,91.3062,0,0,-31.8,-1.6);

	this.instance_1537 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1537.setTransform(32.65,372.6,0.1766,0.1766,-26.6514,0,0,1.9,-44.3);

	this.instance_1538 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1538.setTransform(64.25,349.45,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1539 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1539.setTransform(63.85,377.45,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_1540 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1540.setTransform(63.3,376,0.1767,0.1767,-120.7491,0,0,4.8,-8.7);

	this.instance_1541 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1541.setTransform(58.9,362.3,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1542 = new lib.ch1_headcopy2("synched",0);
	this.instance_1542.setTransform(74.25,339.45,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1544.setTransform(76.75,385.1,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1545 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1545.setTransform(73.55,343.2,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1547.setTransform(73.95,386.75,0.1765,0.1765,36.4509,0,0,4,-53.3);

	this.instance_1548 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1548.setTransform(77.1,370,0.1766,0.1766,7.7828,0,0,-0.3,2);

	this.instance_1549 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1549.setTransform(92,375.1,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_1550 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1550.setTransform(91.6,373.05,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_1551 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1551.setTransform(82.3,362.3,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_1552 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1552.setTransform(82.4,348.9,0.1767,0.1767,91.3062,0,0,-32.9,-0.7);

	this.instance_1553 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1553.setTransform(69.9,369.5,0.1766,0.1766,-26.6514,0,0,2.4,-45.1);

	this.instance_1554 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1554.setTransform(106.4,359.7,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1555 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1555.setTransform(106,387.7,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_1556 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1556.setTransform(105.45,386.25,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_1557 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1557.setTransform(101,372.55,0.1767,0.1767,-107.385,0,0,40.3,0.1);

	this.instance_1558 = new lib.ch1_headcopy2("synched",0);
	this.instance_1558.setTransform(116.4,349.7,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1560.setTransform(118.9,395.35,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1561 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1561.setTransform(115.7,353.45,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1563.setTransform(116.1,397,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_1564 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1564.setTransform(119.25,380.25,0.1766,0.1766,7.7828,0,0,0.2,1.9);

	this.instance_1565 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1565.setTransform(134.15,385.35,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_1566 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1566.setTransform(133.75,383.3,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_1567 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1567.setTransform(124.45,372.55,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_1568 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1568.setTransform(124.55,359.15,0.1767,0.1767,91.3062,0,0,-32.5,-0.7);

	this.instance_1569 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1569.setTransform(112,379.75,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_1570 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1570.setTransform(125.9,349.2,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1571 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1571.setTransform(120.05,377,0.1765,0.1765,-85.3585,0,0,5.6,-0.8);

	this.instance_1572 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1572.setTransform(121.1,375.95,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_1573 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1573.setTransform(119.65,361.65,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_1574 = new lib.ch1_headcopy("synched",0);
	this.instance_1574.setTransform(136.05,339.2,0.1766,0.1766,-1.0395,0,0,1.3,52.7);
	...
	this.instance_1576.setTransform(137.6,385.55,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_1577 = new lib.ch1_neckcopy("synched",0);
	this.instance_1577.setTransform(135.15,343,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1578 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1578.setTransform(135.05,361.75,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1579 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1579.setTransform(137.8,387.2,0.1764,0.1764,30.7078,0,0,4.7,-52.6);

	this.instance_1580 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1580.setTransform(137.5,370.3,0.1764,0.1764,-3.3621,0,0,0.1,2.9);

	this.instance_1581 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1581.setTransform(148.25,377.35,0.1765,0.1765,90.2674,0,0,-3.6,2.3);

	this.instance_1582 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1582.setTransform(149.45,375.75,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_1583 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1583.setTransform(146.65,361.8,0.1765,0.1765,78.6493,0,0,-39.4,-1.2);

	this.instance_1584 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1584.setTransform(144,348.75,0.1765,0.1765,79.4856,0,0,-32,0.1);

	this.instance_1585 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1585.setTransform(132.15,369.45,0.1764,0.1764,-21.1325,0,0,1.7,-45.2);

	this.instance_1586 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1586.setTransform(175.9,350.8,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1587 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1587.setTransform(175.5,378.8,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_1588 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1588.setTransform(174.95,377.35,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_1589 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1589.setTransform(170.55,363.65,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1590 = new lib.ch1_headcopy2("synched",0);
	this.instance_1590.setTransform(185.9,340.8,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1592.setTransform(188.4,386.45,0.1766,0.1766,-11.907,0,0,4,-53.6);

	this.instance_1593 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1593.setTransform(185.2,344.55,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1595.setTransform(185.6,388.1,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_1596 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1596.setTransform(188.75,371.35,0.1766,0.1766,7.7828,0,0,0.8,1.9);

	this.instance_1597 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1597.setTransform(203.65,376.45,0.1766,0.1766,34.1032,0,0,-3.5,2);

	this.instance_1598 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1598.setTransform(203.25,374.4,0.1767,0.1767,58.3964,0,0,-5.1,7.2);

	this.instance_1599 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1599.setTransform(193.95,363.65,0.1766,0.1766,49.3015,0,0,-39.5,-1.9);

	this.instance_1600 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1600.setTransform(194.05,350.25,0.1767,0.1767,91.3062,0,0,-32.6,-1.8);

	this.instance_1601 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1601.setTransform(181.5,370.85,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_1602 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1602.setTransform(148.55,340.8,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1603 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1603.setTransform(148.15,368.8,0.1766,0.1766,-110.4825,0,0,5.5,-1.6);

	this.instance_1604 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1604.setTransform(147.6,367.35,0.1767,0.1767,-120.7491,0,0,4.1,-9.1);

	this.instance_1605 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1605.setTransform(143.2,353.65,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1606 = new lib.ch1_headcopy2("synched",0);
	this.instance_1606.setTransform(158.55,330.8,0.1768,0.1768,-1.9979,0,0,1,52.6);

	this.instance_1607 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_1607.setTransform(157.35,341.25,0.177,0.177,0,0,0,0,-22.6);

	this.instance_1608 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_1608.setTransform(161.05,376.45,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1609 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1609.setTransform(157.85,334.55,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1611.setTransform(158.25,378.1,0.1765,0.1765,36.4509,0,0,4.5,-52.6);

	this.instance_1612 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1612.setTransform(161.45,361.35,0.1766,0.1766,7.7828,0,0,-0.1,3.1);

	this.instance_1613 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1613.setTransform(176.3,366.45,0.1766,0.1766,34.1032,0,0,-3.9,3.4);

	this.instance_1614 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1614.setTransform(175.85,364.4,0.1767,0.1767,58.3964,0,0,-5.7,8.2);

	this.instance_1615 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1615.setTransform(166.6,353.65,0.1766,0.1766,49.3015,0,0,-39.6,-0.5);

	this.instance_1616 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1616.setTransform(166.7,340.25,0.1767,0.1767,91.3062,0,0,-31.7,-0.7);

	this.instance_1617 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1617.setTransform(154.15,360.85,0.1766,0.1766,-26.6514,0,0,1.9,-44.3);

	this.instance_1618 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1618.setTransform(161.35,321.85,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1619 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1619.setTransform(155.5,349.65,0.1765,0.1765,-85.3585,0,0,5,-0.7);

	this.instance_1620 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1620.setTransform(156.55,348.6,0.1764,0.1764,-53.0003,0,0,3.9,-7.2);

	this.instance_1621 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1621.setTransform(155.05,334.3,0.1765,0.1765,-95.5854,0,0,38.1,-0.2);

	this.instance_1622 = new lib.ch1_headcopy("synched",0);
	this.instance_1622.setTransform(171.5,311.85,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1623 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1623.setTransform(170.15,322.35,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_1624 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1624.setTransform(173.05,358.25,0.1764,0.1764,-17.6357,0,0,3.1,-52.6);

	this.instance_1625 = new lib.ch1_neckcopy("synched",0);
	this.instance_1625.setTransform(170.6,315.65,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1626 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1626.setTransform(170.5,334.4,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1627 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1627.setTransform(173.25,359.9,0.1764,0.1764,30.7078,0,0,5,-52.1);

	this.instance_1628 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1628.setTransform(172.95,342.95,0.1764,0.1764,-3.3621,0,0,1,2.4);

	this.instance_1629 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1629.setTransform(183.7,350,0.1765,0.1765,90.2674,0,0,-3.1,1.4);

	this.instance_1630 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1630.setTransform(184.9,348.4,0.1765,0.1765,109.9873,0,0,-4.9,6.6);

	this.instance_1631 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1631.setTransform(182.1,334.45,0.1765,0.1765,78.6493,0,0,-39.7,-2.2);

	this.instance_1632 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1632.setTransform(179.45,321.4,0.1765,0.1765,79.4856,0,0,-32.4,-0.8);

	this.instance_1633 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1633.setTransform(167.55,342.1,0.1764,0.1764,-21.1325,0,0,1.5,-44.7);
	...
	this.instance_1639.setTransform(82.1,319.05,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_1642.setTransform(82.45,331.2,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_1650.setTransform(44.35,328.9,0.1765,0.1765,-63.3618,0,0,34.6,1.4);

	this.instance_1651 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1651.setTransform(38.5,356.7,0.1765,0.1765,-85.3585,0,0,5,-0.7);

	this.instance_1652 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1652.setTransform(39.55,355.65,0.1764,0.1764,-53.0003,0,0,3.9,-7.2);

	this.instance_1653 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1653.setTransform(38.05,341.35,0.1765,0.1765,-95.5854,0,0,38.1,-0.2);

	this.instance_1654 = new lib.ch1_headcopy("synched",0);
	this.instance_1654.setTransform(54.5,318.9,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1655 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1655.setTransform(53.15,329.4,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_1656 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1656.setTransform(56.05,365.3,0.1764,0.1764,-17.6357,0,0,3.1,-52.6);

	this.instance_1657 = new lib.ch1_neckcopy("synched",0);
	this.instance_1657.setTransform(53.6,322.7,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1658 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1658.setTransform(53.5,341.45,0.1768,0.1768,0,0,0,0.3,-21.8);

	this.instance_1659 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1659.setTransform(56.25,366.95,0.1764,0.1764,30.7078,0,0,5,-52.1);

	this.instance_1660 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1660.setTransform(55.95,350,0.1764,0.1764,-3.3621,0,0,0.7,3.5);

	this.instance_1661 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1661.setTransform(66.7,357.05,0.1765,0.1765,90.2674,0,0,-3.1,1.7);

	this.instance_1662 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1662.setTransform(67.9,355.45,0.1765,0.1765,109.9873,0,0,-4.9,6.6);

	this.instance_1663 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1663.setTransform(65.1,341.5,0.1765,0.1765,78.6493,0,0,-38.6,-1.7);

	this.instance_1664 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1664.setTransform(62.45,328.45,0.1765,0.1765,79.4856,0,0,-31.4,-0.4);

	this.instance_1665 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1665.setTransform(50.55,349.15,0.1764,0.1764,-21.1325,0,0,1.5,-44.7);

	this.instance_1666 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1666.setTransform(51.15,302.4,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1667 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1667.setTransform(50.75,330.4,0.1766,0.1766,-110.4825,0,0,5.7,-1.5);

	this.instance_1668 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1668.setTransform(50.2,328.95,0.1767,0.1767,-120.7491,0,0,4.6,-8.8);

	this.instance_1669 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1669.setTransform(45.8,315.25,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1670 = new lib.ch1_headcopy2("synched",0);
	this.instance_1670.setTransform(61.15,292.4,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1672.setTransform(63.65,338.05,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1673 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1673.setTransform(60.45,296.15,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1675.setTransform(60.85,339.7,0.1765,0.1765,36.4509,0,0,4.2,-53.1);

	this.instance_1676 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1676.setTransform(64,322.95,0.1766,0.1766,7.7828,0,0,0.2,1.9);

	this.instance_1677 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1677.setTransform(78.9,328.05,0.1766,0.1766,34.1032,0,0,-4,3.1);

	this.instance_1678 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1678.setTransform(78.5,326,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_1679 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1679.setTransform(69.2,315.2,0.1766,0.1766,49.3015,0,0,-39.4,-1.1);

	this.instance_1680 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1680.setTransform(69.3,301.85,0.1767,0.1767,91.3062,0,0,-32.9,-0.7);

	this.instance_1681 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1681.setTransform(56.75,322.5,0.1766,0.1766,-26.6514,0,0,2.2,-44.8);

	this.instance_1682 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1682.setTransform(0.25,342.35,0.1765,0.1765,-63.3618,0,0,34.9,-0.1);

	this.instance_1683 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1683.setTransform(-5.6,370.15,0.1765,0.1765,-85.3585,0,0,6.1,-1.9);

	this.instance_1684 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1684.setTransform(-4.55,369.1,0.1764,0.1764,-53.0003,0,0,3.1,-8.1);

	this.instance_1685 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1685.setTransform(-6.05,354.8,0.1765,0.1765,-95.5854,0,0,38.2,-1.4);

	this.instance_1686 = new lib.ch1_headcopy("synched",0);
	this.instance_1686.setTransform(10.4,332.35,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1687 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1687.setTransform(9.05,342.85,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1688 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1688.setTransform(11.95,378.7,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_1689 = new lib.ch1_neckcopy("synched",0);
	this.instance_1689.setTransform(9.5,336.15,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1690 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1690.setTransform(9.4,354.9,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1691 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1691.setTransform(12.15,380.4,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1692 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1692.setTransform(11.85,363.45,0.1764,0.1764,-3.3621,0,0,0.5,2.3);

	this.instance_1693 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1693.setTransform(22.6,370.5,0.1765,0.1765,90.2674,0,0,-4.2,2);

	this.instance_1694 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1694.setTransform(23.8,368.9,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_1695 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1695.setTransform(21,354.95,0.1765,0.1765,78.6493,0,0,-39.9,-1.7);

	this.instance_1696 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1696.setTransform(18.35,341.9,0.1765,0.1765,79.4856,0,0,-32.5,-0.2);

	this.instance_1697 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1697.setTransform(6.45,362.6,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_1698 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1698.setTransform(20.85,320.7,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1699 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1699.setTransform(20.45,348.7,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_1700 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1700.setTransform(19.9,347.25,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_1701 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1701.setTransform(15.5,333.55,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1702 = new lib.ch1_headcopy2("synched",0);
	this.instance_1702.setTransform(30.85,310.7,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1704.setTransform(33.35,356.35,0.1766,0.1766,-11.907,0,0,4,-53.6);

	this.instance_1705 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1705.setTransform(30.15,314.45,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1707.setTransform(30.55,358,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_1708 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1708.setTransform(33.7,341.25,0.1766,0.1766,7.7828,0,0,0.8,1.9);

	this.instance_1709 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1709.setTransform(48.6,346.35,0.1766,0.1766,34.1032,0,0,-3.5,2);

	this.instance_1710 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1710.setTransform(48.2,344.3,0.1767,0.1767,58.3964,0,0,-5.1,7.2);

	this.instance_1711 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1711.setTransform(38.9,333.55,0.1766,0.1766,49.3015,0,0,-39.5,-1.9);

	this.instance_1712 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1712.setTransform(39,320.15,0.1767,0.1767,91.3062,0,0,-32.6,-1.8);

	this.instance_1713 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1713.setTransform(26.45,340.75,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_1714 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_1714.setTransform(101.2,334.7,0.1767,0.1767,-90.7322,0,0,35.1,2.5);

	this.instance_1715 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_1715.setTransform(113.25,359.05,0.1766,0.1766,-148.1525,0,0,4.6,-1.2);

	this.instance_1716 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_1716.setTransform(112.6,357.6,0.1767,0.1767,-124.7938,0,0,4,-7.2);

	this.instance_1717 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_1717.setTransform(101.65,348.7,0.1766,0.1766,-141.5767,0,0,38,2.4);

	this.instance_1718 = new lib.ch1_headcopy_1("synched",0);
	this.instance_1718.setTransform(111.35,324.85,0.1768,0.1768,-3.6174,0,0,3.1,54.3);

	this.instance_1719 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_1719.setTransform(109.95,335.15,0.177,0.177,0,0,0,1.2,-23.2);

	this.instance_1720 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_1720.setTransform(107.15,372.3,0.1766,0.1766,16.7851,0,0,5.2,-54.5);

	this.instance_1721 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_1721.setTransform(110.45,328.5,0.1768,0.1768,12.0868,0,0,1.1,9.1);

	this.instance_1722 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_1722.setTransform(110.25,347.3,0.177,0.177,0,0,0,1.7,-22.3);

	this.instance_1723 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_1723.setTransform(116.4,372.3,0.1766,0.1766,-11.5702,0,0,4.2,-53.2);

	this.instance_1724 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_1724.setTransform(113,355.7,0.1766,0.1766,-14.6979,0,0,0.7,3.1);

	this.instance_1725 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_1725.setTransform(119.6,359.8,0.1767,0.1767,58.7222,0,0,-3.6,2.1);

	this.instance_1726 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_1726.setTransform(120.45,358.05,0.1767,0.1767,96.3659,0,0,-5.6,6);

	this.instance_1727 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_1727.setTransform(112.85,345.9,0.1767,0.1767,58.0466,0,0,-38.9,-1.9);

	this.instance_1728 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_1728.setTransform(119.25,334.1,0.1767,0.1767,119.3036,0,0,-34,-2);

	this.instance_1729 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_1729.setTransform(108.3,355.2,0.1767,0.1767,1.8162,0,0,4,-45.7);

	this.instance_1730 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_1730.setTransform(-2.9,312.45,0.1767,0.1767,-90.7322,0,0,35.1,1.3);

	this.instance_1731 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_1731.setTransform(9.15,336.8,0.1766,0.1766,-148.1525,0,0,4.6,-1.2);

	this.instance_1732 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_1732.setTransform(8.5,335.35,0.1767,0.1767,-124.7938,0,0,4,-7.2);

	this.instance_1733 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_1733.setTransform(-2.45,326.45,0.1766,0.1766,-141.5767,0,0,38,2.4);

	this.instance_1734 = new lib.ch1_headcopy_1("synched",0);
	this.instance_1734.setTransform(7.25,302.6,0.1768,0.1768,-3.6174,0,0,3.1,54.1);

	this.instance_1735 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_1735.setTransform(5.85,312.9,0.177,0.177,0,0,0,1.2,-23.2);

	this.instance_1736 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_1736.setTransform(3,350.05,0.1766,0.1766,16.7851,0,0,4,-54.1);

	this.instance_1737 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_1737.setTransform(6.35,306.25,0.1768,0.1768,12.0868,0,0,1.1,9.1);

	this.instance_1738 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_1738.setTransform(6.15,325.05,0.177,0.177,0,0,0,1.7,-22.6);

	this.instance_1739 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_1739.setTransform(12.3,350.05,0.1766,0.1766,-11.5702,0,0,4.2,-53.2);

	this.instance_1740 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_1740.setTransform(8.9,333.45,0.1766,0.1766,-14.6979,0,0,0.7,3.1);

	this.instance_1741 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_1741.setTransform(15.5,337.55,0.1767,0.1767,58.7222,0,0,-3.6,2.1);

	this.instance_1742 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_1742.setTransform(16.35,335.8,0.1767,0.1767,96.3659,0,0,-5.6,6);

	this.instance_1743 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_1743.setTransform(8.75,323.7,0.1767,0.1767,58.0466,0,0,-39.1,-2);

	this.instance_1744 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_1744.setTransform(15.15,311.85,0.1767,0.1767,119.3036,0,0,-34,-2);

	this.instance_1745 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_1745.setTransform(4.2,332.95,0.1767,0.1767,1.8162,0,0,4,-45.7);

	this.instance_1746 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1746.setTransform(196.45,322.7,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1747 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1747.setTransform(190.6,350.5,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1748 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1748.setTransform(191.65,349.45,0.1764,0.1764,-53.0003,0,0,3.9,-7.2);

	this.instance_1749 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1749.setTransform(190.15,335.15,0.1765,0.1765,-95.5854,0,0,38.1,-0.2);

	this.instance_1750 = new lib.ch1_headcopy("synched",0);
	this.instance_1750.setTransform(206.6,312.7,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1751 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1751.setTransform(205.25,323.2,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1752 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1752.setTransform(208.15,359.05,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_1753 = new lib.ch1_neckcopy("synched",0);
	this.instance_1753.setTransform(205.7,316.5,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1754 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1754.setTransform(205.6,335.25,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1755 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1755.setTransform(208.35,360.75,0.1764,0.1764,30.7078,0,0,4.9,-52.4);

	this.instance_1756 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1756.setTransform(208,343.8,0.1764,0.1764,-3.3621,0,0,0.7,2.3);

	this.instance_1757 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1757.setTransform(218.8,350.85,0.1765,0.1765,90.2674,0,0,-4.2,1.7);

	this.instance_1758 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1758.setTransform(220,349.25,0.1765,0.1765,109.9873,0,0,-4.9,6.6);

	this.instance_1759 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1759.setTransform(217.2,335.3,0.1765,0.1765,78.6493,0,0,-39.8,-1.9);

	this.instance_1760 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1760.setTransform(214.55,322.25,0.1765,0.1765,79.4856,0,0,-32.5,-0.2);

	this.instance_1761 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1761.setTransform(202.65,342.95,0.1764,0.1764,-21.1325,0,0,1.6,-45);

	this.instance_1762 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_1762.setTransform(219.75,314.35,0.1767,0.1767,-90.7322,0,0,35.1,1.3);

	this.instance_1763 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_1763.setTransform(231.8,338.7,0.1766,0.1766,-148.1525,0,0,5.5,-1.8);

	this.instance_1764 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_1764.setTransform(231.15,337.25,0.1767,0.1767,-124.7938,0,0,4.7,-8.2);

	this.instance_1765 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_1765.setTransform(220.2,328.35,0.1766,0.1766,-141.5767,0,0,38.9,1.7);

	this.instance_1766 = new lib.ch1_headcopy_1("synched",0);
	this.instance_1766.setTransform(229.9,304.5,0.1768,0.1768,-3.6174,0,0,1.9,54.2);

	this.instance_1767 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_1767.setTransform(228.5,314.8,0.177,0.177,0,0,0,0,-22.9);

	this.instance_1768 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_1768.setTransform(225.65,351.95,0.1766,0.1766,16.7851,0,0,4,-54.1);

	this.instance_1769 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_1769.setTransform(229,308.15,0.1768,0.1768,12.0868,0,0,-0.1,9.2);

	this.instance_1770 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_1770.setTransform(228.8,326.95,0.177,0.177,0,0,0,0.6,-22.3);

	this.instance_1771 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_1771.setTransform(234.95,351.95,0.1766,0.1766,-11.5702,0,0,3.1,-53.4);

	this.instance_1772 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_1772.setTransform(231.55,335.35,0.1766,0.1766,-14.6979,0,0,-0.5,2.8);

	this.instance_1773 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_1773.setTransform(238.15,339.45,0.1767,0.1767,58.7222,0,0,-4.2,3.1);

	this.instance_1774 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_1774.setTransform(239,337.7,0.1767,0.1767,96.3659,0,0,-5.5,7.2);

	this.instance_1775 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_1775.setTransform(231.45,325.6,0.1767,0.1767,58.0466,0,0,-39.3,-1.2);

	this.instance_1776 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_1776.setTransform(237.8,313.8,0.1767,0.1767,119.3036,0,0,-33.4,-1.1);

	this.instance_1777 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_1777.setTransform(226.85,334.85,0.1767,0.1767,1.8162,0,0,2.8,-45.6);

	this.instance_1778 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1778.setTransform(238.4,295.1,0.1765,0.1765,-63.3618,0,0,35.6,0.8);

	this.instance_1779 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1779.setTransform(232.55,322.9,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1780 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1780.setTransform(233.6,321.85,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_1781 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1781.setTransform(232.15,307.55,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_1782 = new lib.ch1_headcopy("synched",0);
	this.instance_1782.setTransform(248.55,285.1,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1783 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1783.setTransform(247.2,295.6,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1784 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1784.setTransform(250.1,331.45,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_1785 = new lib.ch1_neckcopy("synched",0);
	this.instance_1785.setTransform(247.65,288.9,0.1766,0.1766,10.6945,0,0,-0.7,8.8);
	...
	this.instance_1787.setTransform(250.3,333.15,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1788 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1788.setTransform(249.95,316.2,0.1764,0.1764,-3.3621,0,0,0.7,2.3);

	this.instance_1789 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1789.setTransform(260.75,323.25,0.1765,0.1765,90.2674,0,0,-4.2,1.4);

	this.instance_1790 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1790.setTransform(261.95,321.65,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_1791 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1791.setTransform(259.15,307.7,0.1765,0.1765,78.6493,0,0,-39.7,-2.2);

	this.instance_1792 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1792.setTransform(256.5,294.65,0.1765,0.1765,79.4856,0,0,-32.5,-0.6);

	this.instance_1793 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1793.setTransform(244.6,315.35,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);
	...
	this.instance_1799.setTransform(268.75,284.35,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_1802.setTransform(269.1,296.5,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_1810.setTransform(281.45,267.3,0.1767,0.1767,-67.6869,0,0,35.5,0.8);

	this.instance_1811 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1811.setTransform(281.05,295.3,0.1767,0.1767,-110.4854,0,0,5.5,-1.6);

	this.instance_1812 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1812.setTransform(280.5,293.85,0.1767,0.1767,-120.7482,0,0,4.4,-9);

	this.instance_1813 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1813.setTransform(276.1,280.15,0.1767,0.1767,-107.3868,0,0,40,0.1);

	this.instance_1814 = new lib.ch1_headcopy2("synched",0);
	this.instance_1814.setTransform(291.5,257.3,0.1768,0.1768,-2.0027,0,0,1,52.6);

	this.instance_1815 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_1815.setTransform(290.25,267.75,0.177,0.177,0,0,0,0,-22.9);

	this.instance_1816 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_1816.setTransform(293.95,302.95,0.1766,0.1766,-11.9108,0,0,3.8,-53.6);

	this.instance_1817 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1817.setTransform(290.75,261.05,0.1768,0.1768,10.1793,0,0,-0.1,9);
	...
	this.instance_1819.setTransform(291.15,304.6,0.1765,0.1765,36.4519,0,0,4.3,-52.8);

	this.instance_1820 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1820.setTransform(294.3,287.85,0.1766,0.1766,7.787,0,0,-0.2,2.9);

	this.instance_1821 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1821.setTransform(309.2,292.95,0.1767,0.1767,34.1046,0,0,-3.2,2.9);

	this.instance_1822 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1822.setTransform(308.8,290.9,0.1767,0.1767,58.3948,0,0,-5.5,7.9);

	this.instance_1823 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1823.setTransform(299.5,280.15,0.1767,0.1767,49.301,0,0,-39.6,-0.5);

	this.instance_1824 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1824.setTransform(299.6,266.75,0.1767,0.1767,91.3111,0,0,-32.5,-0.7);

	this.instance_1825 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1825.setTransform(287.05,287.35,0.1766,0.1766,-26.6536,0,0,2.1,-44.6);

	this.instance_1826 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1826.setTransform(95.35,302.4,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1827 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1827.setTransform(94.95,330.4,0.1766,0.1766,-110.4825,0,0,5.7,-1.5);

	this.instance_1828 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1828.setTransform(94.4,328.95,0.1767,0.1767,-120.7491,0,0,4.6,-8.8);

	this.instance_1829 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1829.setTransform(90,315.25,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1830 = new lib.ch1_headcopy2("synched",0);
	this.instance_1830.setTransform(105.35,292.4,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1832.setTransform(107.85,338.05,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1833 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1833.setTransform(104.65,296.15,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1835.setTransform(105.05,339.7,0.1765,0.1765,36.4509,0,0,4.2,-53.1);

	this.instance_1836 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1836.setTransform(108.2,322.95,0.1766,0.1766,7.7828,0,0,-0.3,2);

	this.instance_1837 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1837.setTransform(123.1,328.05,0.1766,0.1766,34.1032,0,0,-4,3.1);

	this.instance_1838 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1838.setTransform(122.7,326,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_1839 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1839.setTransform(113.4,315.25,0.1766,0.1766,49.3015,0,0,-39.8,-0.6);

	this.instance_1840 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1840.setTransform(113.5,301.85,0.1767,0.1767,91.3062,0,0,-32.9,-0.7);

	this.instance_1841 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1841.setTransform(100.95,322.5,0.1766,0.1766,-26.6514,0,0,2.2,-44.8);

	this.instance_1842 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1842.setTransform(119.6,313.6,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1843 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1843.setTransform(113.75,341.4,0.1765,0.1765,-85.3585,0,0,5.6,-0.8);

	this.instance_1844 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1844.setTransform(114.8,340.35,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_1845 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1845.setTransform(113.35,326.05,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_1846 = new lib.ch1_headcopy("synched",0);
	this.instance_1846.setTransform(129.75,303.6,0.1766,0.1766,-1.0395,0,0,1.3,52.7);
	...
	this.instance_1848.setTransform(131.3,349.95,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_1849 = new lib.ch1_neckcopy("synched",0);
	this.instance_1849.setTransform(128.85,307.4,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1850 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1850.setTransform(128.75,326.15,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1851 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1851.setTransform(131.5,351.6,0.1764,0.1764,30.7078,0,0,4.7,-52.6);

	this.instance_1852 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1852.setTransform(131.15,334.7,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_1853 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1853.setTransform(141.95,341.75,0.1765,0.1765,90.2674,0,0,-3.6,2.3);

	this.instance_1854 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1854.setTransform(143.15,340.15,0.1765,0.1765,109.9873,0,0,-6,5.8);

	this.instance_1855 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1855.setTransform(140.35,326.2,0.1765,0.1765,78.6493,0,0,-39.9,-1.4);

	this.instance_1856 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1856.setTransform(137.7,313.15,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_1857 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1857.setTransform(125.85,333.85,0.1764,0.1764,-21.1325,0,0,1.7,-45.2);

	this.instance_1858 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1858.setTransform(142.15,294.9,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1859 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1859.setTransform(141.75,322.9,0.1766,0.1766,-110.4825,0,0,6,-1.4);

	this.instance_1860 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1860.setTransform(141.2,321.45,0.1767,0.1767,-120.7491,0,0,4.8,-8.7);

	this.instance_1861 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1861.setTransform(136.8,307.75,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1862 = new lib.ch1_headcopy2("synched",0);
	this.instance_1862.setTransform(152.15,284.9,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1864.setTransform(154.65,330.55,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1865 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1865.setTransform(151.45,288.65,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1867.setTransform(151.85,332.2,0.1765,0.1765,36.4509,0,0,4,-53.3);

	this.instance_1868 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1868.setTransform(155,315.45,0.1766,0.1766,7.7828,0,0,0.2,1.9);

	this.instance_1869 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1869.setTransform(169.9,320.55,0.1766,0.1766,34.1032,0,0,-4.2,2.9);

	this.instance_1870 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1870.setTransform(169.5,318.5,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_1871 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1871.setTransform(160.2,307.75,0.1766,0.1766,49.3015,0,0,-40,-0.8);

	this.instance_1872 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1872.setTransform(160.3,294.35,0.1767,0.1767,91.3062,0,0,-32.9,-0.7);

	this.instance_1873 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1873.setTransform(147.8,314.95,0.1766,0.1766,-26.6514,0,0,2.4,-45.1);

	this.instance_1874 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_1874.setTransform(176.6,298.25,0.1767,0.1767,-90.7322,0,0,34,2.1);

	this.instance_1875 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_1875.setTransform(188.7,322.6,0.1766,0.1766,-148.1525,0,0,4.7,-2.6);

	this.instance_1876 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_1876.setTransform(188.05,321.15,0.1767,0.1767,-124.7938,0,0,3.8,-8.4);

	this.instance_1877 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_1877.setTransform(177.1,312.25,0.1766,0.1766,-141.5767,0,0,38.2,2.2);

	this.instance_1878 = new lib.ch1_headcopy_1("synched",0);
	this.instance_1878.setTransform(186.8,288.35,0.1768,0.1768,-3.6174,0,0,3.1,55.1);

	this.instance_1879 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_1879.setTransform(185.4,298.7,0.177,0.177,0,0,0,0,-22.3);

	this.instance_1880 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_1880.setTransform(182.55,335.85,0.1766,0.1766,16.7851,0,0,5.5,-53.4);

	this.instance_1881 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_1881.setTransform(185.9,292.05,0.1768,0.1768,12.0868,0,0,0.2,10.3);

	this.instance_1882 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_1882.setTransform(185.7,310.85,0.177,0.177,0,0,0,0.8,-21.4);

	this.instance_1883 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_1883.setTransform(191.85,335.85,0.1766,0.1766,-11.5702,0,0,4,-53.2);

	this.instance_1884 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_1884.setTransform(188.45,319.25,0.1766,0.1766,-14.6979,0,0,0.4,4.2);

	this.instance_1885 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_1885.setTransform(195.05,323.35,0.1767,0.1767,58.7222,0,0,-2.6,2.7);

	this.instance_1886 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_1886.setTransform(195.9,321.6,0.1767,0.1767,96.3659,0,0,-4.8,6);

	this.instance_1887 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_1887.setTransform(188.3,309.5,0.1767,0.1767,58.0466,0,0,-38.1,-1.4);

	this.instance_1888 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_1888.setTransform(194.7,297.7,0.1767,0.1767,119.3036,0,0,-33.2,-2.5);

	this.instance_1889 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_1889.setTransform(183.75,318.75,0.1767,0.1767,1.8162,0,0,2.8,-45.6);

	this.instance_1890 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1890.setTransform(196.7,285.6,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1891 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1891.setTransform(196.3,313.6,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_1892 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1892.setTransform(195.75,312.15,0.1767,0.1767,-120.7491,0,0,5,-8.5);

	this.instance_1893 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1893.setTransform(191.3,298.45,0.1767,0.1767,-107.385,0,0,40.3,0.1);

	this.instance_1894 = new lib.ch1_headcopy2("synched",0);
	this.instance_1894.setTransform(206.7,275.6,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1896.setTransform(209.2,321.25,0.1766,0.1766,-11.907,0,0,3,-54.1);

	this.instance_1897 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1897.setTransform(206,279.35,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1899.setTransform(206.4,322.9,0.1765,0.1765,36.4509,0,0,3.8,-53.5);

	this.instance_1900 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1900.setTransform(209.55,306.15,0.1766,0.1766,7.7828,0,0,-0.4,1.8);

	this.instance_1901 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1901.setTransform(224.45,311.25,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_1902 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1902.setTransform(224.05,309.2,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_1903 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1903.setTransform(214.75,298.45,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_1904 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1904.setTransform(214.85,285.05,0.1767,0.1767,91.3062,0,0,-32.9,-0.7);

	this.instance_1905 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1905.setTransform(202.3,305.65,0.1766,0.1766,-26.6514,0,0,2.5,-45.3);

	this.instance_1906 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1906.setTransform(77,282.15,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_1907 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1907.setTransform(71.15,309.95,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1908 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1908.setTransform(72.2,308.9,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_1909 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1909.setTransform(70.75,294.6,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_1910 = new lib.ch1_headcopy("synched",0);
	this.instance_1910.setTransform(87.15,272.15,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1911 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1911.setTransform(85.8,282.65,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1912 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1912.setTransform(88.7,318.5,0.1764,0.1764,-17.6357,0,0,4.4,-53.1);

	this.instance_1913 = new lib.ch1_neckcopy("synched",0);
	this.instance_1913.setTransform(86.25,275.95,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1914 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1914.setTransform(86.15,294.7,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_1915 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1915.setTransform(88.9,320.15,0.1764,0.1764,30.7078,0,0,4.7,-52.6);

	this.instance_1916 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1916.setTransform(88.6,303.25,0.1764,0.1764,-3.3621,0,0,1,2.4);

	this.instance_1917 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1917.setTransform(99.35,310.3,0.1765,0.1765,90.2674,0,0,-4.2,1.2);

	this.instance_1918 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1918.setTransform(100.55,308.7,0.1765,0.1765,109.9873,0,0,-6,5.8);

	this.instance_1919 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1919.setTransform(97.75,294.75,0.1765,0.1765,78.6493,0,0,-39.6,-2.5);

	this.instance_1920 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1920.setTransform(95.1,281.7,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_1921 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1921.setTransform(83.2,302.4,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_1922 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_1922.setTransform(106.4,272.1,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1923 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1923.setTransform(106,300.1,0.1766,0.1766,-110.4825,0,0,6.2,-1.3);

	this.instance_1924 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1924.setTransform(105.45,298.65,0.1767,0.1767,-120.7491,0,0,4.4,-9);

	this.instance_1925 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1925.setTransform(101.05,284.95,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1926 = new lib.ch1_headcopy2("synched",0);
	this.instance_1926.setTransform(116.4,262.1,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1928.setTransform(118.9,307.75,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1929 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1929.setTransform(115.7,265.85,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1931.setTransform(116.1,309.4,0.1765,0.1765,36.4509,0,0,4.3,-52.9);

	this.instance_1932 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1932.setTransform(119.25,292.65,0.1766,0.1766,7.7828,0,0,0.4,3.1);

	this.instance_1933 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1933.setTransform(134.15,297.75,0.1766,0.1766,34.1032,0,0,-4.4,2.6);

	this.instance_1934 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1934.setTransform(133.75,295.7,0.1767,0.1767,58.3964,0,0,-5.5,7.9);

	this.instance_1935 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1935.setTransform(124.45,284.95,0.1766,0.1766,49.3015,0,0,-40.2,-1);

	this.instance_1936 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1936.setTransform(124.55,271.55,0.1767,0.1767,91.3062,0,0,-32.5,-0.7);

	this.instance_1937 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1937.setTransform(112,292.15,0.1766,0.1766,-26.6514,0,0,2.1,-44.6);

	this.instance_1938 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1938.setTransform(15.95,293.35,0.1765,0.1765,-63.3618,0,0,35.6,0.8);

	this.instance_1939 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1939.setTransform(10.1,321.15,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_1940 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1940.setTransform(11.15,320.05,0.1764,0.1764,-53.0003,0,0,4.8,-7.9);

	this.instance_1941 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1941.setTransform(9.65,305.8,0.1765,0.1765,-95.5854,0,0,39.3,-0.1);

	this.instance_1942 = new lib.ch1_headcopy("synched",0);
	this.instance_1942.setTransform(26.1,283.35,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1943 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1943.setTransform(24.75,293.85,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_1944 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1944.setTransform(27.65,329.75,0.1764,0.1764,-17.6357,0,0,3.4,-53.6);

	this.instance_1945 = new lib.ch1_neckcopy("synched",0);
	this.instance_1945.setTransform(25.2,287.15,0.1766,0.1766,10.6945,0,0,-0.7,8.8);
	...
	this.instance_1947.setTransform(27.85,331.4,0.1764,0.1764,30.7078,0,0,4.4,-53.1);

	this.instance_1948 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1948.setTransform(27.5,314.45,0.1764,0.1764,-3.3621,0,0,0.7,2.3);

	this.instance_1949 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1949.setTransform(38.3,321.5,0.1765,0.1765,90.2674,0,0,-4.2,1.7);

	this.instance_1950 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1950.setTransform(39.5,319.9,0.1765,0.1765,109.9873,0,0,-5.9,7);

	this.instance_1951 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1951.setTransform(36.7,305.95,0.1765,0.1765,78.6493,0,0,-39.7,-2.2);

	this.instance_1952 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_1952.setTransform(34.05,292.9,0.1765,0.1765,79.4856,0,0,-32.5,-0.6);

	this.instance_1953 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_1953.setTransform(22.15,313.6,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);
	...
	this.instance_1959.setTransform(46.15,282.6,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_1962.setTransform(46.5,294.75,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_1970.setTransform(58.75,265.5,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_1971 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_1971.setTransform(58.35,293.5,0.1766,0.1766,-110.4825,0,0,6,-1.4);

	this.instance_1972 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_1972.setTransform(57.8,292.05,0.1767,0.1767,-120.7491,0,0,4.8,-8.7);

	this.instance_1973 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_1973.setTransform(53.4,278.35,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_1974 = new lib.ch1_headcopy2("synched",0);
	this.instance_1974.setTransform(68.75,255.5,0.1768,0.1768,-1.9979,0,0,1,52.6);
	...
	this.instance_1976.setTransform(71.25,301.15,0.1766,0.1766,-11.907,0,0,3,-53.8);

	this.instance_1977 = new lib.ch1_neckcopy2("synched",0);
	this.instance_1977.setTransform(68.05,259.25,0.1768,0.1768,10.1753,0,0,-0.1,9);
	...
	this.instance_1979.setTransform(68.45,302.8,0.1765,0.1765,36.4509,0,0,4,-53.3);

	this.instance_1980 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_1980.setTransform(71.6,286.05,0.1766,0.1766,7.7828,0,0,-0.3,2);

	this.instance_1981 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_1981.setTransform(86.5,291.15,0.1766,0.1766,34.1032,0,0,-4.2,2.9);

	this.instance_1982 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_1982.setTransform(86.1,289.1,0.1767,0.1767,58.3964,0,0,-5.8,7.8);

	this.instance_1983 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_1983.setTransform(76.8,278.35,0.1766,0.1766,49.3015,0,0,-40,-0.8);

	this.instance_1984 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_1984.setTransform(76.9,264.95,0.1767,0.1767,91.3062,0,0,-32.9,-0.7);

	this.instance_1985 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_1985.setTransform(64.4,285.55,0.1766,0.1766,-26.6514,0,0,2.4,-45.1);

	this.instance_1986 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_1986.setTransform(87.1,252.5,0.1765,0.1765,-63.3618,0,0,34.4,1.5);

	this.instance_1987 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_1987.setTransform(81.25,280.35,0.1765,0.1765,-85.3585,0,0,5,-0.7);

	this.instance_1988 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_1988.setTransform(82.3,279.3,0.1764,0.1764,-53.0003,0,0,3.6,-7);

	this.instance_1989 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_1989.setTransform(80.8,265,0.1765,0.1765,-95.5854,0,0,37.9,-0.3);

	this.instance_1990 = new lib.ch1_headcopy("synched",0);
	this.instance_1990.setTransform(97.25,242.55,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_1991 = new lib.ch1_uBodycopy("synched",0);
	this.instance_1991.setTransform(95.9,253.05,0.1768,0.1768,0,0,0,0,-22.4);

	this.instance_1992 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_1992.setTransform(98.8,288.95,0.1764,0.1764,-17.6357,0,0,2.7,-52.4);

	this.instance_1993 = new lib.ch1_neckcopy("synched",0);
	this.instance_1993.setTransform(96.35,246.35,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_1994 = new lib.ch1_lBodycopy("synched",0);
	this.instance_1994.setTransform(96.25,265.1,0.1768,0.1768,0,0,0,0.3,-21.8);

	this.instance_1995 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_1995.setTransform(99,290.6,0.1764,0.1764,30.7078,0,0,5,-52.1);

	this.instance_1996 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_1996.setTransform(98.7,273.65,0.1764,0.1764,-3.3621,0,0,0.1,3.4);

	this.instance_1997 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_1997.setTransform(109.45,280.7,0.1765,0.1765,90.2674,0,0,-3.1,2.3);

	this.instance_1998 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_1998.setTransform(110.6,279.1,0.1765,0.1765,109.9873,0,0,-4.5,6.8);

	this.instance_1999 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_1999.setTransform(107.85,265.15,0.1765,0.1765,78.6493,0,0,-38.8,-1.2);

	this.instance_2000 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_2000.setTransform(105.2,252.1,0.1765,0.1765,79.4856,0,0,-31.4,0.2);

	this.instance_2001 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_2001.setTransform(93.3,272.8,0.1764,0.1764,-21.1325,0,0,1.5,-44.7);
	...
	this.instance_2007.setTransform(141.15,267.9,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_2010.setTransform(141.5,280.05,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_2023.setTransform(169.2,278.1,0.1769,0.1769,0,0,0,0,-24);
	...
	this.instance_2026.setTransform(169.55,290.25,0.1769,0.1769,0,0,0,0.3,-23.2);
	...
	this.instance_2034.setTransform(68.1,236.3,0.1767,0.1767,-90.7322,0,0,35.1,2.5);

	this.instance_2035 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_2035.setTransform(80.15,260.65,0.1766,0.1766,-148.1525,0,0,4.6,-1.2);

	this.instance_2036 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_2036.setTransform(79.5,259.2,0.1767,0.1767,-124.7938,0,0,4,-7.2);

	this.instance_2037 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_2037.setTransform(68.55,250.3,0.1766,0.1766,-141.5767,0,0,38,2.4);

	this.instance_2038 = new lib.ch1_headcopy_1("synched",0);
	this.instance_2038.setTransform(78.25,226.45,0.1768,0.1768,-3.6174,0,0,3.1,54.1);

	this.instance_2039 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_2039.setTransform(76.85,236.75,0.177,0.177,0,0,0,1.2,-23.2);

	this.instance_2040 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_2040.setTransform(74.05,273.9,0.1766,0.1766,16.7851,0,0,5.2,-54.5);

	this.instance_2041 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_2041.setTransform(77.35,230.1,0.1768,0.1768,12.0868,0,0,1.1,9.1);

	this.instance_2042 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_2042.setTransform(77.15,248.9,0.177,0.177,0,0,0,1.7,-22.6);

	this.instance_2043 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_2043.setTransform(83.3,273.9,0.1766,0.1766,-11.5702,0,0,4.2,-53.2);

	this.instance_2044 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_2044.setTransform(79.9,257.3,0.1766,0.1766,-14.6979,0,0,0.7,3.1);

	this.instance_2045 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_2045.setTransform(86.5,261.4,0.1767,0.1767,58.7222,0,0,-3.6,2.1);

	this.instance_2046 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_2046.setTransform(87.35,259.65,0.1767,0.1767,96.3659,0,0,-5.6,6);

	this.instance_2047 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_2047.setTransform(79.75,247.55,0.1767,0.1767,58.0466,0,0,-39.1,-2);

	this.instance_2048 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_2048.setTransform(86.15,235.7,0.1767,0.1767,119.3036,0,0,-34,-2);

	this.instance_2049 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_2049.setTransform(75.2,256.8,0.1767,0.1767,1.8162,0,0,4,-45.7);

	this.instance_2050 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_2050.setTransform(181.35,266.65,0.1765,0.1765,-63.3618,0,0,35.4,1);

	this.instance_2051 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_2051.setTransform(175.5,294.45,0.1765,0.1765,-85.3585,0,0,6.2,-0.8);

	this.instance_2052 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_2052.setTransform(176.55,293.4,0.1764,0.1764,-53.0003,0,0,4.5,-7.7);

	this.instance_2053 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_2053.setTransform(175.1,279.1,0.1765,0.1765,-95.5854,0,0,39,-0.1);

	this.instance_2054 = new lib.ch1_headcopy("synched",0);
	this.instance_2054.setTransform(191.5,256.65,0.1766,0.1766,-1.0395,0,0,1.3,52.7);

	this.instance_2055 = new lib.ch1_uBodycopy("synched",0);
	this.instance_2055.setTransform(190.15,267.15,0.1768,0.1768,0,0,0,0,-23.4);

	this.instance_2056 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_2056.setTransform(193.05,303,0.1764,0.1764,-17.6357,0,0,3.3,-53.4);

	this.instance_2057 = new lib.ch1_neckcopy("synched",0);
	this.instance_2057.setTransform(190.6,260.45,0.1766,0.1766,10.6945,0,0,-0.7,8.8);

	this.instance_2058 = new lib.ch1_lBodycopy("synched",0);
	this.instance_2058.setTransform(190.5,279.2,0.1768,0.1768,0,0,0,0.3,-22.6);

	this.instance_2059 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_2059.setTransform(193.25,304.65,0.1764,0.1764,30.7078,0,0,4.7,-52.6);

	this.instance_2060 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_2060.setTransform(192.9,287.75,0.1764,0.1764,-3.3621,0,0,0.1,2.3);

	this.instance_2061 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_2061.setTransform(203.7,294.8,0.1765,0.1765,90.2674,0,0,-4.2,2.3);

	this.instance_2062 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_2062.setTransform(204.9,293.2,0.1765,0.1765,109.9873,0,0,-5.7,6.9);

	this.instance_2063 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_2063.setTransform(202.1,279.25,0.1765,0.1765,78.6493,0,0,-39.9,-1.7);

	this.instance_2064 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_2064.setTransform(199.45,266.2,0.1765,0.1765,79.4856,0,0,-32.5,0);

	this.instance_2065 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_2065.setTransform(187.55,286.9,0.1764,0.1764,-21.1325,0,0,1.9,-45.8);

	this.instance_2066 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_2066.setTransform(155.9,244.7,0.1767,0.1767,-67.6896,0,0,35.5,0.8);

	this.instance_2067 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_2067.setTransform(155.5,272.7,0.1766,0.1766,-110.4825,0,0,5.2,-1.7);

	this.instance_2068 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_2068.setTransform(154.95,271.25,0.1767,0.1767,-120.7491,0,0,4.1,-9.1);

	this.instance_2069 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_2069.setTransform(150.55,257.55,0.1767,0.1767,-107.385,0,0,40,0.1);

	this.instance_2070 = new lib.ch1_headcopy2("synched",0);
	this.instance_2070.setTransform(165.9,234.7,0.1768,0.1768,-1.9979,0,0,1,52.6);

	this.instance_2071 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_2071.setTransform(164.7,245.15,0.177,0.177,0,0,0,0,-22.6);

	this.instance_2072 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_2072.setTransform(168.4,280.35,0.1766,0.1766,-11.907,0,0,2.8,-53);

	this.instance_2073 = new lib.ch1_neckcopy2("synched",0);
	this.instance_2073.setTransform(165.2,238.45,0.1768,0.1768,10.1753,0,0,-0.1,9);

	this.instance_2074 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_2074.setTransform(165.05,257.25,0.177,0.177,0,0,0,0.3,-22.1);

	this.instance_2075 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_2075.setTransform(165.6,282,0.1765,0.1765,36.4509,0,0,4.5,-52.6);

	this.instance_2076 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_2076.setTransform(168.8,265.25,0.1766,0.1766,7.7828,0,0,-0.1,3.1);

	this.instance_2077 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_2077.setTransform(183.65,270.35,0.1766,0.1766,34.1032,0,0,-3.8,3.6);

	this.instance_2078 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_2078.setTransform(183.2,268.3,0.1767,0.1767,58.3964,0,0,-5.7,8.2);

	this.instance_2079 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_2079.setTransform(173.95,257.55,0.1766,0.1766,49.3015,0,0,-39.4,-0.2);

	this.instance_2080 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_2080.setTransform(174.05,244.15,0.1767,0.1767,91.3062,0,0,-31.7,-0.7);

	this.instance_2081 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_2081.setTransform(161.5,264.75,0.1766,0.1766,-26.6514,0,0,1.9,-44.3);

	this.instance_2082 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_2082.setTransform(15,257.45,0.1767,0.1767,-67.6904,0,0,35.5,0.8);

	this.instance_2083 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_2083.setTransform(14.6,285.45,0.1766,0.1766,-110.4813,0,0,6.2,-1.3);

	this.instance_2084 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_2084.setTransform(14.05,284,0.1767,0.1767,-120.7473,0,0,5,-8.5);

	this.instance_2085 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_2085.setTransform(9.6,270.3,0.1767,0.1767,-107.3818,0,0,40.3,0.1);

	this.instance_2086 = new lib.ch1_headcopy2("synched",0);
	this.instance_2086.setTransform(25,247.45,0.1768,0.1768,-1.9933,0,0,1,52.6);

	this.instance_2087 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_2087.setTransform(23.8,257.9,0.177,0.177,0,0,0,0,-23.8);

	this.instance_2088 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_2088.setTransform(27.5,293.1,0.1766,0.1766,-11.9042,0,0,3,-54.1);

	this.instance_2089 = new lib.ch1_neckcopy2("synched",0);
	this.instance_2089.setTransform(24.3,251.2,0.1768,0.1768,10.1721,0,0,-0.1,9);

	this.instance_2090 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_2090.setTransform(24.15,270,0.177,0.177,0,0,0,0.3,-23.2);

	this.instance_2091 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_2091.setTransform(24.7,294.75,0.1765,0.1765,36.4488,0,0,3.8,-53.5);

	this.instance_2092 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_2092.setTransform(27.85,278,0.1765,0.1765,7.7792,0,0,-0.3,2);

	this.instance_2093 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_2093.setTransform(42.75,283.1,0.1766,0.1766,34.1019,0,0,-4.4,2.6);

	this.instance_2094 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_2094.setTransform(42.35,281.05,0.1767,0.1767,58.398,0,0,-5.8,7.8);

	this.instance_2095 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_2095.setTransform(33.05,270.3,0.1766,0.1766,49.3026,0,0,-40.2,-1);

	this.instance_2096 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_2096.setTransform(33.15,256.9,0.1767,0.1767,91.3014,0,0,-32.9,-0.7);

	this.instance_2097 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_2097.setTransform(20.6,277.5,0.1766,0.1766,-26.6514,0,0,2.5,-45.4);

	this.instance_2098 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_2098.setTransform(113.4,241.05,0.1765,0.1765,-63.3641,0,0,35.4,1);

	this.instance_2099 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_2099.setTransform(107.6,268.85,0.1765,0.1765,-85.3627,0,0,5.4,-0.7);

	this.instance_2100 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_2100.setTransform(108.6,267.8,0.1764,0.1764,-53.0013,0,0,3.4,-6.8);

	this.instance_2101 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_2101.setTransform(107.1,253.5,0.1765,0.1765,-95.581,0,0,37.6,-0.3);

	this.instance_2102 = new lib.ch1_headcopy("synched",0);
	this.instance_2102.setTransform(123.55,231.05,0.1766,0.1766,-1.0346,0,0,1.3,52.7);

	this.instance_2103 = new lib.ch1_uBodycopy("synched",0);
	this.instance_2103.setTransform(122.2,241.55,0.1768,0.1768,0,0,0,0,-22.1);

	this.instance_2104 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_2104.setTransform(125.1,277.45,0.1764,0.1764,-17.6325,0,0,3,-52.3);

	this.instance_2105 = new lib.ch1_neckcopy("synched",0);
	this.instance_2105.setTransform(122.65,234.85,0.1766,0.1766,10.6905,0,0,-0.7,8.8);

	this.instance_2106 = new lib.ch1_lBodycopy("synched",0);
	this.instance_2106.setTransform(122.55,253.6,0.1768,0.1768,0,0,0,0.3,-22.7);

	this.instance_2107 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_2107.setTransform(125.3,279.1,0.1763,0.1763,30.7086,0,0,5.2,-51.9);

	this.instance_2108 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_2108.setTransform(124.95,262.15,0.1764,0.1764,-3.3577,0,0,0.1,2.3);

	this.instance_2109 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_2109.setTransform(135.75,269.2,0.1765,0.1765,90.2625,0,0,-3.4,2.3);

	this.instance_2110 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_2110.setTransform(136.9,267.6,0.1765,0.1765,109.9844,0,0,-4.5,6.5);

	this.instance_2111 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_2111.setTransform(134.15,253.65,0.1765,0.1765,78.6532,0,0,-39.9,-1.4);

	this.instance_2112 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_2112.setTransform(131.5,240.6,0.1765,0.1765,79.4896,0,0,-32.5,0);

	this.instance_2113 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_2113.setTransform(119.6,261.3,0.1764,0.1764,-21.1297,0,0,1.4,-44.5);

	this.instance_2114 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_2114.setTransform(219.4,273.75,0.1765,0.1765,-63.3641,0,0,35.4,1);

	this.instance_2115 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_2115.setTransform(213.6,301.55,0.1765,0.1765,-85.3627,0,0,5.4,-0.7);

	this.instance_2116 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_2116.setTransform(214.6,300.5,0.1764,0.1764,-53.0013,0,0,3.9,-7.2);

	this.instance_2117 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_2117.setTransform(213.1,286.2,0.1765,0.1765,-95.581,0,0,38.1,-0.2);

	this.instance_2118 = new lib.ch1_headcopy("synched",0);
	this.instance_2118.setTransform(229.55,263.75,0.1766,0.1766,-1.0346,0,0,1.3,52.7);

	this.instance_2119 = new lib.ch1_uBodycopy("synched",0);
	this.instance_2119.setTransform(228.2,274.25,0.1768,0.1768,0,0,0,0,-22.7);

	this.instance_2120 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_2120.setTransform(231.1,310.1,0.1764,0.1764,-17.6325,0,0,3.3,-53.4);

	this.instance_2121 = new lib.ch1_neckcopy("synched",0);
	this.instance_2121.setTransform(228.65,267.55,0.1766,0.1766,10.6905,0,0,-0.7,8.8);

	this.instance_2122 = new lib.ch1_lBodycopy("synched",0);
	this.instance_2122.setTransform(228.55,286.3,0.1768,0.1768,0,0,0,0.3,-22.7);

	this.instance_2123 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_2123.setTransform(231.3,311.8,0.1763,0.1763,30.7086,0,0,4.9,-52.4);

	this.instance_2124 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_2124.setTransform(230.95,294.85,0.1764,0.1764,-3.3577,0,0,0.1,2.3);

	this.instance_2125 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_2125.setTransform(241.75,301.9,0.1765,0.1765,90.2625,0,0,-3.4,2.3);

	this.instance_2126 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_2126.setTransform(242.95,300.3,0.1765,0.1765,109.9844,0,0,-5.7,6.9);

	this.instance_2127 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_2127.setTransform(240.15,286.35,0.1765,0.1765,78.6532,0,0,-39.9,-1.4);

	this.instance_2128 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_2128.setTransform(237.5,273.3,0.1765,0.1765,79.4896,0,0,-32.5,0);

	this.instance_2129 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_2129.setTransform(225.6,294,0.1764,0.1764,-21.1297,0,0,1.6,-45);

	this.instance_2130 = new lib.ch1_uArm_rcopy2("synched",0);
	this.instance_2130.setTransform(243.55,259.25,0.1767,0.1767,-67.6904,0,0,35.5,0.8);

	this.instance_2131 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_2131.setTransform(243.15,287.25,0.1766,0.1766,-110.4813,0,0,5.2,-1.7);

	this.instance_2132 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_2132.setTransform(242.6,285.8,0.1767,0.1767,-120.7473,0,0,4.1,-9.1);

	this.instance_2133 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_2133.setTransform(238.2,272.1,0.1767,0.1767,-107.3818,0,0,40,0.1);

	this.instance_2134 = new lib.ch1_headcopy2("synched",0);
	this.instance_2134.setTransform(253.55,249.25,0.1768,0.1768,-1.9933,0,0,1,52.6);

	this.instance_2135 = new lib.ch1_uBodycopy2("synched",0);
	this.instance_2135.setTransform(252.35,259.7,0.177,0.177,0,0,0,0,-22.6);

	this.instance_2136 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_2136.setTransform(256.05,294.9,0.1766,0.1766,-11.9042,0,0,3,-53.8);

	this.instance_2137 = new lib.ch1_neckcopy2("synched",0);
	this.instance_2137.setTransform(252.85,253,0.1768,0.1768,10.1721,0,0,-0.1,9);

	this.instance_2138 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_2138.setTransform(252.7,271.8,0.177,0.177,0,0,0,0.3,-22.3);

	this.instance_2139 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_2139.setTransform(253.25,296.55,0.1765,0.1765,36.4488,0,0,4.5,-52.6);

	this.instance_2140 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_2140.setTransform(256.45,279.8,0.1765,0.1765,7.7792,0,0,-0.1,3.1);

	this.instance_2141 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_2141.setTransform(271.3,284.9,0.1766,0.1766,34.1019,0,0,-3.8,3.6);

	this.instance_2142 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_2142.setTransform(270.9,282.85,0.1767,0.1767,58.398,0,0,-5.5,7.9);

	this.instance_2143 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_2143.setTransform(261.6,272.15,0.1766,0.1766,49.3026,0,0,-39.4,-0.2);

	this.instance_2144 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_2144.setTransform(261.7,258.7,0.1767,0.1767,91.3014,0,0,-31.7,-0.7);

	this.instance_2145 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_2145.setTransform(249.15,279.3,0.1766,0.1766,-26.6514,0,0,1.9,-44.3);

	this.instance_2146 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_2146.setTransform(309.8,254.35,0.1765,0.1765,-63.3619,0,0,35.4,1);

	this.instance_2147 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_2147.setTransform(303.95,282.15,0.1765,0.1765,-85.354,0,0,6.2,-0.8);

	this.instance_2148 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_2148.setTransform(305,281.1,0.1765,0.1765,-52.9983,0,0,4.5,-7.7);

	this.instance_2149 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_2149.setTransform(303.55,266.8,0.1765,0.1765,-95.5899,0,0,39,-0.1);

	this.instance_2150 = new lib.ch1_headcopy("synched",0);
	this.instance_2150.setTransform(319.95,244.35,0.1767,0.1767,-1.0443,0,0,1.3,52.7);
	...
	this.instance_2152.setTransform(321.5,290.75,0.1765,0.1765,-17.6375,0,0,3,-53.5);

	this.instance_2153 = new lib.ch1_neckcopy("synched",0);
	this.instance_2153.setTransform(319.05,248.15,0.1766,0.1766,10.6984,0,0,-0.7,8.8);
	...
	this.instance_2155.setTransform(321.7,292.4,0.1764,0.1764,30.7096,0,0,4.4,-53.1);

	this.instance_2156 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_2156.setTransform(321.35,275.45,0.1764,0.1764,-3.3668,0,0,0.1,2.3);

	this.instance_2157 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_2157.setTransform(332.15,282.5,0.1765,0.1765,90.2724,0,0,-4.2,2.3);

	this.instance_2158 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_2158.setTransform(333.35,280.9,0.1765,0.1765,109.9886,0,0,-5.5,7.2);

	this.instance_2159 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_2159.setTransform(330.55,266.95,0.1766,0.1766,78.6464,0,0,-39.9,-1.4);

	this.instance_2160 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_2160.setTransform(327.9,253.9,0.1765,0.1765,79.4817,0,0,-32.5,0);

	this.instance_2161 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_2161.setTransform(316,274.6,0.1765,0.1765,-21.1353,0,0,1.9,-45.8);

	this.instance_2162 = new lib.ch1_uArm_rcopy_1("synched",0);
	this.instance_2162.setTransform(290.7,238.15,0.1767,0.1767,-90.7322,0,0,35.1,1.3);

	this.instance_2163 = new lib.ch1_hand_rcopy_1("synched",0);
	this.instance_2163.setTransform(302.75,262.5,0.1766,0.1766,-148.1525,0,0,5.3,-1.7);

	this.instance_2164 = new lib.ch1_thumb_rcopy_1("synched",0);
	this.instance_2164.setTransform(302.1,261.05,0.1767,0.1767,-124.7938,0,0,4.5,-7.9);

	this.instance_2165 = new lib.ch1_lArm_rcopy_1("synched",0);
	this.instance_2165.setTransform(291.15,252.15,0.1766,0.1766,-141.5767,0,0,38.9,1.7);

	this.instance_2166 = new lib.ch1_headcopy_1("synched",0);
	this.instance_2166.setTransform(300.85,228.35,0.1768,0.1768,-3.6174,0,0,1.9,54);

	this.instance_2167 = new lib.ch1_uBodycopy_1("synched",0);
	this.instance_2167.setTransform(299.45,238.6,0.177,0.177,0,0,0,0,-23.2);

	this.instance_2168 = new lib.ch1_lLeg_rcopy_1("synched",0);
	this.instance_2168.setTransform(296.6,275.75,0.1766,0.1766,16.7851,0,0,4.4,-54.2);

	this.instance_2169 = new lib.ch1_neckcopy_1("synched",0);
	this.instance_2169.setTransform(299.95,231.95,0.1768,0.1768,12.0868,0,0,-0.1,9.2);

	this.instance_2170 = new lib.ch1_lBodycopy_1("synched",0);
	this.instance_2170.setTransform(299.75,250.75,0.177,0.177,0,0,0,0.8,-22.6);

	this.instance_2171 = new lib.ch1_lLeg_lcopy_1("synched",0);
	this.instance_2171.setTransform(305.9,275.75,0.1766,0.1766,-11.5702,0,0,3.1,-53.4);

	this.instance_2172 = new lib.ch1_uLeg_lcopy_1("synched",0);
	this.instance_2172.setTransform(302.5,259.15,0.1766,0.1766,-14.6979,0,0,-0.5,2.8);

	this.instance_2173 = new lib.ch1_hand_lcopy_1("synched",0);
	this.instance_2173.setTransform(309.1,263.25,0.1767,0.1767,58.7222,0,0,-4.2,3.1);

	this.instance_2174 = new lib.ch1_thumb_lcopy_1("synched",0);
	this.instance_2174.setTransform(309.95,261.5,0.1767,0.1767,96.3659,0,0,-5.5,6.9);

	this.instance_2175 = new lib.ch1_lArm_lcopy_1("synched",0);
	this.instance_2175.setTransform(302.35,249.4,0.1767,0.1767,58.0466,0,0,-39.6,-1.3);

	this.instance_2176 = new lib.ch1_uArm_lcopy_1("synched",0);
	this.instance_2176.setTransform(308.75,237.6,0.1767,0.1767,119.3036,0,0,-33.4,-1.1);

	this.instance_2177 = new lib.ch1_uLeg_rcopy_1("synched",0);
	this.instance_2177.setTransform(297.8,258.65,0.1767,0.1767,1.8162,0,0,2.8,-45.6);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LessonChapter1_10_atlas_1.png?1655324578646", id:"LessonChapter1_10_atlas_1"},
		{src:"images/LessonChapter1_10_atlas_2.png?1655324578647", id:"LessonChapter1_10_atlas_2"},
		{src:"sounds/beforewar2edit_10wav.mp3?1655324580710", id:"beforewar2edit_10wav"},
		{src:"sounds/popsound.mp3?1655324580710", id:"popsound"}
	],
	preloads: []
};
